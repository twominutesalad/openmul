...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_mul_nbapi')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_mul_nbapi')
...
class ofp_header(_object):
    ...
    if _newclass:
        version = _swig_property(_mul_nbapi.ofp_header_version_get, _mul_nbapi.ofp_header_version_set)
    __swig_setmethods__["type"] = _mul_nbapi.ofp_header_type_set
    __swig_getmethods__["type"] = _mul_nbapi.ofp_header_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_header_type_get, _mul_nbapi.ofp_header_type_set)
    __swig_setmethods__["length"] = _mul_nbapi.ofp_header_length_set
    __swig_getmethods__["length"] = _mul_nbapi.ofp_header_length_get
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_header_length_get, _mul_nbapi.ofp_header_length_set)
    __swig_setmethods__["xid"] = _mul_nbapi.ofp_header_xid_set
    __swig_getmethods__["xid"] = _mul_nbapi.ofp_header_xid_get
    if _newclass:
        xid = _swig_property(_mul_nbapi.ofp_header_xid_get, _mul_nbapi.ofp_header_xid_set)
...
class ofp_oxm_header(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_oxm_header_length_get, _mul_nbapi.ofp_oxm_header_length_set)
    ...
    if _newclass:
        oxm_field_hm = _swig_property(_mul_nbapi.ofp_oxm_header_oxm_field_hm_get, _mul_nbapi.ofp_oxm_header_oxm_field_hm_set)
    ...
    if _newclass:
        oxm_class = _swig_property(_mul_nbapi.ofp_oxm_header_oxm_class_get, _mul_nbapi.ofp_oxm_header_oxm_class_set)
    __swig_setmethods__["data"] = _mul_nbapi.ofp_oxm_header_data_set
    __swig_getmethods__["data"] = _mul_nbapi.ofp_oxm_header_data_get
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp_oxm_header_data_get, _mul_nbapi.ofp_oxm_header_data_set)
...
class ofp_instruction(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_type_get, _mul_nbapi.ofp_instruction_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_instruction_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_instruction_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_len_get, _mul_nbapi.ofp_instruction_len_set)
...
class ofp_instruction_goto_table(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_goto_table_type_get, _mul_nbapi.ofp_instruction_goto_table_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_goto_table_len_get, _mul_nbapi.ofp_instruction_goto_table_len_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_instruction_goto_table_table_id_get, _mul_nbapi.ofp_instruction_goto_table_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_instruction_goto_table_pad_get, _mul_nbapi.ofp_instruction_goto_table_pad_set)
...
class ofp_instruction_write_metadata(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_write_metadata_type_get, _mul_nbapi.ofp_instruction_write_metadata_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_write_metadata_len_get, _mul_nbapi.ofp_instruction_write_metadata_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_instruction_write_metadata_pad_get, _mul_nbapi.ofp_instruction_write_metadata_pad_set)
    ...
    if _newclass:
        metadata = _swig_property(_mul_nbapi.ofp_instruction_write_metadata_metadata_get, _mul_nbapi.ofp_instruction_write_metadata_metadata_set)
    ...
    if _newclass:
        metadata_mask = _swig_property(_mul_nbapi.ofp_instruction_write_metadata_metadata_mask_get, _mul_nbapi.ofp_instruction_write_metadata_metadata_mask_set)
...
class ofp_action_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_header_type_get, _mul_nbapi.ofp_action_header_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_header_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_header_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_header_len_get, _mul_nbapi.ofp_action_header_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_action_header_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_action_header_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_header_pad_get, _mul_nbapi.ofp_action_header_pad_set)
...
class ofp_instruction_actions(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_actions_type_get, _mul_nbapi.ofp_instruction_actions_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_actions_len_get, _mul_nbapi.ofp_instruction_actions_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_instruction_actions_pad_get, _mul_nbapi.ofp_instruction_actions_pad_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_instruction_actions_actions_get, _mul_nbapi.ofp_instruction_actions_actions_set)
...
class ofp_instruction_meter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_meter_type_get, _mul_nbapi.ofp_instruction_meter_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_meter_len_get, _mul_nbapi.ofp_instruction_meter_len_set)
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.ofp_instruction_meter_meter_id_get, _mul_nbapi.ofp_instruction_meter_meter_id_set)
...
class ofp_instruction_experimenter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_instruction_experimenter_type_get, _mul_nbapi.ofp_instruction_experimenter_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_instruction_experimenter_len_get, _mul_nbapi.ofp_instruction_experimenter_len_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_instruction_experimenter_experimenter_get, _mul_nbapi.ofp_instruction_experimenter_experimenter_set)
...
class ofp_action_group(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_group_type_get, _mul_nbapi.ofp_action_group_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_group_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_group_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_group_len_get, _mul_nbapi.ofp_action_group_len_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_action_group_group_id_get, _mul_nbapi.ofp_action_group_group_id_set)
...
class ofp_action_mpls_ttl(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_mpls_ttl_type_get, _mul_nbapi.ofp_action_mpls_ttl_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_mpls_ttl_len_get, _mul_nbapi.ofp_action_mpls_ttl_len_set)
    ...
    if _newclass:
        mpls_ttl = _swig_property(_mul_nbapi.ofp_action_mpls_ttl_mpls_ttl_get, _mul_nbapi.ofp_action_mpls_ttl_mpls_ttl_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_mpls_ttl_pad_get, _mul_nbapi.ofp_action_mpls_ttl_pad_set)
...
class ofp_action_nw_ttl(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_nw_ttl_type_get, _mul_nbapi.ofp_action_nw_ttl_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_nw_ttl_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_nw_ttl_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_nw_ttl_len_get, _mul_nbapi.ofp_action_nw_ttl_len_set)
    ...
    if _newclass:
        nw_ttl = _swig_property(_mul_nbapi.ofp_action_nw_ttl_nw_ttl_get, _mul_nbapi.ofp_action_nw_ttl_nw_ttl_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_action_nw_ttl_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_action_nw_ttl_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_nw_ttl_pad_get, _mul_nbapi.ofp_action_nw_ttl_pad_set)
...
class ofp_action_push(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_push_type_get, _mul_nbapi.ofp_action_push_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_push_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_push_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_push_len_get, _mul_nbapi.ofp_action_push_len_set)
    ...
    if _newclass:
        ethertype = _swig_property(_mul_nbapi.ofp_action_push_ethertype_get, _mul_nbapi.ofp_action_push_ethertype_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_action_push_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_action_push_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_push_pad_get, _mul_nbapi.ofp_action_push_pad_set)
...
class ofp_action_pop_mpls(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_pop_mpls_type_get, _mul_nbapi.ofp_action_pop_mpls_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_pop_mpls_len_get, _mul_nbapi.ofp_action_pop_mpls_len_set)
    ...
    if _newclass:
        ethertype = _swig_property(_mul_nbapi.ofp_action_pop_mpls_ethertype_get, _mul_nbapi.ofp_action_pop_mpls_ethertype_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_pop_mpls_pad_get, _mul_nbapi.ofp_action_pop_mpls_pad_set)
...
class ofp_action_set_field(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_set_field_type_get, _mul_nbapi.ofp_action_set_field_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_set_field_len_get, _mul_nbapi.ofp_action_set_field_len_set)
    ...
    if _newclass:
        field = _swig_property(_mul_nbapi.ofp_action_set_field_field_get, _mul_nbapi.ofp_action_set_field_field_set)
...
class ofp_action_experimenter_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_experimenter_header_type_get, _mul_nbapi.ofp_action_experimenter_header_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_experimenter_header_len_get, _mul_nbapi.ofp_action_experimenter_header_len_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_action_experimenter_header_experimenter_get, _mul_nbapi.ofp_action_experimenter_header_experimenter_set)
...
class ofp_switch_config(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_switch_config_header_get, _mul_nbapi.ofp_switch_config_header_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_switch_config_flags_get, _mul_nbapi.ofp_switch_config_flags_set)
    ...
    if _newclass:
        miss_send_len = _swig_property(_mul_nbapi.ofp_switch_config_miss_send_len_get, _mul_nbapi.ofp_switch_config_miss_send_len_set)
...
class ofp_table_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_table_mod_header_get, _mul_nbapi.ofp_table_mod_header_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_table_mod_table_id_get, _mul_nbapi.ofp_table_mod_table_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_table_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_table_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_table_mod_pad_get, _mul_nbapi.ofp_table_mod_pad_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp_table_mod_config_get, _mul_nbapi.ofp_table_mod_config_set)
...
class ofpx_match(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofpx_match_type_get, _mul_nbapi.ofpx_match_type_set)
    __swig_setmethods__["length"] = _mul_nbapi.ofpx_match_length_set
    __swig_getmethods__["length"] = _mul_nbapi.ofpx_match_length_get
    if _newclass:
        length = _swig_property(_mul_nbapi.ofpx_match_length_get, _mul_nbapi.ofpx_match_length_set)
    ...
    if _newclass:
        oxm_fields = _swig_property(_mul_nbapi.ofpx_match_oxm_fields_get, _mul_nbapi.ofpx_match_oxm_fields_set)
...
class ofp_bucket(_object):
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_bucket_len_get, _mul_nbapi.ofp_bucket_len_set)
    __swig_setmethods__["weight"] = _mul_nbapi.ofp_bucket_weight_set
    __swig_getmethods__["weight"] = _mul_nbapi.ofp_bucket_weight_get
    if _newclass:
        weight = _swig_property(_mul_nbapi.ofp_bucket_weight_get, _mul_nbapi.ofp_bucket_weight_set)
    ...
    if _newclass:
        watch_port = _swig_property(_mul_nbapi.ofp_bucket_watch_port_get, _mul_nbapi.ofp_bucket_watch_port_set)
    ...
    if _newclass:
        watch_group = _swig_property(_mul_nbapi.ofp_bucket_watch_group_get, _mul_nbapi.ofp_bucket_watch_group_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_bucket_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_bucket_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_bucket_pad_get, _mul_nbapi.ofp_bucket_pad_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_bucket_actions_get, _mul_nbapi.ofp_bucket_actions_set)
...
class ofp_group_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_group_mod_header_get, _mul_nbapi.ofp_group_mod_header_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.ofp_group_mod_command_get, _mul_nbapi.ofp_group_mod_command_set)
    __swig_setmethods__["type"] = _mul_nbapi.ofp_group_mod_type_set
    __swig_getmethods__["type"] = _mul_nbapi.ofp_group_mod_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_group_mod_type_get, _mul_nbapi.ofp_group_mod_type_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_group_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_group_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_group_mod_pad_get, _mul_nbapi.ofp_group_mod_pad_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_group_mod_group_id_get, _mul_nbapi.ofp_group_mod_group_id_set)
    ...
    if _newclass:
        buckets = _swig_property(_mul_nbapi.ofp_group_mod_buckets_get, _mul_nbapi.ofp_group_mod_buckets_set)
...
class ofp_meter_band_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_meter_band_header_type_get, _mul_nbapi.ofp_meter_band_header_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_meter_band_header_len_get, _mul_nbapi.ofp_meter_band_header_len_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_meter_band_header_rate_get, _mul_nbapi.ofp_meter_band_header_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.ofp_meter_band_header_burst_size_get, _mul_nbapi.ofp_meter_band_header_burst_size_set)
...
class ofp_meter_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_meter_mod_header_get, _mul_nbapi.ofp_meter_mod_header_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.ofp_meter_mod_command_get, _mul_nbapi.ofp_meter_mod_command_set)
    __swig_setmethods__["flags"] = _mul_nbapi.ofp_meter_mod_flags_set
    __swig_getmethods__["flags"] = _mul_nbapi.ofp_meter_mod_flags_get
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_meter_mod_flags_get, _mul_nbapi.ofp_meter_mod_flags_set)
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.ofp_meter_mod_meter_id_get, _mul_nbapi.ofp_meter_mod_meter_id_set)
    __swig_setmethods__["bands"] = _mul_nbapi.ofp_meter_mod_bands_set
    __swig_getmethods__["bands"] = _mul_nbapi.ofp_meter_mod_bands_get
    if _newclass:
        bands = _swig_property(_mul_nbapi.ofp_meter_mod_bands_get, _mul_nbapi.ofp_meter_mod_bands_set)
...
class ofp_meter_band_drop(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_meter_band_drop_type_get, _mul_nbapi.ofp_meter_band_drop_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_meter_band_drop_len_get, _mul_nbapi.ofp_meter_band_drop_len_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_meter_band_drop_rate_get, _mul_nbapi.ofp_meter_band_drop_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.ofp_meter_band_drop_burst_size_get, _mul_nbapi.ofp_meter_band_drop_burst_size_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_meter_band_drop_pad_get, _mul_nbapi.ofp_meter_band_drop_pad_set)
...
class ofp_meter_band_dscp_remark(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_type_get, _mul_nbapi.ofp_meter_band_dscp_remark_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_len_get, _mul_nbapi.ofp_meter_band_dscp_remark_len_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_rate_get, _mul_nbapi.ofp_meter_band_dscp_remark_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_burst_size_get, _mul_nbapi.ofp_meter_band_dscp_remark_burst_size_set)
    ...
    if _newclass:
        prec_level = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_prec_level_get, _mul_nbapi.ofp_meter_band_dscp_remark_prec_level_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_meter_band_dscp_remark_pad_get, _mul_nbapi.ofp_meter_band_dscp_remark_pad_set)
...
class ofp_meter_band_experimenter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_meter_band_experimenter_type_get, _mul_nbapi.ofp_meter_band_experimenter_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_meter_band_experimenter_len_get, _mul_nbapi.ofp_meter_band_experimenter_len_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_meter_band_experimenter_rate_get, _mul_nbapi.ofp_meter_band_experimenter_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.ofp_meter_band_experimenter_burst_size_get, _mul_nbapi.ofp_meter_band_experimenter_burst_size_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_meter_band_experimenter_experimenter_get, _mul_nbapi.ofp_meter_band_experimenter_experimenter_set)
...
class ofp_multipart_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_multipart_request_header_get, _mul_nbapi.ofp_multipart_request_header_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_multipart_request_type_get, _mul_nbapi.ofp_multipart_request_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_multipart_request_flags_get, _mul_nbapi.ofp_multipart_request_flags_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_multipart_request_pad_get, _mul_nbapi.ofp_multipart_request_pad_set)
    ...
    if _newclass:
        body = _swig_property(_mul_nbapi.ofp_multipart_request_body_get, _mul_nbapi.ofp_multipart_request_body_set)
...
class ofp_multipart_reply(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_multipart_reply_header_get, _mul_nbapi.ofp_multipart_reply_header_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_multipart_reply_type_get, _mul_nbapi.ofp_multipart_reply_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_multipart_reply_flags_get, _mul_nbapi.ofp_multipart_reply_flags_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_multipart_reply_pad_get, _mul_nbapi.ofp_multipart_reply_pad_set)
    ...
    if _newclass:
        body = _swig_property(_mul_nbapi.ofp_multipart_reply_body_get, _mul_nbapi.ofp_multipart_reply_body_set)
...
class ofp_desc_stats(_object):
    ...
    if _newclass:
        mfr_desc = _swig_property(_mul_nbapi.ofp_desc_stats_mfr_desc_get, _mul_nbapi.ofp_desc_stats_mfr_desc_set)
    ...
    if _newclass:
        hw_desc = _swig_property(_mul_nbapi.ofp_desc_stats_hw_desc_get, _mul_nbapi.ofp_desc_stats_hw_desc_set)
    ...
    if _newclass:
        sw_desc = _swig_property(_mul_nbapi.ofp_desc_stats_sw_desc_get, _mul_nbapi.ofp_desc_stats_sw_desc_set)
    ...
    if _newclass:
        serial_num = _swig_property(_mul_nbapi.ofp_desc_stats_serial_num_get, _mul_nbapi.ofp_desc_stats_serial_num_set)
    ...
    if _newclass:
        dp_desc = _swig_property(_mul_nbapi.ofp_desc_stats_dp_desc_get, _mul_nbapi.ofp_desc_stats_dp_desc_set)
...
class ofp_table_feature_prop_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_header_type_get, _mul_nbapi.ofp_table_feature_prop_header_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_header_length_get, _mul_nbapi.ofp_table_feature_prop_header_length_set)
...
class ofp_table_features(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_features_length_get, _mul_nbapi.ofp_table_features_length_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_table_features_table_id_get, _mul_nbapi.ofp_table_features_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_table_features_pad_get, _mul_nbapi.ofp_table_features_pad_set)
    ...
    if _newclass:
        name = _swig_property(_mul_nbapi.ofp_table_features_name_get, _mul_nbapi.ofp_table_features_name_set)
    ...
    if _newclass:
        metadata_match = _swig_property(_mul_nbapi.ofp_table_features_metadata_match_get, _mul_nbapi.ofp_table_features_metadata_match_set)
    ...
    if _newclass:
        metadata_write = _swig_property(_mul_nbapi.ofp_table_features_metadata_write_get, _mul_nbapi.ofp_table_features_metadata_write_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp_table_features_config_get, _mul_nbapi.ofp_table_features_config_set)
    ...
    if _newclass:
        max_entries = _swig_property(_mul_nbapi.ofp_table_features_max_entries_get, _mul_nbapi.ofp_table_features_max_entries_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp_table_features_properties_get, _mul_nbapi.ofp_table_features_properties_set)
...
class ofp_table_feature_prop_instructions(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_instructions_type_get, _mul_nbapi.ofp_table_feature_prop_instructions_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_instructions_length_get, _mul_nbapi.ofp_table_feature_prop_instructions_length_set)
    ...
    if _newclass:
        instruction_ids = _swig_property(_mul_nbapi.ofp_table_feature_prop_instructions_instruction_ids_get, _mul_nbapi.ofp_table_feature_prop_instructions_instruction_ids_set)
...
class ofp_table_feature_prop_next_tables(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_next_tables_type_get, _mul_nbapi.ofp_table_feature_prop_next_tables_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_next_tables_length_get, _mul_nbapi.ofp_table_feature_prop_next_tables_length_set)
    ...
    if _newclass:
        next_table_ids = _swig_property(_mul_nbapi.ofp_table_feature_prop_next_tables_next_table_ids_get, _mul_nbapi.ofp_table_feature_prop_next_tables_next_table_ids_set)
...
class ofp_table_feature_prop_actions(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_actions_type_get, _mul_nbapi.ofp_table_feature_prop_actions_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_actions_length_get, _mul_nbapi.ofp_table_feature_prop_actions_length_set)
    ...
    if _newclass:
        action_ids = _swig_property(_mul_nbapi.ofp_table_feature_prop_actions_action_ids_get, _mul_nbapi.ofp_table_feature_prop_actions_action_ids_set)
...
class ofp_table_feature_prop_oxm(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_oxm_type_get, _mul_nbapi.ofp_table_feature_prop_oxm_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_oxm_length_get, _mul_nbapi.ofp_table_feature_prop_oxm_length_set)
    ...
    if _newclass:
        oxm_ids = _swig_property(_mul_nbapi.ofp_table_feature_prop_oxm_oxm_ids_get, _mul_nbapi.ofp_table_feature_prop_oxm_oxm_ids_set)
...
class ofp_table_feature_prop_experimenter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_table_feature_prop_experimenter_type_get, _mul_nbapi.ofp_table_feature_prop_experimenter_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_table_feature_prop_experimenter_length_get, _mul_nbapi.ofp_table_feature_prop_experimenter_length_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_table_feature_prop_experimenter_experimenter_get, _mul_nbapi.ofp_table_feature_prop_experimenter_experimenter_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp_table_feature_prop_experimenter_exp_type_get, _mul_nbapi.ofp_table_feature_prop_experimenter_exp_type_set)
    ...
    if _newclass:
        experimenter_data = _swig_property(_mul_nbapi.ofp_table_feature_prop_experimenter_experimenter_data_get, _mul_nbapi.ofp_table_feature_prop_experimenter_experimenter_data_set)
...
class ofp_bucket_counter(_object):
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp_bucket_counter_packet_count_get, _mul_nbapi.ofp_bucket_counter_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp_bucket_counter_byte_count_get, _mul_nbapi.ofp_bucket_counter_byte_count_set)
...
class ofp_group_stats_request(_object):
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_group_stats_request_group_id_get, _mul_nbapi.ofp_group_stats_request_group_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_group_stats_request_pad_get, _mul_nbapi.ofp_group_stats_request_pad_set)
...
class ofp_group_stats(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_group_stats_length_get, _mul_nbapi.ofp_group_stats_length_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_group_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_group_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_group_stats_pad_get, _mul_nbapi.ofp_group_stats_pad_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_group_stats_group_id_get, _mul_nbapi.ofp_group_stats_group_id_set)
    ...
    if _newclass:
        ref_count = _swig_property(_mul_nbapi.ofp_group_stats_ref_count_get, _mul_nbapi.ofp_group_stats_ref_count_set)
    __swig_setmethods__["pad2"] = _mul_nbapi.ofp_group_stats_pad2_set
    __swig_getmethods__["pad2"] = _mul_nbapi.ofp_group_stats_pad2_get
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp_group_stats_pad2_get, _mul_nbapi.ofp_group_stats_pad2_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp_group_stats_packet_count_get, _mul_nbapi.ofp_group_stats_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp_group_stats_byte_count_get, _mul_nbapi.ofp_group_stats_byte_count_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp_group_stats_duration_sec_get, _mul_nbapi.ofp_group_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp_group_stats_duration_nsec_get, _mul_nbapi.ofp_group_stats_duration_nsec_set)
    ...
    if _newclass:
        bucket_stats = _swig_property(_mul_nbapi.ofp_group_stats_bucket_stats_get, _mul_nbapi.ofp_group_stats_bucket_stats_set)
...
class ofp_group_desc(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_group_desc_length_get, _mul_nbapi.ofp_group_desc_length_set)
    __swig_setmethods__["type"] = _mul_nbapi.ofp_group_desc_type_set
    __swig_getmethods__["type"] = _mul_nbapi.ofp_group_desc_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_group_desc_type_get, _mul_nbapi.ofp_group_desc_type_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_group_desc_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_group_desc_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_group_desc_pad_get, _mul_nbapi.ofp_group_desc_pad_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_group_desc_group_id_get, _mul_nbapi.ofp_group_desc_group_id_set)
    ...
    if _newclass:
        buckets = _swig_property(_mul_nbapi.ofp_group_desc_buckets_get, _mul_nbapi.ofp_group_desc_buckets_set)
...
class ofp_group_features(_object):
    ...
    if _newclass:
        types = _swig_property(_mul_nbapi.ofp_group_features_types_get, _mul_nbapi.ofp_group_features_types_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.ofp_group_features_capabilities_get, _mul_nbapi.ofp_group_features_capabilities_set)
    ...
    if _newclass:
        max_groups = _swig_property(_mul_nbapi.ofp_group_features_max_groups_get, _mul_nbapi.ofp_group_features_max_groups_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_group_features_actions_get, _mul_nbapi.ofp_group_features_actions_set)
...
class ofp_meter_band_stats(_object):
    ...
    if _newclass:
        packet_band_count = _swig_property(_mul_nbapi.ofp_meter_band_stats_packet_band_count_get, _mul_nbapi.ofp_meter_band_stats_packet_band_count_set)
    ...
    if _newclass:
        byte_band_count = _swig_property(_mul_nbapi.ofp_meter_band_stats_byte_band_count_get, _mul_nbapi.ofp_meter_band_stats_byte_band_count_set)
...
class ofp_meter_multipart_request(_object):
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.ofp_meter_multipart_request_meter_id_get, _mul_nbapi.ofp_meter_multipart_request_meter_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_meter_multipart_request_pad_get, _mul_nbapi.ofp_meter_multipart_request_pad_set)
...
class ofp_meter_config(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_meter_config_length_get, _mul_nbapi.ofp_meter_config_length_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_meter_config_flags_get, _mul_nbapi.ofp_meter_config_flags_set)
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.ofp_meter_config_meter_id_get, _mul_nbapi.ofp_meter_config_meter_id_set)
    ...
    if _newclass:
        bands = _swig_property(_mul_nbapi.ofp_meter_config_bands_get, _mul_nbapi.ofp_meter_config_bands_set)
...
class ofp_meter_stats(_object):
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.ofp_meter_stats_meter_id_get, _mul_nbapi.ofp_meter_stats_meter_id_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_meter_stats_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_meter_stats_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_meter_stats_len_get, _mul_nbapi.ofp_meter_stats_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_meter_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_meter_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_meter_stats_pad_get, _mul_nbapi.ofp_meter_stats_pad_set)
    ...
    if _newclass:
        flow_count = _swig_property(_mul_nbapi.ofp_meter_stats_flow_count_get, _mul_nbapi.ofp_meter_stats_flow_count_set)
    ...
    if _newclass:
        packet_in_count = _swig_property(_mul_nbapi.ofp_meter_stats_packet_in_count_get, _mul_nbapi.ofp_meter_stats_packet_in_count_set)
    ...
    if _newclass:
        byte_in_count = _swig_property(_mul_nbapi.ofp_meter_stats_byte_in_count_get, _mul_nbapi.ofp_meter_stats_byte_in_count_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp_meter_stats_duration_sec_get, _mul_nbapi.ofp_meter_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp_meter_stats_duration_nsec_get, _mul_nbapi.ofp_meter_stats_duration_nsec_set)
    ...
    if _newclass:
        band_stats = _swig_property(_mul_nbapi.ofp_meter_stats_band_stats_get, _mul_nbapi.ofp_meter_stats_band_stats_set)
...
class ofp_meter_features(_object):
    ...
    if _newclass:
        max_meter = _swig_property(_mul_nbapi.ofp_meter_features_max_meter_get, _mul_nbapi.ofp_meter_features_max_meter_set)
    ...
    if _newclass:
        band_types = _swig_property(_mul_nbapi.ofp_meter_features_band_types_get, _mul_nbapi.ofp_meter_features_band_types_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.ofp_meter_features_capabilities_get, _mul_nbapi.ofp_meter_features_capabilities_set)
    ...
    if _newclass:
        max_bands = _swig_property(_mul_nbapi.ofp_meter_features_max_bands_get, _mul_nbapi.ofp_meter_features_max_bands_set)
    ...
    if _newclass:
        max_color = _swig_property(_mul_nbapi.ofp_meter_features_max_color_get, _mul_nbapi.ofp_meter_features_max_color_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_meter_features_pad_get, _mul_nbapi.ofp_meter_features_pad_set)
...
class ofp_role_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_role_request_header_get, _mul_nbapi.ofp_role_request_header_set)
    ...
    if _newclass:
        role = _swig_property(_mul_nbapi.ofp_role_request_role_get, _mul_nbapi.ofp_role_request_role_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_role_request_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_role_request_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_role_request_pad_get, _mul_nbapi.ofp_role_request_pad_set)
    ...
    if _newclass:
        generation_id = _swig_property(_mul_nbapi.ofp_role_request_generation_id_get, _mul_nbapi.ofp_role_request_generation_id_set)
...
class ofp_async_config(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_async_config_header_get, _mul_nbapi.ofp_async_config_header_set)
    ...
    if _newclass:
        packet_in_mask = _swig_property(_mul_nbapi.ofp_async_config_packet_in_mask_get, _mul_nbapi.ofp_async_config_packet_in_mask_set)
    ...
    if _newclass:
        port_status_mask = _swig_property(_mul_nbapi.ofp_async_config_port_status_mask_get, _mul_nbapi.ofp_async_config_port_status_mask_set)
    ...
    if _newclass:
        flow_removed_mask = _swig_property(_mul_nbapi.ofp_async_config_flow_removed_mask_get, _mul_nbapi.ofp_async_config_flow_removed_mask_set)
...
class ofp_error_msg(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_error_msg_header_get, _mul_nbapi.ofp_error_msg_header_set)
    __swig_setmethods__["type"] = _mul_nbapi.ofp_error_msg_type_set
    __swig_getmethods__["type"] = _mul_nbapi.ofp_error_msg_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_error_msg_type_get, _mul_nbapi.ofp_error_msg_type_set)
    __swig_setmethods__["code"] = _mul_nbapi.ofp_error_msg_code_set
    __swig_getmethods__["code"] = _mul_nbapi.ofp_error_msg_code_get
    if _newclass:
        code = _swig_property(_mul_nbapi.ofp_error_msg_code_get, _mul_nbapi.ofp_error_msg_code_set)
    __swig_setmethods__["data"] = _mul_nbapi.ofp_error_msg_data_set
    __swig_getmethods__["data"] = _mul_nbapi.ofp_error_msg_data_get
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp_error_msg_data_get, _mul_nbapi.ofp_error_msg_data_set)
...
class ofp_hello_elem_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_hello_elem_header_type_get, _mul_nbapi.ofp_hello_elem_header_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_hello_elem_header_length_get, _mul_nbapi.ofp_hello_elem_header_length_set)
...
class ofp_hello_elem_versionbitmap(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_hello_elem_versionbitmap_type_get, _mul_nbapi.ofp_hello_elem_versionbitmap_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_hello_elem_versionbitmap_length_get, _mul_nbapi.ofp_hello_elem_versionbitmap_length_set)
    ...
    if _newclass:
        bitmaps = _swig_property(_mul_nbapi.ofp_hello_elem_versionbitmap_bitmaps_get, _mul_nbapi.ofp_hello_elem_versionbitmap_bitmaps_set)
...
class ofp_hello(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_hello_header_get, _mul_nbapi.ofp_hello_header_set)
    ...
    if _newclass:
        elements = _swig_property(_mul_nbapi.ofp_hello_elements_get, _mul_nbapi.ofp_hello_elements_set)
...
class ofp_experimenter_header(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_experimenter_header_header_get, _mul_nbapi.ofp_experimenter_header_header_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_experimenter_header_experimenter_get, _mul_nbapi.ofp_experimenter_header_experimenter_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp_experimenter_header_exp_type_get, _mul_nbapi.ofp_experimenter_header_exp_type_set)
...
class ofp_queue_prop_header(_object):
    ...
    if _newclass:
        property = _swig_property(_mul_nbapi.ofp_queue_prop_header_property_get, _mul_nbapi.ofp_queue_prop_header_property_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_queue_prop_header_len_get, _mul_nbapi.ofp_queue_prop_header_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_prop_header_pad_get, _mul_nbapi.ofp_queue_prop_header_pad_set)
...
class ofp_queue_prop_min_rate(_object):
    ...
    if _newclass:
        prop_header = _swig_property(_mul_nbapi.ofp_queue_prop_min_rate_prop_header_get, _mul_nbapi.ofp_queue_prop_min_rate_prop_header_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_queue_prop_min_rate_rate_get, _mul_nbapi.ofp_queue_prop_min_rate_rate_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_prop_min_rate_pad_get, _mul_nbapi.ofp_queue_prop_min_rate_pad_set)
...
class ofp_queue_prop_max_rate(_object):
    ...
    if _newclass:
        prop_header = _swig_property(_mul_nbapi.ofp_queue_prop_max_rate_prop_header_get, _mul_nbapi.ofp_queue_prop_max_rate_prop_header_set)
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.ofp_queue_prop_max_rate_rate_get, _mul_nbapi.ofp_queue_prop_max_rate_rate_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_prop_max_rate_pad_get, _mul_nbapi.ofp_queue_prop_max_rate_pad_set)
...
class ofp_phy_port(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_phy_port_port_no_get, _mul_nbapi.ofp_phy_port_port_no_set)
    ...
    if _newclass:
        hw_addr = _swig_property(_mul_nbapi.ofp_phy_port_hw_addr_get, _mul_nbapi.ofp_phy_port_hw_addr_set)
    __swig_setmethods__["name"] = _mul_nbapi.ofp_phy_port_name_set
    __swig_getmethods__["name"] = _mul_nbapi.ofp_phy_port_name_get
    if _newclass:
        name = _swig_property(_mul_nbapi.ofp_phy_port_name_get, _mul_nbapi.ofp_phy_port_name_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp_phy_port_config_get, _mul_nbapi.ofp_phy_port_config_set)
    __swig_setmethods__["state"] = _mul_nbapi.ofp_phy_port_state_set
    __swig_getmethods__["state"] = _mul_nbapi.ofp_phy_port_state_get
    if _newclass:
        state = _swig_property(_mul_nbapi.ofp_phy_port_state_get, _mul_nbapi.ofp_phy_port_state_set)
    __swig_setmethods__["curr"] = _mul_nbapi.ofp_phy_port_curr_set
    __swig_getmethods__["curr"] = _mul_nbapi.ofp_phy_port_curr_get
    if _newclass:
        curr = _swig_property(_mul_nbapi.ofp_phy_port_curr_get, _mul_nbapi.ofp_phy_port_curr_set)
    ...
    if _newclass:
        advertised = _swig_property(_mul_nbapi.ofp_phy_port_advertised_get, _mul_nbapi.ofp_phy_port_advertised_set)
    ...
    if _newclass:
        supported = _swig_property(_mul_nbapi.ofp_phy_port_supported_get, _mul_nbapi.ofp_phy_port_supported_set)
    __swig_setmethods__["peer"] = _mul_nbapi.ofp_phy_port_peer_set
    __swig_getmethods__["peer"] = _mul_nbapi.ofp_phy_port_peer_get
    if _newclass:
        peer = _swig_property(_mul_nbapi.ofp_phy_port_peer_get, _mul_nbapi.ofp_phy_port_peer_set)
...
class ofp_switch_features(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_switch_features_header_get, _mul_nbapi.ofp_switch_features_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.ofp_switch_features_datapath_id_get, _mul_nbapi.ofp_switch_features_datapath_id_set)
    ...
    if _newclass:
        n_buffers = _swig_property(_mul_nbapi.ofp_switch_features_n_buffers_get, _mul_nbapi.ofp_switch_features_n_buffers_set)
    ...
    if _newclass:
        n_tables = _swig_property(_mul_nbapi.ofp_switch_features_n_tables_get, _mul_nbapi.ofp_switch_features_n_tables_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_switch_features_pad_get, _mul_nbapi.ofp_switch_features_pad_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.ofp_switch_features_capabilities_get, _mul_nbapi.ofp_switch_features_capabilities_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_switch_features_actions_get, _mul_nbapi.ofp_switch_features_actions_set)
    ...
    if _newclass:
        ports = _swig_property(_mul_nbapi.ofp_switch_features_ports_get, _mul_nbapi.ofp_switch_features_ports_set)
...
class ofp_port_status(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_port_status_header_get, _mul_nbapi.ofp_port_status_header_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp_port_status_reason_get, _mul_nbapi.ofp_port_status_reason_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_port_status_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_port_status_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_status_pad_get, _mul_nbapi.ofp_port_status_pad_set)
    __swig_setmethods__["desc"] = _mul_nbapi.ofp_port_status_desc_set
    __swig_getmethods__["desc"] = _mul_nbapi.ofp_port_status_desc_get
    if _newclass:
        desc = _swig_property(_mul_nbapi.ofp_port_status_desc_get, _mul_nbapi.ofp_port_status_desc_set)
...
class ofp_port_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_port_mod_header_get, _mul_nbapi.ofp_port_mod_header_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_port_mod_port_no_get, _mul_nbapi.ofp_port_mod_port_no_set)
    ...
    if _newclass:
        hw_addr = _swig_property(_mul_nbapi.ofp_port_mod_hw_addr_get, _mul_nbapi.ofp_port_mod_hw_addr_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp_port_mod_config_get, _mul_nbapi.ofp_port_mod_config_set)
    __swig_setmethods__["mask"] = _mul_nbapi.ofp_port_mod_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.ofp_port_mod_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.ofp_port_mod_mask_get, _mul_nbapi.ofp_port_mod_mask_set)
    ...
    if _newclass:
        advertise = _swig_property(_mul_nbapi.ofp_port_mod_advertise_get, _mul_nbapi.ofp_port_mod_advertise_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_port_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_port_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_mod_pad_get, _mul_nbapi.ofp_port_mod_pad_set)
...
class ofp_packet_in(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_packet_in_header_get, _mul_nbapi.ofp_packet_in_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp_packet_in_buffer_id_get, _mul_nbapi.ofp_packet_in_buffer_id_set)
    ...
    if _newclass:
        total_len = _swig_property(_mul_nbapi.ofp_packet_in_total_len_get, _mul_nbapi.ofp_packet_in_total_len_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.ofp_packet_in_in_port_get, _mul_nbapi.ofp_packet_in_in_port_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp_packet_in_reason_get, _mul_nbapi.ofp_packet_in_reason_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_packet_in_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_packet_in_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_packet_in_pad_get, _mul_nbapi.ofp_packet_in_pad_set)
    __swig_setmethods__["data"] = _mul_nbapi.ofp_packet_in_data_set
    __swig_getmethods__["data"] = _mul_nbapi.ofp_packet_in_data_get
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp_packet_in_data_get, _mul_nbapi.ofp_packet_in_data_set)
...
class ofp_action_output(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_output_type_get, _mul_nbapi.ofp_action_output_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_output_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_output_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_output_len_get, _mul_nbapi.ofp_action_output_len_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp_action_output_port_get, _mul_nbapi.ofp_action_output_port_set)
    ...
    if _newclass:
        max_len = _swig_property(_mul_nbapi.ofp_action_output_max_len_get, _mul_nbapi.ofp_action_output_max_len_set)
...
class ofp_action_vlan_vid(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_vlan_vid_type_get, _mul_nbapi.ofp_action_vlan_vid_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_vlan_vid_len_get, _mul_nbapi.ofp_action_vlan_vid_len_set)
    ...
    if _newclass:
        vlan_vid = _swig_property(_mul_nbapi.ofp_action_vlan_vid_vlan_vid_get, _mul_nbapi.ofp_action_vlan_vid_vlan_vid_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_vlan_vid_pad_get, _mul_nbapi.ofp_action_vlan_vid_pad_set)
...
class ofp_action_vlan_pcp(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_vlan_pcp_type_get, _mul_nbapi.ofp_action_vlan_pcp_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_vlan_pcp_len_get, _mul_nbapi.ofp_action_vlan_pcp_len_set)
    ...
    if _newclass:
        vlan_pcp = _swig_property(_mul_nbapi.ofp_action_vlan_pcp_vlan_pcp_get, _mul_nbapi.ofp_action_vlan_pcp_vlan_pcp_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_vlan_pcp_pad_get, _mul_nbapi.ofp_action_vlan_pcp_pad_set)
...
class ofp_action_dl_addr(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_dl_addr_type_get, _mul_nbapi.ofp_action_dl_addr_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_dl_addr_len_get, _mul_nbapi.ofp_action_dl_addr_len_set)
    ...
    if _newclass:
        dl_addr = _swig_property(_mul_nbapi.ofp_action_dl_addr_dl_addr_get, _mul_nbapi.ofp_action_dl_addr_dl_addr_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_dl_addr_pad_get, _mul_nbapi.ofp_action_dl_addr_pad_set)
...
class ofp_action_nw_addr(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_nw_addr_type_get, _mul_nbapi.ofp_action_nw_addr_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_nw_addr_len_get, _mul_nbapi.ofp_action_nw_addr_len_set)
    ...
    if _newclass:
        nw_addr = _swig_property(_mul_nbapi.ofp_action_nw_addr_nw_addr_get, _mul_nbapi.ofp_action_nw_addr_nw_addr_set)
...
class ofp_action_tp_port(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_tp_port_type_get, _mul_nbapi.ofp_action_tp_port_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_tp_port_len_get, _mul_nbapi.ofp_action_tp_port_len_set)
    ...
    if _newclass:
        tp_port = _swig_property(_mul_nbapi.ofp_action_tp_port_tp_port_get, _mul_nbapi.ofp_action_tp_port_tp_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_tp_port_pad_get, _mul_nbapi.ofp_action_tp_port_pad_set)
...
class ofp_action_nw_tos(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_nw_tos_type_get, _mul_nbapi.ofp_action_nw_tos_type_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_action_nw_tos_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_action_nw_tos_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_nw_tos_len_get, _mul_nbapi.ofp_action_nw_tos_len_set)
    ...
    if _newclass:
        nw_tos = _swig_property(_mul_nbapi.ofp_action_nw_tos_nw_tos_get, _mul_nbapi.ofp_action_nw_tos_nw_tos_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_action_nw_tos_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_action_nw_tos_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_nw_tos_pad_get, _mul_nbapi.ofp_action_nw_tos_pad_set)
...
class ofp_action_vendor_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_vendor_header_type_get, _mul_nbapi.ofp_action_vendor_header_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_vendor_header_len_get, _mul_nbapi.ofp_action_vendor_header_len_set)
    ...
    if _newclass:
        vendor = _swig_property(_mul_nbapi.ofp_action_vendor_header_vendor_get, _mul_nbapi.ofp_action_vendor_header_vendor_set)
...
class ofp_packet_out(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_packet_out_header_get, _mul_nbapi.ofp_packet_out_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp_packet_out_buffer_id_get, _mul_nbapi.ofp_packet_out_buffer_id_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.ofp_packet_out_in_port_get, _mul_nbapi.ofp_packet_out_in_port_set)
    ...
    if _newclass:
        actions_len = _swig_property(_mul_nbapi.ofp_packet_out_actions_len_get, _mul_nbapi.ofp_packet_out_actions_len_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_packet_out_actions_get, _mul_nbapi.ofp_packet_out_actions_set)
...
class ofp_match(_object):
    ...
    if _newclass:
        dl_vlan_pcp = _swig_property(_mul_nbapi.ofp_match_dl_vlan_pcp_get, _mul_nbapi.ofp_match_dl_vlan_pcp_set)
    __swig_setmethods__["pad1"] = _mul_nbapi.ofp_match_pad1_set
    __swig_getmethods__["pad1"] = _mul_nbapi.ofp_match_pad1_get
    if _newclass:
        pad1 = _swig_property(_mul_nbapi.ofp_match_pad1_get, _mul_nbapi.ofp_match_pad1_set)
    __swig_setmethods__["dl_type"] = _mul_nbapi.ofp_match_dl_type_set
    __swig_getmethods__["dl_type"] = _mul_nbapi.ofp_match_dl_type_get
    if _newclass:
        dl_type = _swig_property(_mul_nbapi.ofp_match_dl_type_get, _mul_nbapi.ofp_match_dl_type_set)
    __swig_setmethods__["nw_tos"] = _mul_nbapi.ofp_match_nw_tos_set
    __swig_getmethods__["nw_tos"] = _mul_nbapi.ofp_match_nw_tos_get
    if _newclass:
        nw_tos = _swig_property(_mul_nbapi.ofp_match_nw_tos_get, _mul_nbapi.ofp_match_nw_tos_set)
...
class ofp_flow_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_flow_mod_header_get, _mul_nbapi.ofp_flow_mod_header_set)
    __swig_setmethods__["match"] = _mul_nbapi.ofp_flow_mod_match_set
    __swig_getmethods__["match"] = _mul_nbapi.ofp_flow_mod_match_get
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp_flow_mod_match_get, _mul_nbapi.ofp_flow_mod_match_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp_flow_mod_cookie_get, _mul_nbapi.ofp_flow_mod_cookie_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.ofp_flow_mod_command_get, _mul_nbapi.ofp_flow_mod_command_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp_flow_mod_idle_timeout_get, _mul_nbapi.ofp_flow_mod_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp_flow_mod_hard_timeout_get, _mul_nbapi.ofp_flow_mod_hard_timeout_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp_flow_mod_priority_get, _mul_nbapi.ofp_flow_mod_priority_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp_flow_mod_buffer_id_get, _mul_nbapi.ofp_flow_mod_buffer_id_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp_flow_mod_out_port_get, _mul_nbapi.ofp_flow_mod_out_port_set)
    __swig_setmethods__["flags"] = _mul_nbapi.ofp_flow_mod_flags_set
    __swig_getmethods__["flags"] = _mul_nbapi.ofp_flow_mod_flags_get
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_flow_mod_flags_get, _mul_nbapi.ofp_flow_mod_flags_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_flow_mod_actions_get, _mul_nbapi.ofp_flow_mod_actions_set)
...
class ofp_flow_removed(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_flow_removed_header_get, _mul_nbapi.ofp_flow_removed_header_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp_flow_removed_match_get, _mul_nbapi.ofp_flow_removed_match_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp_flow_removed_cookie_get, _mul_nbapi.ofp_flow_removed_cookie_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp_flow_removed_priority_get, _mul_nbapi.ofp_flow_removed_priority_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp_flow_removed_reason_get, _mul_nbapi.ofp_flow_removed_reason_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_flow_removed_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_flow_removed_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_flow_removed_pad_get, _mul_nbapi.ofp_flow_removed_pad_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp_flow_removed_duration_sec_get, _mul_nbapi.ofp_flow_removed_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp_flow_removed_duration_nsec_get, _mul_nbapi.ofp_flow_removed_duration_nsec_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp_flow_removed_idle_timeout_get, _mul_nbapi.ofp_flow_removed_idle_timeout_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp_flow_removed_pad2_get, _mul_nbapi.ofp_flow_removed_pad2_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp_flow_removed_packet_count_get, _mul_nbapi.ofp_flow_removed_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp_flow_removed_byte_count_get, _mul_nbapi.ofp_flow_removed_byte_count_set)
...
class ofp_stats_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_stats_request_header_get, _mul_nbapi.ofp_stats_request_header_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_stats_request_type_get, _mul_nbapi.ofp_stats_request_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_stats_request_flags_get, _mul_nbapi.ofp_stats_request_flags_set)
    ...
    if _newclass:
        body = _swig_property(_mul_nbapi.ofp_stats_request_body_get, _mul_nbapi.ofp_stats_request_body_set)
...
class ofp_stats_reply(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_stats_reply_header_get, _mul_nbapi.ofp_stats_reply_header_set)
    __swig_setmethods__["type"] = _mul_nbapi.ofp_stats_reply_type_set
    __swig_getmethods__["type"] = _mul_nbapi.ofp_stats_reply_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_stats_reply_type_get, _mul_nbapi.ofp_stats_reply_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_stats_reply_flags_get, _mul_nbapi.ofp_stats_reply_flags_set)
    __swig_setmethods__["body"] = _mul_nbapi.ofp_stats_reply_body_set
    __swig_getmethods__["body"] = _mul_nbapi.ofp_stats_reply_body_get
    if _newclass:
        body = _swig_property(_mul_nbapi.ofp_stats_reply_body_get, _mul_nbapi.ofp_stats_reply_body_set)
...
class ofp_flow_stats_request(_object):
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp_flow_stats_request_match_get, _mul_nbapi.ofp_flow_stats_request_match_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_flow_stats_request_table_id_get, _mul_nbapi.ofp_flow_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_flow_stats_request_pad_get, _mul_nbapi.ofp_flow_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp_flow_stats_request_out_port_get, _mul_nbapi.ofp_flow_stats_request_out_port_set)
...
class ofp_flow_stats(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_flow_stats_length_get, _mul_nbapi.ofp_flow_stats_length_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_flow_stats_table_id_get, _mul_nbapi.ofp_flow_stats_table_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_flow_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_flow_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_flow_stats_pad_get, _mul_nbapi.ofp_flow_stats_pad_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp_flow_stats_match_get, _mul_nbapi.ofp_flow_stats_match_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp_flow_stats_duration_sec_get, _mul_nbapi.ofp_flow_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp_flow_stats_duration_nsec_get, _mul_nbapi.ofp_flow_stats_duration_nsec_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp_flow_stats_priority_get, _mul_nbapi.ofp_flow_stats_priority_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp_flow_stats_idle_timeout_get, _mul_nbapi.ofp_flow_stats_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp_flow_stats_hard_timeout_get, _mul_nbapi.ofp_flow_stats_hard_timeout_set)
    __swig_setmethods__["pad2"] = _mul_nbapi.ofp_flow_stats_pad2_set
    __swig_getmethods__["pad2"] = _mul_nbapi.ofp_flow_stats_pad2_get
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp_flow_stats_pad2_get, _mul_nbapi.ofp_flow_stats_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp_flow_stats_cookie_get, _mul_nbapi.ofp_flow_stats_cookie_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp_flow_stats_packet_count_get, _mul_nbapi.ofp_flow_stats_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp_flow_stats_byte_count_get, _mul_nbapi.ofp_flow_stats_byte_count_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp_flow_stats_actions_get, _mul_nbapi.ofp_flow_stats_actions_set)
...
class ofp_aggregate_stats_request(_object):
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp_aggregate_stats_request_match_get, _mul_nbapi.ofp_aggregate_stats_request_match_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_aggregate_stats_request_table_id_get, _mul_nbapi.ofp_aggregate_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_aggregate_stats_request_pad_get, _mul_nbapi.ofp_aggregate_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp_aggregate_stats_request_out_port_get, _mul_nbapi.ofp_aggregate_stats_request_out_port_set)
...
class ofp_aggregate_stats_reply(_object):
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp_aggregate_stats_reply_packet_count_get, _mul_nbapi.ofp_aggregate_stats_reply_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp_aggregate_stats_reply_byte_count_get, _mul_nbapi.ofp_aggregate_stats_reply_byte_count_set)
    ...
    if _newclass:
        flow_count = _swig_property(_mul_nbapi.ofp_aggregate_stats_reply_flow_count_get, _mul_nbapi.ofp_aggregate_stats_reply_flow_count_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_aggregate_stats_reply_pad_get, _mul_nbapi.ofp_aggregate_stats_reply_pad_set)
...
class ofp_table_stats(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp_table_stats_table_id_get, _mul_nbapi.ofp_table_stats_table_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_table_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_table_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_table_stats_pad_get, _mul_nbapi.ofp_table_stats_pad_set)
    __swig_setmethods__["name"] = _mul_nbapi.ofp_table_stats_name_set
    __swig_getmethods__["name"] = _mul_nbapi.ofp_table_stats_name_get
    if _newclass:
        name = _swig_property(_mul_nbapi.ofp_table_stats_name_get, _mul_nbapi.ofp_table_stats_name_set)
    ...
    if _newclass:
        wildcards = _swig_property(_mul_nbapi.ofp_table_stats_wildcards_get, _mul_nbapi.ofp_table_stats_wildcards_set)
    ...
    if _newclass:
        max_entries = _swig_property(_mul_nbapi.ofp_table_stats_max_entries_get, _mul_nbapi.ofp_table_stats_max_entries_set)
    ...
    if _newclass:
        active_count = _swig_property(_mul_nbapi.ofp_table_stats_active_count_get, _mul_nbapi.ofp_table_stats_active_count_set)
    ...
    if _newclass:
        lookup_count = _swig_property(_mul_nbapi.ofp_table_stats_lookup_count_get, _mul_nbapi.ofp_table_stats_lookup_count_set)
    ...
    if _newclass:
        matched_count = _swig_property(_mul_nbapi.ofp_table_stats_matched_count_get, _mul_nbapi.ofp_table_stats_matched_count_set)
...
class ofp_port_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_port_stats_request_port_no_get, _mul_nbapi.ofp_port_stats_request_port_no_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_stats_request_pad_get, _mul_nbapi.ofp_port_stats_request_pad_set)
...
class ofp_port_stats(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_port_stats_port_no_get, _mul_nbapi.ofp_port_stats_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_port_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_port_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_stats_pad_get, _mul_nbapi.ofp_port_stats_pad_set)
    ...
    if _newclass:
        rx_packets = _swig_property(_mul_nbapi.ofp_port_stats_rx_packets_get, _mul_nbapi.ofp_port_stats_rx_packets_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp_port_stats_tx_packets_get, _mul_nbapi.ofp_port_stats_tx_packets_set)
    ...
    if _newclass:
        rx_bytes = _swig_property(_mul_nbapi.ofp_port_stats_rx_bytes_get, _mul_nbapi.ofp_port_stats_rx_bytes_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp_port_stats_tx_bytes_get, _mul_nbapi.ofp_port_stats_tx_bytes_set)
    ...
    if _newclass:
        rx_dropped = _swig_property(_mul_nbapi.ofp_port_stats_rx_dropped_get, _mul_nbapi.ofp_port_stats_rx_dropped_set)
    ...
    if _newclass:
        tx_dropped = _swig_property(_mul_nbapi.ofp_port_stats_tx_dropped_get, _mul_nbapi.ofp_port_stats_tx_dropped_set)
    ...
    if _newclass:
        rx_errors = _swig_property(_mul_nbapi.ofp_port_stats_rx_errors_get, _mul_nbapi.ofp_port_stats_rx_errors_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp_port_stats_tx_errors_get, _mul_nbapi.ofp_port_stats_tx_errors_set)
    ...
    if _newclass:
        rx_frame_err = _swig_property(_mul_nbapi.ofp_port_stats_rx_frame_err_get, _mul_nbapi.ofp_port_stats_rx_frame_err_set)
    ...
    if _newclass:
        rx_over_err = _swig_property(_mul_nbapi.ofp_port_stats_rx_over_err_get, _mul_nbapi.ofp_port_stats_rx_over_err_set)
    ...
    if _newclass:
        rx_crc_err = _swig_property(_mul_nbapi.ofp_port_stats_rx_crc_err_get, _mul_nbapi.ofp_port_stats_rx_crc_err_set)
    ...
    if _newclass:
        collisions = _swig_property(_mul_nbapi.ofp_port_stats_collisions_get, _mul_nbapi.ofp_port_stats_collisions_set)
...
class ofp_vendor_header(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_vendor_header_header_get, _mul_nbapi.ofp_vendor_header_header_set)
    ...
    if _newclass:
        vendor = _swig_property(_mul_nbapi.ofp_vendor_header_vendor_get, _mul_nbapi.ofp_vendor_header_vendor_set)
    ...
    if _newclass:
        body = _swig_property(_mul_nbapi.ofp_vendor_header_body_get, _mul_nbapi.ofp_vendor_header_body_set)
...
class ofp_packet_queue(_object):
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp_packet_queue_queue_id_get, _mul_nbapi.ofp_packet_queue_queue_id_set)
    __swig_setmethods__["len"] = _mul_nbapi.ofp_packet_queue_len_set
    __swig_getmethods__["len"] = _mul_nbapi.ofp_packet_queue_len_get
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_packet_queue_len_get, _mul_nbapi.ofp_packet_queue_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_packet_queue_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_packet_queue_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_packet_queue_pad_get, _mul_nbapi.ofp_packet_queue_pad_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp_packet_queue_properties_get, _mul_nbapi.ofp_packet_queue_properties_set)
...
class ofp_queue_get_config_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_queue_get_config_request_header_get, _mul_nbapi.ofp_queue_get_config_request_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp_queue_get_config_request_port_get, _mul_nbapi.ofp_queue_get_config_request_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_get_config_request_pad_get, _mul_nbapi.ofp_queue_get_config_request_pad_set)
...
class ofp_queue_get_config_reply(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp_queue_get_config_reply_header_get, _mul_nbapi.ofp_queue_get_config_reply_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp_queue_get_config_reply_port_get, _mul_nbapi.ofp_queue_get_config_reply_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_get_config_reply_pad_get, _mul_nbapi.ofp_queue_get_config_reply_pad_set)
    ...
    if _newclass:
        queues = _swig_property(_mul_nbapi.ofp_queue_get_config_reply_queues_get, _mul_nbapi.ofp_queue_get_config_reply_queues_set)
...
class ofp_action_enqueue(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_action_enqueue_type_get, _mul_nbapi.ofp_action_enqueue_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_action_enqueue_len_get, _mul_nbapi.ofp_action_enqueue_len_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp_action_enqueue_port_get, _mul_nbapi.ofp_action_enqueue_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_action_enqueue_pad_get, _mul_nbapi.ofp_action_enqueue_pad_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp_action_enqueue_queue_id_get, _mul_nbapi.ofp_action_enqueue_queue_id_set)
...
class ofp_queue_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_queue_stats_request_port_no_get, _mul_nbapi.ofp_queue_stats_request_port_no_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_stats_request_pad_get, _mul_nbapi.ofp_queue_stats_request_pad_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp_queue_stats_request_queue_id_get, _mul_nbapi.ofp_queue_stats_request_queue_id_set)
...
class ofp_queue_stats(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp_queue_stats_port_no_get, _mul_nbapi.ofp_queue_stats_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp_queue_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp_queue_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_queue_stats_pad_get, _mul_nbapi.ofp_queue_stats_pad_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp_queue_stats_queue_id_get, _mul_nbapi.ofp_queue_stats_queue_id_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp_queue_stats_tx_bytes_get, _mul_nbapi.ofp_queue_stats_tx_bytes_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp_queue_stats_tx_packets_get, _mul_nbapi.ofp_queue_stats_tx_packets_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp_queue_stats_tx_errors_get, _mul_nbapi.ofp_queue_stats_tx_errors_set)
...
class ofp131_port(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_port_port_no_get, _mul_nbapi.ofp131_port_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_port_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_port_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_port_pad_get, _mul_nbapi.ofp131_port_pad_set)
    ...
    if _newclass:
        advertised = _swig_property(_mul_nbapi.ofp131_port_advertised_get, _mul_nbapi.ofp131_port_advertised_set)
    ...
    if _newclass:
        supported = _swig_property(_mul_nbapi.ofp131_port_supported_get, _mul_nbapi.ofp131_port_supported_set)
    __swig_setmethods__["peer"] = _mul_nbapi.ofp131_port_peer_set
    __swig_getmethods__["peer"] = _mul_nbapi.ofp131_port_peer_get
    if _newclass:
        peer = _swig_property(_mul_nbapi.ofp131_port_peer_get, _mul_nbapi.ofp131_port_peer_set)
    ...
    if _newclass:
        curr_speed = _swig_property(_mul_nbapi.ofp131_port_curr_speed_get, _mul_nbapi.ofp131_port_curr_speed_set)
    ...
    if _newclass:
        max_speed = _swig_property(_mul_nbapi.ofp131_port_max_speed_get, _mul_nbapi.ofp131_port_max_speed_set)
...
class ofp131_packet_queue(_object):
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp131_packet_queue_queue_id_get, _mul_nbapi.ofp131_packet_queue_queue_id_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp131_packet_queue_port_get, _mul_nbapi.ofp131_packet_queue_port_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp131_packet_queue_len_get, _mul_nbapi.ofp131_packet_queue_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_packet_queue_pad_get, _mul_nbapi.ofp131_packet_queue_pad_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp131_packet_queue_properties_get, _mul_nbapi.ofp131_packet_queue_properties_set)
...
class ofp131_queue_prop_experimenter(_object):
    ...
    if _newclass:
        prop_header = _swig_property(_mul_nbapi.ofp131_queue_prop_experimenter_prop_header_get, _mul_nbapi.ofp131_queue_prop_experimenter_prop_header_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp131_queue_prop_experimenter_experimenter_get, _mul_nbapi.ofp131_queue_prop_experimenter_experimenter_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_queue_prop_experimenter_pad_get, _mul_nbapi.ofp131_queue_prop_experimenter_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp131_queue_prop_experimenter_data_get, _mul_nbapi.ofp131_queue_prop_experimenter_data_set)
...
class ofp131_oxm_experimenter_header(_object):
    ...
    if _newclass:
        oxm_header = _swig_property(_mul_nbapi.ofp131_oxm_experimenter_header_oxm_header_get, _mul_nbapi.ofp131_oxm_experimenter_header_oxm_header_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp131_oxm_experimenter_header_experimenter_get, _mul_nbapi.ofp131_oxm_experimenter_header_experimenter_set)
...
class ofp131_action_output(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp131_action_output_type_get, _mul_nbapi.ofp131_action_output_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp131_action_output_len_get, _mul_nbapi.ofp131_action_output_len_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp131_action_output_port_get, _mul_nbapi.ofp131_action_output_port_set)
    ...
    if _newclass:
        max_len = _swig_property(_mul_nbapi.ofp131_action_output_max_len_get, _mul_nbapi.ofp131_action_output_max_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_action_output_pad_get, _mul_nbapi.ofp131_action_output_pad_set)
...
class ofp131_action_set_queue(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp131_action_set_queue_type_get, _mul_nbapi.ofp131_action_set_queue_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp131_action_set_queue_len_get, _mul_nbapi.ofp131_action_set_queue_len_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp131_action_set_queue_queue_id_get, _mul_nbapi.ofp131_action_set_queue_queue_id_set)
...
class ofp131_switch_features(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_switch_features_header_get, _mul_nbapi.ofp131_switch_features_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.ofp131_switch_features_datapath_id_get, _mul_nbapi.ofp131_switch_features_datapath_id_set)
    ...
    if _newclass:
        n_buffers = _swig_property(_mul_nbapi.ofp131_switch_features_n_buffers_get, _mul_nbapi.ofp131_switch_features_n_buffers_set)
    ...
    if _newclass:
        n_tables = _swig_property(_mul_nbapi.ofp131_switch_features_n_tables_get, _mul_nbapi.ofp131_switch_features_n_tables_set)
    ...
    if _newclass:
        auxiliary_id = _swig_property(_mul_nbapi.ofp131_switch_features_auxiliary_id_get, _mul_nbapi.ofp131_switch_features_auxiliary_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_switch_features_pad_get, _mul_nbapi.ofp131_switch_features_pad_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.ofp131_switch_features_capabilities_get, _mul_nbapi.ofp131_switch_features_capabilities_set)
    ...
    if _newclass:
        reserved = _swig_property(_mul_nbapi.ofp131_switch_features_reserved_get, _mul_nbapi.ofp131_switch_features_reserved_set)
...
class ofp131_flow_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_flow_mod_header_get, _mul_nbapi.ofp131_flow_mod_header_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_flow_mod_cookie_get, _mul_nbapi.ofp131_flow_mod_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp131_flow_mod_cookie_mask_get, _mul_nbapi.ofp131_flow_mod_cookie_mask_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_flow_mod_table_id_get, _mul_nbapi.ofp131_flow_mod_table_id_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.ofp131_flow_mod_command_get, _mul_nbapi.ofp131_flow_mod_command_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp131_flow_mod_idle_timeout_get, _mul_nbapi.ofp131_flow_mod_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp131_flow_mod_hard_timeout_get, _mul_nbapi.ofp131_flow_mod_hard_timeout_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp131_flow_mod_priority_get, _mul_nbapi.ofp131_flow_mod_priority_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp131_flow_mod_buffer_id_get, _mul_nbapi.ofp131_flow_mod_buffer_id_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp131_flow_mod_out_port_get, _mul_nbapi.ofp131_flow_mod_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp131_flow_mod_out_group_get, _mul_nbapi.ofp131_flow_mod_out_group_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp131_flow_mod_flags_get, _mul_nbapi.ofp131_flow_mod_flags_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_flow_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_flow_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_flow_mod_pad_get, _mul_nbapi.ofp131_flow_mod_pad_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_flow_mod_match_get, _mul_nbapi.ofp131_flow_mod_match_set)
...
class ofp131_port_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_port_mod_header_get, _mul_nbapi.ofp131_port_mod_header_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_port_mod_port_no_get, _mul_nbapi.ofp131_port_mod_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_port_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_port_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_port_mod_pad_get, _mul_nbapi.ofp131_port_mod_pad_set)
    ...
    if _newclass:
        hw_addr = _swig_property(_mul_nbapi.ofp131_port_mod_hw_addr_get, _mul_nbapi.ofp131_port_mod_hw_addr_set)
    __swig_setmethods__["pad2"] = _mul_nbapi.ofp131_port_mod_pad2_set
    __swig_getmethods__["pad2"] = _mul_nbapi.ofp131_port_mod_pad2_get
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp131_port_mod_pad2_get, _mul_nbapi.ofp131_port_mod_pad2_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp131_port_mod_config_get, _mul_nbapi.ofp131_port_mod_config_set)
    __swig_setmethods__["mask"] = _mul_nbapi.ofp131_port_mod_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.ofp131_port_mod_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.ofp131_port_mod_mask_get, _mul_nbapi.ofp131_port_mod_mask_set)
    ...
    if _newclass:
        advertise = _swig_property(_mul_nbapi.ofp131_port_mod_advertise_get, _mul_nbapi.ofp131_port_mod_advertise_set)
    __swig_setmethods__["pad3"] = _mul_nbapi.ofp131_port_mod_pad3_set
    __swig_getmethods__["pad3"] = _mul_nbapi.ofp131_port_mod_pad3_get
    if _newclass:
        pad3 = _swig_property(_mul_nbapi.ofp131_port_mod_pad3_get, _mul_nbapi.ofp131_port_mod_pad3_set)
...
class ofp131_flow_stats_request(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_flow_stats_request_table_id_get, _mul_nbapi.ofp131_flow_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_flow_stats_request_pad_get, _mul_nbapi.ofp131_flow_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp131_flow_stats_request_out_port_get, _mul_nbapi.ofp131_flow_stats_request_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp131_flow_stats_request_out_group_get, _mul_nbapi.ofp131_flow_stats_request_out_group_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp131_flow_stats_request_pad2_get, _mul_nbapi.ofp131_flow_stats_request_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_flow_stats_request_cookie_get, _mul_nbapi.ofp131_flow_stats_request_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp131_flow_stats_request_cookie_mask_get, _mul_nbapi.ofp131_flow_stats_request_cookie_mask_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_flow_stats_request_match_get, _mul_nbapi.ofp131_flow_stats_request_match_set)
...
class ofp131_flow_stats(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp131_flow_stats_length_get, _mul_nbapi.ofp131_flow_stats_length_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_flow_stats_table_id_get, _mul_nbapi.ofp131_flow_stats_table_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_flow_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_flow_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_flow_stats_pad_get, _mul_nbapi.ofp131_flow_stats_pad_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp131_flow_stats_duration_sec_get, _mul_nbapi.ofp131_flow_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp131_flow_stats_duration_nsec_get, _mul_nbapi.ofp131_flow_stats_duration_nsec_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp131_flow_stats_priority_get, _mul_nbapi.ofp131_flow_stats_priority_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp131_flow_stats_idle_timeout_get, _mul_nbapi.ofp131_flow_stats_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp131_flow_stats_hard_timeout_get, _mul_nbapi.ofp131_flow_stats_hard_timeout_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp131_flow_stats_flags_get, _mul_nbapi.ofp131_flow_stats_flags_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp131_flow_stats_pad2_get, _mul_nbapi.ofp131_flow_stats_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_flow_stats_cookie_get, _mul_nbapi.ofp131_flow_stats_cookie_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp131_flow_stats_packet_count_get, _mul_nbapi.ofp131_flow_stats_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp131_flow_stats_byte_count_get, _mul_nbapi.ofp131_flow_stats_byte_count_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_flow_stats_match_get, _mul_nbapi.ofp131_flow_stats_match_set)
...
class ofp131_aggregate_stats_request(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_table_id_get, _mul_nbapi.ofp131_aggregate_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_pad_get, _mul_nbapi.ofp131_aggregate_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_out_port_get, _mul_nbapi.ofp131_aggregate_stats_request_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_out_group_get, _mul_nbapi.ofp131_aggregate_stats_request_out_group_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_pad2_get, _mul_nbapi.ofp131_aggregate_stats_request_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_cookie_get, _mul_nbapi.ofp131_aggregate_stats_request_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_cookie_mask_get, _mul_nbapi.ofp131_aggregate_stats_request_cookie_mask_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_aggregate_stats_request_match_get, _mul_nbapi.ofp131_aggregate_stats_request_match_set)
...
class ofp131_table_stats(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_table_stats_table_id_get, _mul_nbapi.ofp131_table_stats_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_table_stats_pad_get, _mul_nbapi.ofp131_table_stats_pad_set)
    ...
    if _newclass:
        active_count = _swig_property(_mul_nbapi.ofp131_table_stats_active_count_get, _mul_nbapi.ofp131_table_stats_active_count_set)
    ...
    if _newclass:
        lookup_count = _swig_property(_mul_nbapi.ofp131_table_stats_lookup_count_get, _mul_nbapi.ofp131_table_stats_lookup_count_set)
    ...
    if _newclass:
        matched_count = _swig_property(_mul_nbapi.ofp131_table_stats_matched_count_get, _mul_nbapi.ofp131_table_stats_matched_count_set)
...
class ofp131_port_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_port_stats_request_port_no_get, _mul_nbapi.ofp131_port_stats_request_port_no_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_port_stats_request_pad_get, _mul_nbapi.ofp131_port_stats_request_pad_set)
...
class ofp131_port_stats(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_port_stats_port_no_get, _mul_nbapi.ofp131_port_stats_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_port_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_port_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_port_stats_pad_get, _mul_nbapi.ofp131_port_stats_pad_set)
    ...
    if _newclass:
        rx_packets = _swig_property(_mul_nbapi.ofp131_port_stats_rx_packets_get, _mul_nbapi.ofp131_port_stats_rx_packets_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp131_port_stats_tx_packets_get, _mul_nbapi.ofp131_port_stats_tx_packets_set)
    ...
    if _newclass:
        rx_bytes = _swig_property(_mul_nbapi.ofp131_port_stats_rx_bytes_get, _mul_nbapi.ofp131_port_stats_rx_bytes_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp131_port_stats_tx_bytes_get, _mul_nbapi.ofp131_port_stats_tx_bytes_set)
    ...
    if _newclass:
        rx_dropped = _swig_property(_mul_nbapi.ofp131_port_stats_rx_dropped_get, _mul_nbapi.ofp131_port_stats_rx_dropped_set)
    ...
    if _newclass:
        tx_dropped = _swig_property(_mul_nbapi.ofp131_port_stats_tx_dropped_get, _mul_nbapi.ofp131_port_stats_tx_dropped_set)
    ...
    if _newclass:
        rx_errors = _swig_property(_mul_nbapi.ofp131_port_stats_rx_errors_get, _mul_nbapi.ofp131_port_stats_rx_errors_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp131_port_stats_tx_errors_get, _mul_nbapi.ofp131_port_stats_tx_errors_set)
    ...
    if _newclass:
        rx_frame_err = _swig_property(_mul_nbapi.ofp131_port_stats_rx_frame_err_get, _mul_nbapi.ofp131_port_stats_rx_frame_err_set)
    ...
    if _newclass:
        rx_over_err = _swig_property(_mul_nbapi.ofp131_port_stats_rx_over_err_get, _mul_nbapi.ofp131_port_stats_rx_over_err_set)
    ...
    if _newclass:
        rx_crc_err = _swig_property(_mul_nbapi.ofp131_port_stats_rx_crc_err_get, _mul_nbapi.ofp131_port_stats_rx_crc_err_set)
    ...
    if _newclass:
        collisions = _swig_property(_mul_nbapi.ofp131_port_stats_collisions_get, _mul_nbapi.ofp131_port_stats_collisions_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp131_port_stats_duration_sec_get, _mul_nbapi.ofp131_port_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp131_port_stats_duration_nsec_get, _mul_nbapi.ofp131_port_stats_duration_nsec_set)
...
class ofp131_queue_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_queue_stats_request_port_no_get, _mul_nbapi.ofp131_queue_stats_request_port_no_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp131_queue_stats_request_queue_id_get, _mul_nbapi.ofp131_queue_stats_request_queue_id_set)
...
class ofp131_queue_stats(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp131_queue_stats_port_no_get, _mul_nbapi.ofp131_queue_stats_port_no_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp131_queue_stats_queue_id_get, _mul_nbapi.ofp131_queue_stats_queue_id_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp131_queue_stats_tx_bytes_get, _mul_nbapi.ofp131_queue_stats_tx_bytes_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp131_queue_stats_tx_packets_get, _mul_nbapi.ofp131_queue_stats_tx_packets_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp131_queue_stats_tx_errors_get, _mul_nbapi.ofp131_queue_stats_tx_errors_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp131_queue_stats_duration_sec_get, _mul_nbapi.ofp131_queue_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp131_queue_stats_duration_nsec_get, _mul_nbapi.ofp131_queue_stats_duration_nsec_set)
...
class ofp131_packet_out(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_packet_out_header_get, _mul_nbapi.ofp131_packet_out_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp131_packet_out_buffer_id_get, _mul_nbapi.ofp131_packet_out_buffer_id_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.ofp131_packet_out_in_port_get, _mul_nbapi.ofp131_packet_out_in_port_set)
    ...
    if _newclass:
        actions_len = _swig_property(_mul_nbapi.ofp131_packet_out_actions_len_get, _mul_nbapi.ofp131_packet_out_actions_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp131_packet_out_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp131_packet_out_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_packet_out_pad_get, _mul_nbapi.ofp131_packet_out_pad_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp131_packet_out_actions_get, _mul_nbapi.ofp131_packet_out_actions_set)
...
class ofp131_packet_in(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_packet_in_header_get, _mul_nbapi.ofp131_packet_in_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp131_packet_in_buffer_id_get, _mul_nbapi.ofp131_packet_in_buffer_id_set)
    ...
    if _newclass:
        total_len = _swig_property(_mul_nbapi.ofp131_packet_in_total_len_get, _mul_nbapi.ofp131_packet_in_total_len_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp131_packet_in_reason_get, _mul_nbapi.ofp131_packet_in_reason_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_packet_in_table_id_get, _mul_nbapi.ofp131_packet_in_table_id_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_packet_in_cookie_get, _mul_nbapi.ofp131_packet_in_cookie_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_packet_in_match_get, _mul_nbapi.ofp131_packet_in_match_set)
...
class ofp131_flow_removed(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_flow_removed_header_get, _mul_nbapi.ofp131_flow_removed_header_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp131_flow_removed_cookie_get, _mul_nbapi.ofp131_flow_removed_cookie_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp131_flow_removed_priority_get, _mul_nbapi.ofp131_flow_removed_priority_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp131_flow_removed_reason_get, _mul_nbapi.ofp131_flow_removed_reason_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp131_flow_removed_table_id_get, _mul_nbapi.ofp131_flow_removed_table_id_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp131_flow_removed_duration_sec_get, _mul_nbapi.ofp131_flow_removed_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp131_flow_removed_duration_nsec_get, _mul_nbapi.ofp131_flow_removed_duration_nsec_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp131_flow_removed_idle_timeout_get, _mul_nbapi.ofp131_flow_removed_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp131_flow_removed_hard_timeout_get, _mul_nbapi.ofp131_flow_removed_hard_timeout_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp131_flow_removed_packet_count_get, _mul_nbapi.ofp131_flow_removed_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp131_flow_removed_byte_count_get, _mul_nbapi.ofp131_flow_removed_byte_count_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp131_flow_removed_match_get, _mul_nbapi.ofp131_flow_removed_match_set)
...
class ofp131_port_status(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_port_status_header_get, _mul_nbapi.ofp131_port_status_header_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp131_port_status_reason_get, _mul_nbapi.ofp131_port_status_reason_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_port_status_pad_get, _mul_nbapi.ofp131_port_status_pad_set)
    ...
    if _newclass:
        desc = _swig_property(_mul_nbapi.ofp131_port_status_desc_get, _mul_nbapi.ofp131_port_status_desc_set)
...
class ofp131_queue_get_config_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_queue_get_config_request_header_get, _mul_nbapi.ofp131_queue_get_config_request_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp131_queue_get_config_request_port_get, _mul_nbapi.ofp131_queue_get_config_request_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_queue_get_config_request_pad_get, _mul_nbapi.ofp131_queue_get_config_request_pad_set)
...
class ofp131_queue_get_config_reply(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_queue_get_config_reply_header_get, _mul_nbapi.ofp131_queue_get_config_reply_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp131_queue_get_config_reply_port_get, _mul_nbapi.ofp131_queue_get_config_reply_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp131_queue_get_config_reply_pad_get, _mul_nbapi.ofp131_queue_get_config_reply_pad_set)
    ...
    if _newclass:
        queues = _swig_property(_mul_nbapi.ofp131_queue_get_config_reply_queues_get, _mul_nbapi.ofp131_queue_get_config_reply_queues_set)
...
class ofp131_error_experimenter_msg(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp131_error_experimenter_msg_header_get, _mul_nbapi.ofp131_error_experimenter_msg_header_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp131_error_experimenter_msg_type_get, _mul_nbapi.ofp131_error_experimenter_msg_type_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp131_error_experimenter_msg_exp_type_get, _mul_nbapi.ofp131_error_experimenter_msg_exp_type_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp131_error_experimenter_msg_experimenter_get, _mul_nbapi.ofp131_error_experimenter_msg_experimenter_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp131_error_experimenter_msg_data_get, _mul_nbapi.ofp131_error_experimenter_msg_data_set)
...
class ofp_port_desc_prop_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_desc_prop_header_type_get, _mul_nbapi.ofp_port_desc_prop_header_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_desc_prop_header_length_get, _mul_nbapi.ofp_port_desc_prop_header_length_set)
...
class ofp_port_desc_prop_ethernet(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_type_get, _mul_nbapi.ofp_port_desc_prop_ethernet_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_length_get, _mul_nbapi.ofp_port_desc_prop_ethernet_length_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_pad_get, _mul_nbapi.ofp_port_desc_prop_ethernet_pad_set)
    ...
    if _newclass:
        curr = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_curr_get, _mul_nbapi.ofp_port_desc_prop_ethernet_curr_set)
    ...
    if _newclass:
        advertised = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_advertised_get, _mul_nbapi.ofp_port_desc_prop_ethernet_advertised_set)
    ...
    if _newclass:
        supported = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_supported_get, _mul_nbapi.ofp_port_desc_prop_ethernet_supported_set)
    ...
    if _newclass:
        peer = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_peer_get, _mul_nbapi.ofp_port_desc_prop_ethernet_peer_set)
    ...
    if _newclass:
        curr_speed = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_curr_speed_get, _mul_nbapi.ofp_port_desc_prop_ethernet_curr_speed_set)
    ...
    if _newclass:
        max_speed = _swig_property(_mul_nbapi.ofp_port_desc_prop_ethernet_max_speed_get, _mul_nbapi.ofp_port_desc_prop_ethernet_max_speed_set)
...
class ofp_port_desc_prop_optical(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_type_get, _mul_nbapi.ofp_port_desc_prop_optical_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_length_get, _mul_nbapi.ofp_port_desc_prop_optical_length_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_pad_get, _mul_nbapi.ofp_port_desc_prop_optical_pad_set)
    ...
    if _newclass:
        supported = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_supported_get, _mul_nbapi.ofp_port_desc_prop_optical_supported_set)
    ...
    if _newclass:
        tx_min_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_tx_min_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_tx_min_freq_lmda_set)
    ...
    if _newclass:
        tx_max_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_tx_max_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_tx_max_freq_lmda_set)
    ...
    if _newclass:
        tx_grid_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_tx_grid_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_tx_grid_freq_lmda_set)
    ...
    if _newclass:
        rx_min_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_rx_min_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_rx_min_freq_lmda_set)
    ...
    if _newclass:
        rx_max_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_rx_max_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_rx_max_freq_lmda_set)
    ...
    if _newclass:
        rx_grid_freq_lmda = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_rx_grid_freq_lmda_get, _mul_nbapi.ofp_port_desc_prop_optical_rx_grid_freq_lmda_set)
    ...
    if _newclass:
        tx_pwr_min = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_tx_pwr_min_get, _mul_nbapi.ofp_port_desc_prop_optical_tx_pwr_min_set)
    ...
    if _newclass:
        tx_pwr_max = _swig_property(_mul_nbapi.ofp_port_desc_prop_optical_tx_pwr_max_get, _mul_nbapi.ofp_port_desc_prop_optical_tx_pwr_max_set)
...
class ofp140_port(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_port_port_no_get, _mul_nbapi.ofp140_port_port_no_set)
    __swig_setmethods__["length"] = _mul_nbapi.ofp140_port_length_set
    __swig_getmethods__["length"] = _mul_nbapi.ofp140_port_length_get
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp140_port_length_get, _mul_nbapi.ofp140_port_length_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_port_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_port_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_port_pad_get, _mul_nbapi.ofp140_port_pad_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp140_port_properties_get, _mul_nbapi.ofp140_port_properties_set)
...
class ofp140_packet_queue(_object):
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp140_packet_queue_queue_id_get, _mul_nbapi.ofp140_packet_queue_queue_id_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp140_packet_queue_port_get, _mul_nbapi.ofp140_packet_queue_port_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp140_packet_queue_len_get, _mul_nbapi.ofp140_packet_queue_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_packet_queue_pad_get, _mul_nbapi.ofp140_packet_queue_pad_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp140_packet_queue_properties_get, _mul_nbapi.ofp140_packet_queue_properties_set)
...
class ofp140_queue_prop_experimenter(_object):
    ...
    if _newclass:
        prop_header = _swig_property(_mul_nbapi.ofp140_queue_prop_experimenter_prop_header_get, _mul_nbapi.ofp140_queue_prop_experimenter_prop_header_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp140_queue_prop_experimenter_experimenter_get, _mul_nbapi.ofp140_queue_prop_experimenter_experimenter_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_queue_prop_experimenter_pad_get, _mul_nbapi.ofp140_queue_prop_experimenter_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp140_queue_prop_experimenter_data_get, _mul_nbapi.ofp140_queue_prop_experimenter_data_set)
...
class ofp140_oxm_experimenter_header(_object):
    ...
    if _newclass:
        oxm_header = _swig_property(_mul_nbapi.ofp140_oxm_experimenter_header_oxm_header_get, _mul_nbapi.ofp140_oxm_experimenter_header_oxm_header_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp140_oxm_experimenter_header_experimenter_get, _mul_nbapi.ofp140_oxm_experimenter_header_experimenter_set)
...
class ofp140_action_output(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp140_action_output_type_get, _mul_nbapi.ofp140_action_output_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp140_action_output_len_get, _mul_nbapi.ofp140_action_output_len_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp140_action_output_port_get, _mul_nbapi.ofp140_action_output_port_set)
    ...
    if _newclass:
        max_len = _swig_property(_mul_nbapi.ofp140_action_output_max_len_get, _mul_nbapi.ofp140_action_output_max_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_action_output_pad_get, _mul_nbapi.ofp140_action_output_pad_set)
...
class ofp140_action_set_queue(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp140_action_set_queue_type_get, _mul_nbapi.ofp140_action_set_queue_type_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp140_action_set_queue_len_get, _mul_nbapi.ofp140_action_set_queue_len_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp140_action_set_queue_queue_id_get, _mul_nbapi.ofp140_action_set_queue_queue_id_set)
...
class ofp140_switch_features(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_switch_features_header_get, _mul_nbapi.ofp140_switch_features_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.ofp140_switch_features_datapath_id_get, _mul_nbapi.ofp140_switch_features_datapath_id_set)
    ...
    if _newclass:
        n_buffers = _swig_property(_mul_nbapi.ofp140_switch_features_n_buffers_get, _mul_nbapi.ofp140_switch_features_n_buffers_set)
    ...
    if _newclass:
        n_tables = _swig_property(_mul_nbapi.ofp140_switch_features_n_tables_get, _mul_nbapi.ofp140_switch_features_n_tables_set)
    ...
    if _newclass:
        auxiliary_id = _swig_property(_mul_nbapi.ofp140_switch_features_auxiliary_id_get, _mul_nbapi.ofp140_switch_features_auxiliary_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_switch_features_pad_get, _mul_nbapi.ofp140_switch_features_pad_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.ofp140_switch_features_capabilities_get, _mul_nbapi.ofp140_switch_features_capabilities_set)
    ...
    if _newclass:
        reserved = _swig_property(_mul_nbapi.ofp140_switch_features_reserved_get, _mul_nbapi.ofp140_switch_features_reserved_set)
...
class ofp140_flow_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_flow_mod_header_get, _mul_nbapi.ofp140_flow_mod_header_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_flow_mod_cookie_get, _mul_nbapi.ofp140_flow_mod_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp140_flow_mod_cookie_mask_get, _mul_nbapi.ofp140_flow_mod_cookie_mask_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_flow_mod_table_id_get, _mul_nbapi.ofp140_flow_mod_table_id_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.ofp140_flow_mod_command_get, _mul_nbapi.ofp140_flow_mod_command_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp140_flow_mod_idle_timeout_get, _mul_nbapi.ofp140_flow_mod_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp140_flow_mod_hard_timeout_get, _mul_nbapi.ofp140_flow_mod_hard_timeout_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp140_flow_mod_priority_get, _mul_nbapi.ofp140_flow_mod_priority_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp140_flow_mod_buffer_id_get, _mul_nbapi.ofp140_flow_mod_buffer_id_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp140_flow_mod_out_port_get, _mul_nbapi.ofp140_flow_mod_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp140_flow_mod_out_group_get, _mul_nbapi.ofp140_flow_mod_out_group_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp140_flow_mod_flags_get, _mul_nbapi.ofp140_flow_mod_flags_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_flow_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_flow_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_flow_mod_pad_get, _mul_nbapi.ofp140_flow_mod_pad_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_flow_mod_match_get, _mul_nbapi.ofp140_flow_mod_match_set)
...
class ofp_port_mod_prop_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_mod_prop_header_type_get, _mul_nbapi.ofp_port_mod_prop_header_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_mod_prop_header_length_get, _mul_nbapi.ofp_port_mod_prop_header_length_set)
...
class ofp_port_mod_prop_ethernet(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_mod_prop_ethernet_type_get, _mul_nbapi.ofp_port_mod_prop_ethernet_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_mod_prop_ethernet_length_get, _mul_nbapi.ofp_port_mod_prop_ethernet_length_set)
    ...
    if _newclass:
        advertise = _swig_property(_mul_nbapi.ofp_port_mod_prop_ethernet_advertise_get, _mul_nbapi.ofp_port_mod_prop_ethernet_advertise_set)
...
class ofp_port_mod_prop_optical(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_type_get, _mul_nbapi.ofp_port_mod_prop_optical_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_length_get, _mul_nbapi.ofp_port_mod_prop_optical_length_set)
    ...
    if _newclass:
        configure = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_configure_get, _mul_nbapi.ofp_port_mod_prop_optical_configure_set)
    ...
    if _newclass:
        freq_lmda = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_freq_lmda_get, _mul_nbapi.ofp_port_mod_prop_optical_freq_lmda_set)
    ...
    if _newclass:
        fl_offset = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_fl_offset_get, _mul_nbapi.ofp_port_mod_prop_optical_fl_offset_set)
    ...
    if _newclass:
        grid_span = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_grid_span_get, _mul_nbapi.ofp_port_mod_prop_optical_grid_span_set)
    ...
    if _newclass:
        tx_pwr = _swig_property(_mul_nbapi.ofp_port_mod_prop_optical_tx_pwr_get, _mul_nbapi.ofp_port_mod_prop_optical_tx_pwr_set)
...
class ofp_port_mod_prop_experimenter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_mod_prop_experimenter_type_get, _mul_nbapi.ofp_port_mod_prop_experimenter_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_mod_prop_experimenter_length_get, _mul_nbapi.ofp_port_mod_prop_experimenter_length_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_port_mod_prop_experimenter_experimenter_get, _mul_nbapi.ofp_port_mod_prop_experimenter_experimenter_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp_port_mod_prop_experimenter_exp_type_get, _mul_nbapi.ofp_port_mod_prop_experimenter_exp_type_set)
    ...
    if _newclass:
        experimenter_data = _swig_property(_mul_nbapi.ofp_port_mod_prop_experimenter_experimenter_data_get, _mul_nbapi.ofp_port_mod_prop_experimenter_experimenter_data_set)
...
class ofp140_port_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_port_mod_header_get, _mul_nbapi.ofp140_port_mod_header_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_port_mod_port_no_get, _mul_nbapi.ofp140_port_mod_port_no_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_port_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_port_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_port_mod_pad_get, _mul_nbapi.ofp140_port_mod_pad_set)
    ...
    if _newclass:
        hw_addr = _swig_property(_mul_nbapi.ofp140_port_mod_hw_addr_get, _mul_nbapi.ofp140_port_mod_hw_addr_set)
    __swig_setmethods__["pad2"] = _mul_nbapi.ofp140_port_mod_pad2_set
    __swig_getmethods__["pad2"] = _mul_nbapi.ofp140_port_mod_pad2_get
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp140_port_mod_pad2_get, _mul_nbapi.ofp140_port_mod_pad2_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.ofp140_port_mod_config_get, _mul_nbapi.ofp140_port_mod_config_set)
    __swig_setmethods__["mask"] = _mul_nbapi.ofp140_port_mod_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.ofp140_port_mod_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.ofp140_port_mod_mask_get, _mul_nbapi.ofp140_port_mod_mask_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp140_port_mod_properties_get, _mul_nbapi.ofp140_port_mod_properties_set)
...
class ofp140_flow_stats_request(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_flow_stats_request_table_id_get, _mul_nbapi.ofp140_flow_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_flow_stats_request_pad_get, _mul_nbapi.ofp140_flow_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp140_flow_stats_request_out_port_get, _mul_nbapi.ofp140_flow_stats_request_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp140_flow_stats_request_out_group_get, _mul_nbapi.ofp140_flow_stats_request_out_group_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp140_flow_stats_request_pad2_get, _mul_nbapi.ofp140_flow_stats_request_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_flow_stats_request_cookie_get, _mul_nbapi.ofp140_flow_stats_request_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp140_flow_stats_request_cookie_mask_get, _mul_nbapi.ofp140_flow_stats_request_cookie_mask_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_flow_stats_request_match_get, _mul_nbapi.ofp140_flow_stats_request_match_set)
...
class ofp140_flow_stats(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp140_flow_stats_length_get, _mul_nbapi.ofp140_flow_stats_length_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_flow_stats_table_id_get, _mul_nbapi.ofp140_flow_stats_table_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_flow_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_flow_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_flow_stats_pad_get, _mul_nbapi.ofp140_flow_stats_pad_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp140_flow_stats_duration_sec_get, _mul_nbapi.ofp140_flow_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp140_flow_stats_duration_nsec_get, _mul_nbapi.ofp140_flow_stats_duration_nsec_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp140_flow_stats_priority_get, _mul_nbapi.ofp140_flow_stats_priority_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp140_flow_stats_idle_timeout_get, _mul_nbapi.ofp140_flow_stats_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp140_flow_stats_hard_timeout_get, _mul_nbapi.ofp140_flow_stats_hard_timeout_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp140_flow_stats_flags_get, _mul_nbapi.ofp140_flow_stats_flags_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp140_flow_stats_pad2_get, _mul_nbapi.ofp140_flow_stats_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_flow_stats_cookie_get, _mul_nbapi.ofp140_flow_stats_cookie_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp140_flow_stats_packet_count_get, _mul_nbapi.ofp140_flow_stats_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp140_flow_stats_byte_count_get, _mul_nbapi.ofp140_flow_stats_byte_count_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_flow_stats_match_get, _mul_nbapi.ofp140_flow_stats_match_set)
...
class ofp140_aggregate_stats_request(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_table_id_get, _mul_nbapi.ofp140_aggregate_stats_request_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_pad_get, _mul_nbapi.ofp140_aggregate_stats_request_pad_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_out_port_get, _mul_nbapi.ofp140_aggregate_stats_request_out_port_set)
    ...
    if _newclass:
        out_group = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_out_group_get, _mul_nbapi.ofp140_aggregate_stats_request_out_group_set)
    ...
    if _newclass:
        pad2 = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_pad2_get, _mul_nbapi.ofp140_aggregate_stats_request_pad2_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_cookie_get, _mul_nbapi.ofp140_aggregate_stats_request_cookie_set)
    ...
    if _newclass:
        cookie_mask = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_cookie_mask_get, _mul_nbapi.ofp140_aggregate_stats_request_cookie_mask_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_aggregate_stats_request_match_get, _mul_nbapi.ofp140_aggregate_stats_request_match_set)
...
class ofp140_table_stats(_object):
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_table_stats_table_id_get, _mul_nbapi.ofp140_table_stats_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_table_stats_pad_get, _mul_nbapi.ofp140_table_stats_pad_set)
    ...
    if _newclass:
        active_count = _swig_property(_mul_nbapi.ofp140_table_stats_active_count_get, _mul_nbapi.ofp140_table_stats_active_count_set)
    ...
    if _newclass:
        lookup_count = _swig_property(_mul_nbapi.ofp140_table_stats_lookup_count_get, _mul_nbapi.ofp140_table_stats_lookup_count_set)
    ...
    if _newclass:
        matched_count = _swig_property(_mul_nbapi.ofp140_table_stats_matched_count_get, _mul_nbapi.ofp140_table_stats_matched_count_set)
...
class ofp_port_stats_prop_header(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_stats_prop_header_type_get, _mul_nbapi.ofp_port_stats_prop_header_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_stats_prop_header_length_get, _mul_nbapi.ofp_port_stats_prop_header_length_set)
...
class ofp_port_stats_prop_ethernet(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_type_get, _mul_nbapi.ofp_port_stats_prop_ethernet_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_length_get, _mul_nbapi.ofp_port_stats_prop_ethernet_length_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_pad_get, _mul_nbapi.ofp_port_stats_prop_ethernet_pad_set)
    ...
    if _newclass:
        rx_frame_err = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_rx_frame_err_get, _mul_nbapi.ofp_port_stats_prop_ethernet_rx_frame_err_set)
    ...
    if _newclass:
        rx_over_err = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_rx_over_err_get, _mul_nbapi.ofp_port_stats_prop_ethernet_rx_over_err_set)
    ...
    if _newclass:
        rx_crc_err = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_rx_crc_err_get, _mul_nbapi.ofp_port_stats_prop_ethernet_rx_crc_err_set)
    ...
    if _newclass:
        collisions = _swig_property(_mul_nbapi.ofp_port_stats_prop_ethernet_collisions_get, _mul_nbapi.ofp_port_stats_prop_ethernet_collisions_set)
...
class ofp_port_stats_prop_optical(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_type_get, _mul_nbapi.ofp_port_stats_prop_optical_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_length_get, _mul_nbapi.ofp_port_stats_prop_optical_length_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_pad_get, _mul_nbapi.ofp_port_stats_prop_optical_pad_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_flags_get, _mul_nbapi.ofp_port_stats_prop_optical_flags_set)
    ...
    if _newclass:
        tx_freq_lmda = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_tx_freq_lmda_get, _mul_nbapi.ofp_port_stats_prop_optical_tx_freq_lmda_set)
    ...
    if _newclass:
        tx_offset = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_tx_offset_get, _mul_nbapi.ofp_port_stats_prop_optical_tx_offset_set)
    ...
    if _newclass:
        tx_grid_span = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_tx_grid_span_get, _mul_nbapi.ofp_port_stats_prop_optical_tx_grid_span_set)
    ...
    if _newclass:
        rx_freq_lmda = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_rx_freq_lmda_get, _mul_nbapi.ofp_port_stats_prop_optical_rx_freq_lmda_set)
    ...
    if _newclass:
        rx_offset = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_rx_offset_get, _mul_nbapi.ofp_port_stats_prop_optical_rx_offset_set)
    ...
    if _newclass:
        rx_grid_span = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_rx_grid_span_get, _mul_nbapi.ofp_port_stats_prop_optical_rx_grid_span_set)
    ...
    if _newclass:
        tx_pwr = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_tx_pwr_get, _mul_nbapi.ofp_port_stats_prop_optical_tx_pwr_set)
    ...
    if _newclass:
        rx_pwr = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_rx_pwr_get, _mul_nbapi.ofp_port_stats_prop_optical_rx_pwr_set)
    ...
    if _newclass:
        bias_current = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_bias_current_get, _mul_nbapi.ofp_port_stats_prop_optical_bias_current_set)
    ...
    if _newclass:
        temperature = _swig_property(_mul_nbapi.ofp_port_stats_prop_optical_temperature_get, _mul_nbapi.ofp_port_stats_prop_optical_temperature_set)
...
class ofp_port_stats_prop_experimenter(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp_port_stats_prop_experimenter_type_get, _mul_nbapi.ofp_port_stats_prop_experimenter_type_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp_port_stats_prop_experimenter_length_get, _mul_nbapi.ofp_port_stats_prop_experimenter_length_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp_port_stats_prop_experimenter_experimenter_get, _mul_nbapi.ofp_port_stats_prop_experimenter_experimenter_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp_port_stats_prop_experimenter_exp_type_get, _mul_nbapi.ofp_port_stats_prop_experimenter_exp_type_set)
    ...
    if _newclass:
        experimenter_data = _swig_property(_mul_nbapi.ofp_port_stats_prop_experimenter_experimenter_data_get, _mul_nbapi.ofp_port_stats_prop_experimenter_experimenter_data_set)
...
class ofp140_port_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_port_stats_request_port_no_get, _mul_nbapi.ofp140_port_stats_request_port_no_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_port_stats_request_pad_get, _mul_nbapi.ofp140_port_stats_request_pad_set)
...
class ofp140_port_stats(_object):
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.ofp140_port_stats_length_get, _mul_nbapi.ofp140_port_stats_length_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_port_stats_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_port_stats_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_port_stats_pad_get, _mul_nbapi.ofp140_port_stats_pad_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_port_stats_port_no_get, _mul_nbapi.ofp140_port_stats_port_no_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp140_port_stats_duration_sec_get, _mul_nbapi.ofp140_port_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp140_port_stats_duration_nsec_get, _mul_nbapi.ofp140_port_stats_duration_nsec_set)
    ...
    if _newclass:
        rx_packets = _swig_property(_mul_nbapi.ofp140_port_stats_rx_packets_get, _mul_nbapi.ofp140_port_stats_rx_packets_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp140_port_stats_tx_packets_get, _mul_nbapi.ofp140_port_stats_tx_packets_set)
    ...
    if _newclass:
        rx_bytes = _swig_property(_mul_nbapi.ofp140_port_stats_rx_bytes_get, _mul_nbapi.ofp140_port_stats_rx_bytes_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp140_port_stats_tx_bytes_get, _mul_nbapi.ofp140_port_stats_tx_bytes_set)
    ...
    if _newclass:
        rx_dropped = _swig_property(_mul_nbapi.ofp140_port_stats_rx_dropped_get, _mul_nbapi.ofp140_port_stats_rx_dropped_set)
    ...
    if _newclass:
        tx_dropped = _swig_property(_mul_nbapi.ofp140_port_stats_tx_dropped_get, _mul_nbapi.ofp140_port_stats_tx_dropped_set)
    ...
    if _newclass:
        rx_errors = _swig_property(_mul_nbapi.ofp140_port_stats_rx_errors_get, _mul_nbapi.ofp140_port_stats_rx_errors_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp140_port_stats_tx_errors_get, _mul_nbapi.ofp140_port_stats_tx_errors_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.ofp140_port_stats_properties_get, _mul_nbapi.ofp140_port_stats_properties_set)
...
class ofp140_queue_stats_request(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_queue_stats_request_port_no_get, _mul_nbapi.ofp140_queue_stats_request_port_no_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp140_queue_stats_request_queue_id_get, _mul_nbapi.ofp140_queue_stats_request_queue_id_set)
...
class ofp140_queue_stats(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.ofp140_queue_stats_port_no_get, _mul_nbapi.ofp140_queue_stats_port_no_set)
    ...
    if _newclass:
        queue_id = _swig_property(_mul_nbapi.ofp140_queue_stats_queue_id_get, _mul_nbapi.ofp140_queue_stats_queue_id_set)
    ...
    if _newclass:
        tx_bytes = _swig_property(_mul_nbapi.ofp140_queue_stats_tx_bytes_get, _mul_nbapi.ofp140_queue_stats_tx_bytes_set)
    ...
    if _newclass:
        tx_packets = _swig_property(_mul_nbapi.ofp140_queue_stats_tx_packets_get, _mul_nbapi.ofp140_queue_stats_tx_packets_set)
    ...
    if _newclass:
        tx_errors = _swig_property(_mul_nbapi.ofp140_queue_stats_tx_errors_get, _mul_nbapi.ofp140_queue_stats_tx_errors_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp140_queue_stats_duration_sec_get, _mul_nbapi.ofp140_queue_stats_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp140_queue_stats_duration_nsec_get, _mul_nbapi.ofp140_queue_stats_duration_nsec_set)
...
class ofp140_packet_out(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_packet_out_header_get, _mul_nbapi.ofp140_packet_out_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp140_packet_out_buffer_id_get, _mul_nbapi.ofp140_packet_out_buffer_id_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.ofp140_packet_out_in_port_get, _mul_nbapi.ofp140_packet_out_in_port_set)
    ...
    if _newclass:
        actions_len = _swig_property(_mul_nbapi.ofp140_packet_out_actions_len_get, _mul_nbapi.ofp140_packet_out_actions_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.ofp140_packet_out_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.ofp140_packet_out_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_packet_out_pad_get, _mul_nbapi.ofp140_packet_out_pad_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.ofp140_packet_out_actions_get, _mul_nbapi.ofp140_packet_out_actions_set)
...
class ofp140_packet_in(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_packet_in_header_get, _mul_nbapi.ofp140_packet_in_header_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.ofp140_packet_in_buffer_id_get, _mul_nbapi.ofp140_packet_in_buffer_id_set)
    ...
    if _newclass:
        total_len = _swig_property(_mul_nbapi.ofp140_packet_in_total_len_get, _mul_nbapi.ofp140_packet_in_total_len_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp140_packet_in_reason_get, _mul_nbapi.ofp140_packet_in_reason_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_packet_in_table_id_get, _mul_nbapi.ofp140_packet_in_table_id_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_packet_in_cookie_get, _mul_nbapi.ofp140_packet_in_cookie_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_packet_in_match_get, _mul_nbapi.ofp140_packet_in_match_set)
...
class ofp140_flow_removed(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_flow_removed_header_get, _mul_nbapi.ofp140_flow_removed_header_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.ofp140_flow_removed_cookie_get, _mul_nbapi.ofp140_flow_removed_cookie_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.ofp140_flow_removed_priority_get, _mul_nbapi.ofp140_flow_removed_priority_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp140_flow_removed_reason_get, _mul_nbapi.ofp140_flow_removed_reason_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.ofp140_flow_removed_table_id_get, _mul_nbapi.ofp140_flow_removed_table_id_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.ofp140_flow_removed_duration_sec_get, _mul_nbapi.ofp140_flow_removed_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.ofp140_flow_removed_duration_nsec_get, _mul_nbapi.ofp140_flow_removed_duration_nsec_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.ofp140_flow_removed_idle_timeout_get, _mul_nbapi.ofp140_flow_removed_idle_timeout_set)
    ...
    if _newclass:
        hard_timeout = _swig_property(_mul_nbapi.ofp140_flow_removed_hard_timeout_get, _mul_nbapi.ofp140_flow_removed_hard_timeout_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.ofp140_flow_removed_packet_count_get, _mul_nbapi.ofp140_flow_removed_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.ofp140_flow_removed_byte_count_get, _mul_nbapi.ofp140_flow_removed_byte_count_set)
    ...
    if _newclass:
        match = _swig_property(_mul_nbapi.ofp140_flow_removed_match_get, _mul_nbapi.ofp140_flow_removed_match_set)
...
class ofp140_port_status(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_port_status_header_get, _mul_nbapi.ofp140_port_status_header_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.ofp140_port_status_reason_get, _mul_nbapi.ofp140_port_status_reason_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_port_status_pad_get, _mul_nbapi.ofp140_port_status_pad_set)
    ...
    if _newclass:
        desc = _swig_property(_mul_nbapi.ofp140_port_status_desc_get, _mul_nbapi.ofp140_port_status_desc_set)
...
class ofp140_queue_get_config_request(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_queue_get_config_request_header_get, _mul_nbapi.ofp140_queue_get_config_request_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp140_queue_get_config_request_port_get, _mul_nbapi.ofp140_queue_get_config_request_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_queue_get_config_request_pad_get, _mul_nbapi.ofp140_queue_get_config_request_pad_set)
...
class ofp140_queue_get_config_reply(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_queue_get_config_reply_header_get, _mul_nbapi.ofp140_queue_get_config_reply_header_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.ofp140_queue_get_config_reply_port_get, _mul_nbapi.ofp140_queue_get_config_reply_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.ofp140_queue_get_config_reply_pad_get, _mul_nbapi.ofp140_queue_get_config_reply_pad_set)
    ...
    if _newclass:
        queues = _swig_property(_mul_nbapi.ofp140_queue_get_config_reply_queues_get, _mul_nbapi.ofp140_queue_get_config_reply_queues_set)
...
class ofp140_error_experimenter_msg(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.ofp140_error_experimenter_msg_header_get, _mul_nbapi.ofp140_error_experimenter_msg_header_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.ofp140_error_experimenter_msg_type_get, _mul_nbapi.ofp140_error_experimenter_msg_type_set)
    ...
    if _newclass:
        exp_type = _swig_property(_mul_nbapi.ofp140_error_experimenter_msg_exp_type_get, _mul_nbapi.ofp140_error_experimenter_msg_exp_type_set)
    ...
    if _newclass:
        experimenter = _swig_property(_mul_nbapi.ofp140_error_experimenter_msg_experimenter_get, _mul_nbapi.ofp140_error_experimenter_msg_experimenter_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.ofp140_error_experimenter_msg_data_get, _mul_nbapi.ofp140_error_experimenter_msg_data_set)
...
class of_flow_tbl_props(_object):
    ...
    if _newclass:
        name = _swig_property(_mul_nbapi.of_flow_tbl_props_name_get, _mul_nbapi.of_flow_tbl_props_name_set)
    ...
    if _newclass:
        metadata_match = _swig_property(_mul_nbapi.of_flow_tbl_props_metadata_match_get, _mul_nbapi.of_flow_tbl_props_metadata_match_set)
    ...
    if _newclass:
        metadata_write = _swig_property(_mul_nbapi.of_flow_tbl_props_metadata_write_get, _mul_nbapi.of_flow_tbl_props_metadata_write_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.of_flow_tbl_props_config_get, _mul_nbapi.of_flow_tbl_props_config_set)
    ...
    if _newclass:
        max_entries = _swig_property(_mul_nbapi.of_flow_tbl_props_max_entries_get, _mul_nbapi.of_flow_tbl_props_max_entries_set)
    ...
    if _newclass:
        bm_inst = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_inst_get, _mul_nbapi.of_flow_tbl_props_bm_inst_set)
    ...
    if _newclass:
        bm_inst_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_inst_miss_get, _mul_nbapi.of_flow_tbl_props_bm_inst_miss_set)
    ...
    if _newclass:
        bm_wr_actions = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_wr_actions_get, _mul_nbapi.of_flow_tbl_props_bm_wr_actions_set)
    ...
    if _newclass:
        bm_wr_actions_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_wr_actions_miss_get, _mul_nbapi.of_flow_tbl_props_bm_wr_actions_miss_set)
    ...
    if _newclass:
        bm_app_actions = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_app_actions_get, _mul_nbapi.of_flow_tbl_props_bm_app_actions_set)
    ...
    if _newclass:
        bm_app_actions_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_app_actions_miss_get, _mul_nbapi.of_flow_tbl_props_bm_app_actions_miss_set)
    ...
    if _newclass:
        bm_next_tables = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_next_tables_get, _mul_nbapi.of_flow_tbl_props_bm_next_tables_set)
    ...
    if _newclass:
        bm_next_tables_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_next_tables_miss_get, _mul_nbapi.of_flow_tbl_props_bm_next_tables_miss_set)
    ...
    if _newclass:
        bm_wr_set_field = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_wr_set_field_get, _mul_nbapi.of_flow_tbl_props_bm_wr_set_field_set)
    ...
    if _newclass:
        bm_wr_set_field_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_wr_set_field_miss_get, _mul_nbapi.of_flow_tbl_props_bm_wr_set_field_miss_set)
    ...
    if _newclass:
        bm_app_set_field = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_app_set_field_get, _mul_nbapi.of_flow_tbl_props_bm_app_set_field_set)
    ...
    if _newclass:
        bm_app_set_field_miss = _swig_property(_mul_nbapi.of_flow_tbl_props_bm_app_set_field_miss_get, _mul_nbapi.of_flow_tbl_props_bm_app_set_field_miss_set)
...
class ofp_act_parsers(_object):
    ...
    if _newclass:
        act_output = _swig_property(_mul_nbapi.ofp_act_parsers_act_output_get, _mul_nbapi.ofp_act_parsers_act_output_set)
    ...
    if _newclass:
        act_push = _swig_property(_mul_nbapi.ofp_act_parsers_act_push_get, _mul_nbapi.ofp_act_parsers_act_push_set)
    ...
    if _newclass:
        act_pop_vlan = _swig_property(_mul_nbapi.ofp_act_parsers_act_pop_vlan_get, _mul_nbapi.ofp_act_parsers_act_pop_vlan_set)
    ...
    if _newclass:
        act_pop_mpls = _swig_property(_mul_nbapi.ofp_act_parsers_act_pop_mpls_get, _mul_nbapi.ofp_act_parsers_act_pop_mpls_set)
    ...
    if _newclass:
        act_set_mpls_ttl = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_mpls_ttl_get, _mul_nbapi.ofp_act_parsers_act_set_mpls_ttl_set)
    ...
    if _newclass:
        act_dec_mpls_ttl = _swig_property(_mul_nbapi.ofp_act_parsers_act_dec_mpls_ttl_get, _mul_nbapi.ofp_act_parsers_act_dec_mpls_ttl_set)
    ...
    if _newclass:
        act_pop_pbb = _swig_property(_mul_nbapi.ofp_act_parsers_act_pop_pbb_get, _mul_nbapi.ofp_act_parsers_act_pop_pbb_set)
    ...
    if _newclass:
        act_set_queue = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_queue_get, _mul_nbapi.ofp_act_parsers_act_set_queue_set)
    ...
    if _newclass:
        act_set_grp = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_grp_get, _mul_nbapi.ofp_act_parsers_act_set_grp_set)
    ...
    if _newclass:
        act_set_nw_ttl = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_nw_ttl_get, _mul_nbapi.ofp_act_parsers_act_set_nw_ttl_set)
    ...
    if _newclass:
        act_dec_nw_ttl = _swig_property(_mul_nbapi.ofp_act_parsers_act_dec_nw_ttl_get, _mul_nbapi.ofp_act_parsers_act_dec_nw_ttl_set)
    ...
    if _newclass:
        act_set_vlan = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_vlan_get, _mul_nbapi.ofp_act_parsers_act_set_vlan_set)
    ...
    if _newclass:
        act_set_vlan_pcp = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_vlan_pcp_get, _mul_nbapi.ofp_act_parsers_act_set_vlan_pcp_set)
    ...
    if _newclass:
        act_set_dl_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_dl_dst_get, _mul_nbapi.ofp_act_parsers_act_set_dl_dst_set)
    ...
    if _newclass:
        act_set_dl_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_dl_src_get, _mul_nbapi.ofp_act_parsers_act_set_dl_src_set)
    ...
    if _newclass:
        act_set_nw_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_nw_src_get, _mul_nbapi.ofp_act_parsers_act_set_nw_src_set)
    ...
    if _newclass:
        act_set_nw_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_nw_dst_get, _mul_nbapi.ofp_act_parsers_act_set_nw_dst_set)
    ...
    if _newclass:
        act_set_nw_tos = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_nw_tos_get, _mul_nbapi.ofp_act_parsers_act_set_nw_tos_set)
    ...
    if _newclass:
        act_set_field = _swig_property(_mul_nbapi.ofp_act_parsers_act_set_field_get, _mul_nbapi.ofp_act_parsers_act_set_field_set)
    ...
    if _newclass:
        act_setf_in_port = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_in_port_get, _mul_nbapi.ofp_act_parsers_act_setf_in_port_set)
    ...
    if _newclass:
        act_setf_dl_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_dl_dst_get, _mul_nbapi.ofp_act_parsers_act_setf_dl_dst_set)
    ...
    if _newclass:
        act_setf_dl_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_dl_src_get, _mul_nbapi.ofp_act_parsers_act_setf_dl_src_set)
    ...
    if _newclass:
        act_setf_dl_type = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_dl_type_get, _mul_nbapi.ofp_act_parsers_act_setf_dl_type_set)
    ...
    if _newclass:
        act_setf_dl_vlan = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_dl_vlan_get, _mul_nbapi.ofp_act_parsers_act_setf_dl_vlan_set)
    ...
    if _newclass:
        act_setf_dl_vlan_pcp = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_dl_vlan_pcp_get, _mul_nbapi.ofp_act_parsers_act_setf_dl_vlan_pcp_set)
    ...
    if _newclass:
        act_setf_mpls_label = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_mpls_label_get, _mul_nbapi.ofp_act_parsers_act_setf_mpls_label_set)
    ...
    if _newclass:
        act_setf_mpls_tc = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_mpls_tc_get, _mul_nbapi.ofp_act_parsers_act_setf_mpls_tc_set)
    ...
    if _newclass:
        act_setf_mpls_bos = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_mpls_bos_get, _mul_nbapi.ofp_act_parsers_act_setf_mpls_bos_set)
    ...
    if _newclass:
        act_setf_ipv4_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_ipv4_src_get, _mul_nbapi.ofp_act_parsers_act_setf_ipv4_src_set)
    ...
    if _newclass:
        act_setf_ipv4_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_ipv4_dst_get, _mul_nbapi.ofp_act_parsers_act_setf_ipv4_dst_set)
    ...
    if _newclass:
        act_setf_ipv6_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_ipv6_src_get, _mul_nbapi.ofp_act_parsers_act_setf_ipv6_src_set)
    ...
    if _newclass:
        act_setf_ipv6_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_ipv6_dst_get, _mul_nbapi.ofp_act_parsers_act_setf_ipv6_dst_set)
    ...
    if _newclass:
        act_setf_ipv4_dscp = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_ipv4_dscp_get, _mul_nbapi.ofp_act_parsers_act_setf_ipv4_dscp_set)
    ...
    if _newclass:
        act_setf_tcp_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_tcp_src_get, _mul_nbapi.ofp_act_parsers_act_setf_tcp_src_set)
    ...
    if _newclass:
        act_setf_tcp_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_tcp_dst_get, _mul_nbapi.ofp_act_parsers_act_setf_tcp_dst_set)
    ...
    if _newclass:
        act_setf_udp_dst = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_udp_dst_get, _mul_nbapi.ofp_act_parsers_act_setf_udp_dst_set)
    ...
    if _newclass:
        act_setf_udp_src = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_udp_src_get, _mul_nbapi.ofp_act_parsers_act_setf_udp_src_set)
    ...
    if _newclass:
        act_setf_tunnel = _swig_property(_mul_nbapi.ofp_act_parsers_act_setf_tunnel_get, _mul_nbapi.ofp_act_parsers_act_setf_tunnel_set)
    ...
    if _newclass:
        act_cp_ttl_out = _swig_property(_mul_nbapi.ofp_act_parsers_act_cp_ttl_out_get, _mul_nbapi.ofp_act_parsers_act_cp_ttl_out_set)
    ...
    if _newclass:
        act_cp_ttl_in = _swig_property(_mul_nbapi.ofp_act_parsers_act_cp_ttl_in_get, _mul_nbapi.ofp_act_parsers_act_cp_ttl_in_set)
    ...
    if _newclass:
        act_exp = _swig_property(_mul_nbapi.ofp_act_parsers_act_exp_get, _mul_nbapi.ofp_act_parsers_act_exp_set)
...
class ofp_inst_parsers(_object):
    ...
    if _newclass:
        prep_inst_parser = _swig_property(_mul_nbapi.ofp_inst_parsers_prep_inst_parser_get, _mul_nbapi.ofp_inst_parsers_prep_inst_parser_set)
    ...
    if _newclass:
        pre_proc = _swig_property(_mul_nbapi.ofp_inst_parsers_pre_proc_get, _mul_nbapi.ofp_inst_parsers_pre_proc_set)
    ...
    if _newclass:
        post_proc = _swig_property(_mul_nbapi.ofp_inst_parsers_post_proc_get, _mul_nbapi.ofp_inst_parsers_post_proc_set)
    ...
    if _newclass:
        no_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_no_inst_get, _mul_nbapi.ofp_inst_parsers_no_inst_set)
    ...
    if _newclass:
        goto_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_goto_inst_get, _mul_nbapi.ofp_inst_parsers_goto_inst_set)
    ...
    if _newclass:
        wr_meta_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_wr_meta_inst_get, _mul_nbapi.ofp_inst_parsers_wr_meta_inst_set)
    ...
    if _newclass:
        wr_act_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_wr_act_inst_get, _mul_nbapi.ofp_inst_parsers_wr_act_inst_set)
    ...
    if _newclass:
        apply_act_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_apply_act_inst_get, _mul_nbapi.ofp_inst_parsers_apply_act_inst_set)
    ...
    if _newclass:
        clear_act_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_clear_act_inst_get, _mul_nbapi.ofp_inst_parsers_clear_act_inst_set)
    ...
    if _newclass:
        meter_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_meter_inst_get, _mul_nbapi.ofp_inst_parsers_meter_inst_set)
    ...
    if _newclass:
        exp_inst = _swig_property(_mul_nbapi.ofp_inst_parsers_exp_inst_get, _mul_nbapi.ofp_inst_parsers_exp_inst_set)
    ...
    if _newclass:
        fini_inst_parser = _swig_property(_mul_nbapi.ofp_inst_parsers_fini_inst_parser_get, _mul_nbapi.ofp_inst_parsers_fini_inst_parser_set)
...
class ofp_inst_parser_arg(_object):
    ...
    if _newclass:
        fl = _swig_property(_mul_nbapi.ofp_inst_parser_arg_fl_get, _mul_nbapi.ofp_inst_parser_arg_fl_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.ofp_inst_parser_arg_mask_get, _mul_nbapi.ofp_inst_parser_arg_mask_set)
    ...
    if _newclass:
        res = _swig_property(_mul_nbapi.ofp_inst_parser_arg_res_get, _mul_nbapi.ofp_inst_parser_arg_res_set)
    ...
    if _newclass:
        pbuf = _swig_property(_mul_nbapi.ofp_inst_parser_arg_pbuf_get, _mul_nbapi.ofp_inst_parser_arg_pbuf_set)
    ...
    if _newclass:
        len = _swig_property(_mul_nbapi.ofp_inst_parser_arg_len_get, _mul_nbapi.ofp_inst_parser_arg_len_set)
    ...
    if _newclass:
        u_arg = _swig_property(_mul_nbapi.ofp_inst_parser_arg_u_arg_get, _mul_nbapi.ofp_inst_parser_arg_u_arg_set)
    ...
    if _newclass:
        act_set = _swig_property(_mul_nbapi.ofp_inst_parser_arg_act_set_get, _mul_nbapi.ofp_inst_parser_arg_act_set_set)
    ...
    if _newclass:
        inst_wr = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_wr_get, _mul_nbapi.ofp_inst_parser_arg_inst_wr_set)
    ...
    if _newclass:
        inst_app = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_app_get, _mul_nbapi.ofp_inst_parser_arg_inst_app_set)
    ...
    if _newclass:
        inst_goto = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_goto_get, _mul_nbapi.ofp_inst_parser_arg_inst_goto_set)
    ...
    if _newclass:
        inst_meter = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_meter_get, _mul_nbapi.ofp_inst_parser_arg_inst_meter_set)
    ...
    if _newclass:
        inst_clear = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_clear_get, _mul_nbapi.ofp_inst_parser_arg_inst_clear_set)
    ...
    if _newclass:
        inst_wr_meta = _swig_property(_mul_nbapi.ofp_inst_parser_arg_inst_wr_meta_get, _mul_nbapi.ofp_inst_parser_arg_inst_wr_meta_set)
    ...
    if _newclass:
        mod_fl_flag = _swig_property(_mul_nbapi.ofp_inst_parser_arg_mod_fl_flag_get, _mul_nbapi.ofp_inst_parser_arg_mod_fl_flag_set)
    ...
    if _newclass:
        push_mpls = _swig_property(_mul_nbapi.ofp_inst_parser_arg_push_mpls_get, _mul_nbapi.ofp_inst_parser_arg_push_mpls_set)
    ...
    if _newclass:
        push_vlan = _swig_property(_mul_nbapi.ofp_inst_parser_arg_push_vlan_get, _mul_nbapi.ofp_inst_parser_arg_push_vlan_set)
    ...
    if _newclass:
        push_pbb = _swig_property(_mul_nbapi.ofp_inst_parser_arg_push_pbb_get, _mul_nbapi.ofp_inst_parser_arg_push_pbb_set)
    ...
    if _newclass:
        parsers = _swig_property(_mul_nbapi.ofp_inst_parser_arg_parsers_get, _mul_nbapi.ofp_inst_parser_arg_parsers_set)
    ...
    if _newclass:
        act_parsers = _swig_property(_mul_nbapi.ofp_inst_parser_arg_act_parsers_get, _mul_nbapi.ofp_inst_parser_arg_act_parsers_set)
...
class ofp_inst_check_args(_object):
    ...
    if _newclass:
        fl = _swig_property(_mul_nbapi.ofp_inst_check_args_fl_get, _mul_nbapi.ofp_inst_check_args_fl_set)
    ...
    if _newclass:
        sw_ctx = _swig_property(_mul_nbapi.ofp_inst_check_args_sw_ctx_get, _mul_nbapi.ofp_inst_check_args_sw_ctx_set)
    ...
    if _newclass:
        group_act_check = _swig_property(_mul_nbapi.ofp_inst_check_args_group_act_check_get, _mul_nbapi.ofp_inst_check_args_group_act_check_set)
    ...
    if _newclass:
        tbl_prop = _swig_property(_mul_nbapi.ofp_inst_check_args_tbl_prop_get, _mul_nbapi.ofp_inst_check_args_tbl_prop_set)
    ...
    if _newclass:
        grp_prop = _swig_property(_mul_nbapi.ofp_inst_check_args_grp_prop_get, _mul_nbapi.ofp_inst_check_args_grp_prop_set)
    ...
    if _newclass:
        check_setf_supp = _swig_property(_mul_nbapi.ofp_inst_check_args_check_setf_supp_get, _mul_nbapi.ofp_inst_check_args_check_setf_supp_set)
    ...
    if _newclass:
        inst_local = _swig_property(_mul_nbapi.ofp_inst_check_args_inst_local_get, _mul_nbapi.ofp_inst_check_args_inst_local_set)
    ...
    if _newclass:
        grp_list = _swig_property(_mul_nbapi.ofp_inst_check_args_grp_list_get, _mul_nbapi.ofp_inst_check_args_grp_list_set)
    ...
    if _newclass:
        meter_list = _swig_property(_mul_nbapi.ofp_inst_check_args_meter_list_get, _mul_nbapi.ofp_inst_check_args_meter_list_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.ofp_inst_check_args_out_port_get, _mul_nbapi.ofp_inst_check_args_out_port_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.ofp_inst_check_args_group_id_get, _mul_nbapi.ofp_inst_check_args_group_id_set)
    ...
    if _newclass:
        check_port = _swig_property(_mul_nbapi.ofp_inst_check_args_check_port_get, _mul_nbapi.ofp_inst_check_args_check_port_set)
    ...
    if _newclass:
        check_add_meter = _swig_property(_mul_nbapi.ofp_inst_check_args_check_add_meter_get, _mul_nbapi.ofp_inst_check_args_check_add_meter_set)
    ...
    if _newclass:
        check_add_group = _swig_property(_mul_nbapi.ofp_inst_check_args_check_add_group_get, _mul_nbapi.ofp_inst_check_args_check_add_group_set)
    ...
    if _newclass:
        get_v2p_tbl = _swig_property(_mul_nbapi.ofp_inst_check_args_get_v2p_tbl_get, _mul_nbapi.ofp_inst_check_args_get_v2p_tbl_set)
...
class ofpx_oxm_parser_arg(_object):
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.ofpx_oxm_parser_arg_flow_get, _mul_nbapi.ofpx_oxm_parser_arg_flow_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.ofpx_oxm_parser_arg_mask_get, _mul_nbapi.ofpx_oxm_parser_arg_mask_set)
...
class of_act_vec_elem(_object):
    ...
    if _newclass:
        weight = _swig_property(_mul_nbapi.of_act_vec_elem_weight_get, _mul_nbapi.of_act_vec_elem_weight_set)
    ...
    if _newclass:
        ff_port = _swig_property(_mul_nbapi.of_act_vec_elem_ff_port_get, _mul_nbapi.of_act_vec_elem_ff_port_set)
    ...
    if _newclass:
        ff_group = _swig_property(_mul_nbapi.of_act_vec_elem_ff_group_get, _mul_nbapi.of_act_vec_elem_ff_group_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.of_act_vec_elem_actions_get, _mul_nbapi.of_act_vec_elem_actions_set)
    ...
    if _newclass:
        action_len = _swig_property(_mul_nbapi.of_act_vec_elem_action_len_get, _mul_nbapi.of_act_vec_elem_action_len_set)
...
class of_meter_band_elem(_object):
    ...
    if _newclass:
        band = _swig_property(_mul_nbapi.of_meter_band_elem_band_get, _mul_nbapi.of_meter_band_elem_band_set)
    ...
    if _newclass:
        band_len = _swig_property(_mul_nbapi.of_meter_band_elem_band_len_get, _mul_nbapi.of_meter_band_elem_band_len_set)
...
class of_meter_band_parms(_object):
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.of_meter_band_parms_rate_get, _mul_nbapi.of_meter_band_parms_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.of_meter_band_parms_burst_size_get, _mul_nbapi.of_meter_band_parms_burst_size_set)
    ...
    if _newclass:
        prec_level = _swig_property(_mul_nbapi.of_meter_band_parms_prec_level_get, _mul_nbapi.of_meter_band_parms_prec_level_set)
...
class mul_act_mdata(_object):
    ...
    if _newclass:
        act_base = _swig_property(_mul_nbapi.mul_act_mdata_act_base_get, _mul_nbapi.mul_act_mdata_act_base_set)
    ...
    if _newclass:
        act_wr_ptr = _swig_property(_mul_nbapi.mul_act_mdata_act_wr_ptr_get, _mul_nbapi.mul_act_mdata_act_wr_ptr_set)
    ...
    if _newclass:
        act_inst_wr_ptr = _swig_property(_mul_nbapi.mul_act_mdata_act_inst_wr_ptr_get, _mul_nbapi.mul_act_mdata_act_inst_wr_ptr_set)
    ...
    if _newclass:
        act_inst_app_ptr = _swig_property(_mul_nbapi.mul_act_mdata_act_inst_app_ptr_get, _mul_nbapi.mul_act_mdata_act_inst_app_ptr_set)
    ...
    if _newclass:
        n_wracts = _swig_property(_mul_nbapi.mul_act_mdata_n_wracts_get, _mul_nbapi.mul_act_mdata_n_wracts_set)
    ...
    if _newclass:
        n_appacts = _swig_property(_mul_nbapi.mul_act_mdata_n_appacts_get, _mul_nbapi.mul_act_mdata_n_appacts_set)
    ...
    if _newclass:
        n_clracts = _swig_property(_mul_nbapi.mul_act_mdata_n_clracts_get, _mul_nbapi.mul_act_mdata_n_clracts_set)
    ...
    if _newclass:
        buf_len = _swig_property(_mul_nbapi.mul_act_mdata_buf_len_get, _mul_nbapi.mul_act_mdata_buf_len_set)
    ...
    if _newclass:
        only_acts = _swig_property(_mul_nbapi.mul_act_mdata_only_acts_get, _mul_nbapi.mul_act_mdata_only_acts_set)
    ...
    if _newclass:
        act_inst_type = _swig_property(_mul_nbapi.mul_act_mdata_act_inst_type_get, _mul_nbapi.mul_act_mdata_act_inst_type_set)
    ...
    if _newclass:
        inst_bm = _swig_property(_mul_nbapi.mul_act_mdata_inst_bm_get, _mul_nbapi.mul_act_mdata_inst_bm_set)
    ...
    if _newclass:
        act_bm = _swig_property(_mul_nbapi.mul_act_mdata_act_bm_get, _mul_nbapi.mul_act_mdata_act_bm_set)
    ...
    if _newclass:
        setf_bm = _swig_property(_mul_nbapi.mul_act_mdata_setf_bm_get, _mul_nbapi.mul_act_mdata_setf_bm_set)
    ...
    if _newclass:
        ofp_ctors = _swig_property(_mul_nbapi.mul_act_mdata_ofp_ctors_get, _mul_nbapi.mul_act_mdata_ofp_ctors_set)
...
def of_mact_mdata_reset(mdata):
    return _mul_nbapi.of_mact_mdata_reset(mdata)
of_mact_mdata_reset = _mul_nbapi.of_mact_mdata_reset

def of_mact_mdata_init(mdata, len):
    return _mul_nbapi.of_mact_mdata_init(mdata, len)
of_mact_mdata_init = _mul_nbapi.of_mact_mdata_init

def of_mact_mdata_reset_act_wr_inst(mdata):
    return _mul_nbapi.of_mact_mdata_reset_act_wr_inst(mdata)
of_mact_mdata_reset_act_wr_inst = _mul_nbapi.of_mact_mdata_reset_act_wr_inst

def of_mact_buf_room(mdata):
    return _mul_nbapi.of_mact_buf_room(mdata)
of_mact_buf_room = _mul_nbapi.of_mact_buf_room

def of_mact_len(mdata):
    return _mul_nbapi.of_mact_len(mdata)
of_mact_len = _mul_nbapi.of_mact_len

def of_mact_inst_act_len(mdata):
    return _mul_nbapi.of_mact_inst_act_len(mdata)
of_mact_inst_act_len = _mul_nbapi.of_mact_inst_act_len

def of_mask_is_dc_all(mask):
    return _mul_nbapi.of_mask_is_dc_all(mask)
of_mask_is_dc_all = _mul_nbapi.of_mask_is_dc_all

def of_mask_set_dc_all(mask):
    return _mul_nbapi.of_mask_set_dc_all(mask)
of_mask_set_dc_all = _mul_nbapi.of_mask_set_dc_all

def of_mask_set_no_dc(mask):
    return _mul_nbapi.of_mask_set_no_dc(mask)
of_mask_set_no_dc = _mul_nbapi.of_mask_set_no_dc

def of_mask_set_dl_dst(mask):
    return _mul_nbapi.of_mask_set_dl_dst(mask)
of_mask_set_dl_dst = _mul_nbapi.of_mask_set_dl_dst

def of_mask_clr_dl_dst(mask):
    return _mul_nbapi.of_mask_clr_dl_dst(mask)
of_mask_clr_dl_dst = _mul_nbapi.of_mask_clr_dl_dst

def of_mask_set_dl_src(mask):
    return _mul_nbapi.of_mask_set_dl_src(mask)
of_mask_set_dl_src = _mul_nbapi.of_mask_set_dl_src

def of_mask_set_dl_vlan_pcp(mask):
    return _mul_nbapi.of_mask_set_dl_vlan_pcp(mask)
of_mask_set_dl_vlan_pcp = _mul_nbapi.of_mask_set_dl_vlan_pcp

def of_mask_set_nw_tos(mask):
    return _mul_nbapi.of_mask_set_nw_tos(mask)
of_mask_set_nw_tos = _mul_nbapi.of_mask_set_nw_tos

def of_mask_clr_dl_src(mask):
    return _mul_nbapi.of_mask_clr_dl_src(mask)
of_mask_clr_dl_src = _mul_nbapi.of_mask_clr_dl_src

def of_mask_set_nw_src(mask, prefixlen):
    return _mul_nbapi.of_mask_set_nw_src(mask, prefixlen)
of_mask_set_nw_src = _mul_nbapi.of_mask_set_nw_src

def of_mask_clr_nw_src(mask):
    return _mul_nbapi.of_mask_clr_nw_src(mask)
of_mask_clr_nw_src = _mul_nbapi.of_mask_clr_nw_src

def of_mask_set_nw_dst(mask, prefixlen):
    return _mul_nbapi.of_mask_set_nw_dst(mask, prefixlen)
of_mask_set_nw_dst = _mul_nbapi.of_mask_set_nw_dst

def of_mask_set_tp_src(mask):
    return _mul_nbapi.of_mask_set_tp_src(mask)
of_mask_set_tp_src = _mul_nbapi.of_mask_set_tp_src

def of_mask_set_tp_dst(mask):
    return _mul_nbapi.of_mask_set_tp_dst(mask)
of_mask_set_tp_dst = _mul_nbapi.of_mask_set_tp_dst

def of_mask_clr_nw_dst(mask):
    return _mul_nbapi.of_mask_clr_nw_dst(mask)
of_mask_clr_nw_dst = _mul_nbapi.of_mask_clr_nw_dst

def of_mask_set_dl_type(mask):
    return _mul_nbapi.of_mask_set_dl_type(mask)
of_mask_set_dl_type = _mul_nbapi.of_mask_set_dl_type

def of_mask_clr_dl_type(mask):
    return _mul_nbapi.of_mask_clr_dl_type(mask)
of_mask_clr_dl_type = _mul_nbapi.of_mask_clr_dl_type

def of_mask_set_dl_vlan(mask):
    return _mul_nbapi.of_mask_set_dl_vlan(mask)
of_mask_set_dl_vlan = _mul_nbapi.of_mask_set_dl_vlan

def of_mask_set_dl_vlan_present(mask):
    return _mul_nbapi.of_mask_set_dl_vlan_present(mask)
of_mask_set_dl_vlan_present = _mul_nbapi.of_mask_set_dl_vlan_present

def of_mask_clr_dl_vlan(mask):
    return _mul_nbapi.of_mask_clr_dl_vlan(mask)
of_mask_clr_dl_vlan = _mul_nbapi.of_mask_clr_dl_vlan

def of_mask_has_in_port(mask):
    return _mul_nbapi.of_mask_has_in_port(mask)
of_mask_has_in_port = _mul_nbapi.of_mask_has_in_port

def of_mask_set_in_port(mask):
    return _mul_nbapi.of_mask_set_in_port(mask)
of_mask_set_in_port = _mul_nbapi.of_mask_set_in_port

def of_mask_clr_in_port(mask):
    return _mul_nbapi.of_mask_clr_in_port(mask)
of_mask_clr_in_port = _mul_nbapi.of_mask_clr_in_port

def of_mask_set_nw_proto(mask):
    return _mul_nbapi.of_mask_set_nw_proto(mask)
of_mask_set_nw_proto = _mul_nbapi.of_mask_set_nw_proto

def of_mask_clr_nw_proto(mask):
    return _mul_nbapi.of_mask_clr_nw_proto(mask)
of_mask_clr_nw_proto = _mul_nbapi.of_mask_clr_nw_proto

def of_mask_set_metadata(mask):
    return _mul_nbapi.of_mask_set_metadata(mask)
of_mask_set_metadata = _mul_nbapi.of_mask_set_metadata

def of_mask_clr_metadata(mask):
    return _mul_nbapi.of_mask_clr_metadata(mask)
of_mask_clr_metadata = _mul_nbapi.of_mask_clr_metadata

def of_mask_set_tunnel_id(mask):
    return _mul_nbapi.of_mask_set_tunnel_id(mask)
of_mask_set_tunnel_id = _mul_nbapi.of_mask_set_tunnel_id

def of_mask_clr_tunnel_id(mask):
    return _mul_nbapi.of_mask_clr_tunnel_id(mask)
of_mask_clr_tunnel_id = _mul_nbapi.of_mask_clr_tunnel_id

def of_mask_set_table_id(mask):
    return _mul_nbapi.of_mask_set_table_id(mask)
of_mask_set_table_id = _mul_nbapi.of_mask_set_table_id

def of_get_data_len(h):
    return _mul_nbapi.of_get_data_len(h)
of_get_data_len = _mul_nbapi.of_get_data_len

def __of_hdr_valid(h_arg, len):
    return _mul_nbapi.__of_hdr_valid(h_arg, len)
__of_hdr_valid = _mul_nbapi.__of_hdr_valid

def of_put_mpls_label_oxm(dat, label, sz):
    return _mul_nbapi.of_put_mpls_label_oxm(dat, label, sz)
of_put_mpls_label_oxm = _mul_nbapi.of_put_mpls_label_oxm

def of_get_mpls_label_oxm(dat, label, sz):
    return _mul_nbapi.of_get_mpls_label_oxm(dat, label, sz)
of_get_mpls_label_oxm = _mul_nbapi.of_get_mpls_label_oxm

def of_hdr_valid(h_arg):
    return _mul_nbapi.of_hdr_valid(h_arg)
...
class of_flow_mod_params(_object):
    ...
    if _newclass:
        app_owner = _swig_property(_mul_nbapi.of_flow_mod_params_app_owner_get, _mul_nbapi.of_flow_mod_params_app_owner_set)
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.of_flow_mod_params_flow_get, _mul_nbapi.of_flow_mod_params_flow_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.of_flow_mod_params_mask_get, _mul_nbapi.of_flow_mod_params_mask_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.of_flow_mod_params_actions_get, _mul_nbapi.of_flow_mod_params_actions_set)
    ...
    if _newclass:
        action_len = _swig_property(_mul_nbapi.of_flow_mod_params_action_len_get, _mul_nbapi.of_flow_mod_params_action_len_set)
    ...
    if _newclass:
        wildcards = _swig_property(_mul_nbapi.of_flow_mod_params_wildcards_get, _mul_nbapi.of_flow_mod_params_wildcards_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.of_flow_mod_params_buffer_id_get, _mul_nbapi.of_flow_mod_params_buffer_id_set)
    ...
    if _newclass:
        prio = _swig_property(_mul_nbapi.of_flow_mod_params_prio_get, _mul_nbapi.of_flow_mod_params_prio_set)
    ...
    if _newclass:
        itimeo = _swig_property(_mul_nbapi.of_flow_mod_params_itimeo_get, _mul_nbapi.of_flow_mod_params_itimeo_set)
    ...
    if _newclass:
        htimeo = _swig_property(_mul_nbapi.of_flow_mod_params_htimeo_get, _mul_nbapi.of_flow_mod_params_htimeo_set)
    ...
    if _newclass:
        oport = _swig_property(_mul_nbapi.of_flow_mod_params_oport_get, _mul_nbapi.of_flow_mod_params_oport_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.of_flow_mod_params_flags_get, _mul_nbapi.of_flow_mod_params_flags_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.of_flow_mod_params_reason_get, _mul_nbapi.of_flow_mod_params_reason_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.of_flow_mod_params_command_get, _mul_nbapi.of_flow_mod_params_command_set)
    ...
    if _newclass:
        ogroup = _swig_property(_mul_nbapi.of_flow_mod_params_ogroup_get, _mul_nbapi.of_flow_mod_params_ogroup_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.of_flow_mod_params_cookie_get, _mul_nbapi.of_flow_mod_params_cookie_set)
    ...
    if _newclass:
        seq_cookie = _swig_property(_mul_nbapi.of_flow_mod_params_seq_cookie_get, _mul_nbapi.of_flow_mod_params_seq_cookie_set)
    ...
    if _newclass:
        meter_dep = _swig_property(_mul_nbapi.of_flow_mod_params_meter_dep_get, _mul_nbapi.of_flow_mod_params_meter_dep_set)
    ...
    if _newclass:
        grp_dep = _swig_property(_mul_nbapi.of_flow_mod_params_grp_dep_get, _mul_nbapi.of_flow_mod_params_grp_dep_set)
...
class of_group_mod_params(_object):
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.of_group_mod_params_command_get, _mul_nbapi.of_group_mod_params_command_set)
    ...
    if _newclass:
        app_owner = _swig_property(_mul_nbapi.of_group_mod_params_app_owner_get, _mul_nbapi.of_group_mod_params_app_owner_set)
    ...
    if _newclass:
        group = _swig_property(_mul_nbapi.of_group_mod_params_group_get, _mul_nbapi.of_group_mod_params_group_set)
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.of_group_mod_params_type_get, _mul_nbapi.of_group_mod_params_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.of_group_mod_params_flags_get, _mul_nbapi.of_group_mod_params_flags_set)
    ...
    if _newclass:
        act_vectors = _swig_property(_mul_nbapi.of_group_mod_params_act_vectors_get, _mul_nbapi.of_group_mod_params_act_vectors_set)
    ...
    if _newclass:
        act_vec_len = _swig_property(_mul_nbapi.of_group_mod_params_act_vec_len_get, _mul_nbapi.of_group_mod_params_act_vec_len_set)
...
class of_meter_mod_params(_object):
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.of_meter_mod_params_command_get, _mul_nbapi.of_meter_mod_params_command_set)
    ...
    if _newclass:
        app_owner = _swig_property(_mul_nbapi.of_meter_mod_params_app_owner_get, _mul_nbapi.of_meter_mod_params_app_owner_set)
    ...
    if _newclass:
        meter = _swig_property(_mul_nbapi.of_meter_mod_params_meter_get, _mul_nbapi.of_meter_mod_params_meter_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.of_meter_mod_params_flags_get, _mul_nbapi.of_meter_mod_params_flags_set)
    ...
    if _newclass:
        cflags = _swig_property(_mul_nbapi.of_meter_mod_params_cflags_get, _mul_nbapi.of_meter_mod_params_cflags_set)
    ...
    if _newclass:
        meter_bands = _swig_property(_mul_nbapi.of_meter_mod_params_meter_bands_get, _mul_nbapi.of_meter_mod_params_meter_bands_set)
    ...
    if _newclass:
        meter_nbands = _swig_property(_mul_nbapi.of_meter_mod_params_meter_nbands_get, _mul_nbapi.of_meter_mod_params_meter_nbands_set)
...
class ofp_port_mod_properties(_object):
    ...
    if _newclass:
        advertise = _swig_property(_mul_nbapi.ofp_port_mod_properties_advertise_get, _mul_nbapi.ofp_port_mod_properties_advertise_set)
    ...
    if _newclass:
        configure = _swig_property(_mul_nbapi.ofp_port_mod_properties_configure_get, _mul_nbapi.ofp_port_mod_properties_configure_set)
    ...
    if _newclass:
        freq_lmda = _swig_property(_mul_nbapi.ofp_port_mod_properties_freq_lmda_get, _mul_nbapi.ofp_port_mod_properties_freq_lmda_set)
    ...
    if _newclass:
        fl_offset = _swig_property(_mul_nbapi.ofp_port_mod_properties_fl_offset_get, _mul_nbapi.ofp_port_mod_properties_fl_offset_set)
    ...
    if _newclass:
        grid_span = _swig_property(_mul_nbapi.ofp_port_mod_properties_grid_span_get, _mul_nbapi.ofp_port_mod_properties_grid_span_set)
    ...
    if _newclass:
        tx_pwr = _swig_property(_mul_nbapi.ofp_port_mod_properties_tx_pwr_get, _mul_nbapi.ofp_port_mod_properties_tx_pwr_set)
...
class of_port_mod_params(_object):
    ...
    if _newclass:
        type = _swig_property(_mul_nbapi.of_port_mod_params_type_get, _mul_nbapi.of_port_mod_params_type_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.of_port_mod_params_port_no_get, _mul_nbapi.of_port_mod_params_port_no_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.of_port_mod_params_config_get, _mul_nbapi.of_port_mod_params_config_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.of_port_mod_params_mask_get, _mul_nbapi.of_port_mod_params_mask_set)
    ...
    if _newclass:
        properties = _swig_property(_mul_nbapi.of_port_mod_params_properties_get, _mul_nbapi.of_port_mod_params_properties_set)
...
class of_vendor_params(_object):
    ...
    if _newclass:
        vendor = _swig_property(_mul_nbapi.of_vendor_params_vendor_get, _mul_nbapi.of_vendor_params_vendor_set)
    ...
    if _newclass:
        data_len = _swig_property(_mul_nbapi.of_vendor_params_data_len_get, _mul_nbapi.of_vendor_params_data_len_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.of_vendor_params_data_get, _mul_nbapi.of_vendor_params_data_set)
...
class of_async_config_params(_object):
    ...
    if _newclass:
        packet_in_mask = _swig_property(_mul_nbapi.of_async_config_params_packet_in_mask_get, _mul_nbapi.of_async_config_params_packet_in_mask_set)
    ...
    if _newclass:
        port_status_mask = _swig_property(_mul_nbapi.of_async_config_params_port_status_mask_get, _mul_nbapi.of_async_config_params_port_status_mask_set)
    ...
    if _newclass:
        flow_removed_mask = _swig_property(_mul_nbapi.of_async_config_params_flow_removed_mask_get, _mul_nbapi.of_async_config_params_flow_removed_mask_set)
...
class of_pkt_out_params(_object):
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.of_pkt_out_params_buffer_id_get, _mul_nbapi.of_pkt_out_params_buffer_id_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.of_pkt_out_params_in_port_get, _mul_nbapi.of_pkt_out_params_in_port_set)
    ...
    if _newclass:
        action_len = _swig_property(_mul_nbapi.of_pkt_out_params_action_len_get, _mul_nbapi.of_pkt_out_params_action_len_set)
    ...
    if _newclass:
        action_list = _swig_property(_mul_nbapi.of_pkt_out_params_action_list_get, _mul_nbapi.of_pkt_out_params_action_list_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.of_pkt_out_params_data_get, _mul_nbapi.of_pkt_out_params_data_set)
    ...
    if _newclass:
        data_len = _swig_property(_mul_nbapi.of_pkt_out_params_data_len_get, _mul_nbapi.of_pkt_out_params_data_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.of_pkt_out_params_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.of_pkt_out_params_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.of_pkt_out_params_pad_get, _mul_nbapi.of_pkt_out_params_pad_set)
...
class c_ofp_ctors(_object):
    ...
    if _newclass:
        hello = _swig_property(_mul_nbapi.c_ofp_ctors_hello_get, _mul_nbapi.c_ofp_ctors_hello_set)
    ...
    if _newclass:
        echo_req = _swig_property(_mul_nbapi.c_ofp_ctors_echo_req_get, _mul_nbapi.c_ofp_ctors_echo_req_set)
    ...
    if _newclass:
        echo_rsp = _swig_property(_mul_nbapi.c_ofp_ctors_echo_rsp_get, _mul_nbapi.c_ofp_ctors_echo_rsp_set)
    ...
    if _newclass:
        set_config = _swig_property(_mul_nbapi.c_ofp_ctors_set_config_get, _mul_nbapi.c_ofp_ctors_set_config_set)
    ...
    if _newclass:
        role_request = _swig_property(_mul_nbapi.c_ofp_ctors_role_request_get, _mul_nbapi.c_ofp_ctors_role_request_set)
    ...
    if _newclass:
        features = _swig_property(_mul_nbapi.c_ofp_ctors_features_get, _mul_nbapi.c_ofp_ctors_features_set)
    ...
    if _newclass:
        pkt_out = _swig_property(_mul_nbapi.c_ofp_ctors_pkt_out_get, _mul_nbapi.c_ofp_ctors_pkt_out_set)
    ...
    if _newclass:
        pkt_out_fast = _swig_property(_mul_nbapi.c_ofp_ctors_pkt_out_fast_get, _mul_nbapi.c_ofp_ctors_pkt_out_fast_set)
    ...
    if _newclass:
        flow_add = _swig_property(_mul_nbapi.c_ofp_ctors_flow_add_get, _mul_nbapi.c_ofp_ctors_flow_add_set)
    ...
    if _newclass:
        flow_del = _swig_property(_mul_nbapi.c_ofp_ctors_flow_del_get, _mul_nbapi.c_ofp_ctors_flow_del_set)
    ...
    if _newclass:
        flow_stat_req = _swig_property(_mul_nbapi.c_ofp_ctors_flow_stat_req_get, _mul_nbapi.c_ofp_ctors_flow_stat_req_set)
    ...
    if _newclass:
        group_stat_req = _swig_property(_mul_nbapi.c_ofp_ctors_group_stat_req_get, _mul_nbapi.c_ofp_ctors_group_stat_req_set)
    ...
    if _newclass:
        meter_stat_req = _swig_property(_mul_nbapi.c_ofp_ctors_meter_stat_req_get, _mul_nbapi.c_ofp_ctors_meter_stat_req_set)
    ...
    if _newclass:
        meter_stat_cfg_req = _swig_property(_mul_nbapi.c_ofp_ctors_meter_stat_cfg_req_get, _mul_nbapi.c_ofp_ctors_meter_stat_cfg_req_set)
    ...
    if _newclass:
        port_stat_req = _swig_property(_mul_nbapi.c_ofp_ctors_port_stat_req_get, _mul_nbapi.c_ofp_ctors_port_stat_req_set)
    ...
    if _newclass:
        port_q_get_conf = _swig_property(_mul_nbapi.c_ofp_ctors_port_q_get_conf_get, _mul_nbapi.c_ofp_ctors_port_q_get_conf_set)
    ...
    if _newclass:
        port_q_stat_req = _swig_property(_mul_nbapi.c_ofp_ctors_port_q_stat_req_get, _mul_nbapi.c_ofp_ctors_port_q_stat_req_set)
    ...
    if _newclass:
        group_validate = _swig_property(_mul_nbapi.c_ofp_ctors_group_validate_get, _mul_nbapi.c_ofp_ctors_group_validate_set)
    ...
    if _newclass:
        group_add = _swig_property(_mul_nbapi.c_ofp_ctors_group_add_get, _mul_nbapi.c_ofp_ctors_group_add_set)
    ...
    if _newclass:
        group_del = _swig_property(_mul_nbapi.c_ofp_ctors_group_del_get, _mul_nbapi.c_ofp_ctors_group_del_set)
    ...
    if _newclass:
        tbl_mod = _swig_property(_mul_nbapi.c_ofp_ctors_tbl_mod_get, _mul_nbapi.c_ofp_ctors_tbl_mod_set)
    ...
    if _newclass:
        meter_add = _swig_property(_mul_nbapi.c_ofp_ctors_meter_add_get, _mul_nbapi.c_ofp_ctors_meter_add_set)
    ...
    if _newclass:
        meter_del = _swig_property(_mul_nbapi.c_ofp_ctors_meter_del_get, _mul_nbapi.c_ofp_ctors_meter_del_set)
    ...
    if _newclass:
        port_mod = _swig_property(_mul_nbapi.c_ofp_ctors_port_mod_get, _mul_nbapi.c_ofp_ctors_port_mod_set)
    ...
    if _newclass:
        async_config = _swig_property(_mul_nbapi.c_ofp_ctors_async_config_get, _mul_nbapi.c_ofp_ctors_async_config_set)
    ...
    if _newclass:
        prep_mpart_msg = _swig_property(_mul_nbapi.c_ofp_ctors_prep_mpart_msg_get, _mul_nbapi.c_ofp_ctors_prep_mpart_msg_set)
    ...
    if _newclass:
        prep_barrier_req = _swig_property(_mul_nbapi.c_ofp_ctors_prep_barrier_req_get, _mul_nbapi.c_ofp_ctors_prep_barrier_req_set)
    ...
    if _newclass:
        prep_vendor_msg = _swig_property(_mul_nbapi.c_ofp_ctors_prep_vendor_msg_get, _mul_nbapi.c_ofp_ctors_prep_vendor_msg_set)
    ...
    if _newclass:
        set_act_inst = _swig_property(_mul_nbapi.c_ofp_ctors_set_act_inst_get, _mul_nbapi.c_ofp_ctors_set_act_inst_set)
    ...
    if _newclass:
        inst_goto = _swig_property(_mul_nbapi.c_ofp_ctors_inst_goto_get, _mul_nbapi.c_ofp_ctors_inst_goto_set)
    ...
    if _newclass:
        inst_meter = _swig_property(_mul_nbapi.c_ofp_ctors_inst_meter_get, _mul_nbapi.c_ofp_ctors_inst_meter_set)
    ...
    if _newclass:
        inst_wr_meta = _swig_property(_mul_nbapi.c_ofp_ctors_inst_wr_meta_get, _mul_nbapi.c_ofp_ctors_inst_wr_meta_set)
    ...
    if _newclass:
        act_output = _swig_property(_mul_nbapi.c_ofp_ctors_act_output_get, _mul_nbapi.c_ofp_ctors_act_output_set)
    ...
    if _newclass:
        act_set_vid = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_vid_get, _mul_nbapi.c_ofp_ctors_act_set_vid_set)
    ...
    if _newclass:
        act_strip_vid = _swig_property(_mul_nbapi.c_ofp_ctors_act_strip_vid_get, _mul_nbapi.c_ofp_ctors_act_strip_vid_set)
    ...
    if _newclass:
        act_push = _swig_property(_mul_nbapi.c_ofp_ctors_act_push_get, _mul_nbapi.c_ofp_ctors_act_push_set)
    ...
    if _newclass:
        act_strip_mpls = _swig_property(_mul_nbapi.c_ofp_ctors_act_strip_mpls_get, _mul_nbapi.c_ofp_ctors_act_strip_mpls_set)
    ...
    if _newclass:
        act_strip_pbb = _swig_property(_mul_nbapi.c_ofp_ctors_act_strip_pbb_get, _mul_nbapi.c_ofp_ctors_act_strip_pbb_set)
    ...
    if _newclass:
        act_set_mpls_ttl = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_mpls_ttl_get, _mul_nbapi.c_ofp_ctors_act_set_mpls_ttl_set)
    ...
    if _newclass:
        act_dec_mpls_ttl = _swig_property(_mul_nbapi.c_ofp_ctors_act_dec_mpls_ttl_get, _mul_nbapi.c_ofp_ctors_act_dec_mpls_ttl_set)
    ...
    if _newclass:
        act_set_ip_ttl = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_ip_ttl_get, _mul_nbapi.c_ofp_ctors_act_set_ip_ttl_set)
    ...
    if _newclass:
        act_dec_ip_ttl = _swig_property(_mul_nbapi.c_ofp_ctors_act_dec_ip_ttl_get, _mul_nbapi.c_ofp_ctors_act_dec_ip_ttl_set)
    ...
    if _newclass:
        act_cp_ttl = _swig_property(_mul_nbapi.c_ofp_ctors_act_cp_ttl_get, _mul_nbapi.c_ofp_ctors_act_cp_ttl_set)
    ...
    if _newclass:
        act_set_dmac = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_dmac_get, _mul_nbapi.c_ofp_ctors_act_set_dmac_set)
    ...
    if _newclass:
        act_set_smac = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_smac_get, _mul_nbapi.c_ofp_ctors_act_set_smac_set)
    ...
    if _newclass:
        act_set_eth_type = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_eth_type_get, _mul_nbapi.c_ofp_ctors_act_set_eth_type_set)
    ...
    if _newclass:
        act_set_mpls_label = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_mpls_label_get, _mul_nbapi.c_ofp_ctors_act_set_mpls_label_set)
    ...
    if _newclass:
        act_set_mpls_tc = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_mpls_tc_get, _mul_nbapi.c_ofp_ctors_act_set_mpls_tc_set)
    ...
    if _newclass:
        act_set_mpls_bos = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_mpls_bos_get, _mul_nbapi.c_ofp_ctors_act_set_mpls_bos_set)
    ...
    if _newclass:
        act_set_nw_saddr = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_nw_saddr_get, _mul_nbapi.c_ofp_ctors_act_set_nw_saddr_set)
    ...
    if _newclass:
        act_set_nw_daddr = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_nw_daddr_get, _mul_nbapi.c_ofp_ctors_act_set_nw_daddr_set)
    ...
    if _newclass:
        act_set_nw_saddr6 = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_nw_saddr6_get, _mul_nbapi.c_ofp_ctors_act_set_nw_saddr6_set)
    ...
    if _newclass:
        act_set_nw_daddr6 = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_nw_daddr6_get, _mul_nbapi.c_ofp_ctors_act_set_nw_daddr6_set)
    ...
    if _newclass:
        act_set_vlan_pcp = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_vlan_pcp_get, _mul_nbapi.c_ofp_ctors_act_set_vlan_pcp_set)
    ...
    if _newclass:
        act_set_nw_tos = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_nw_tos_get, _mul_nbapi.c_ofp_ctors_act_set_nw_tos_set)
    ...
    if _newclass:
        act_set_tp_udp_dport = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_tp_udp_dport_get, _mul_nbapi.c_ofp_ctors_act_set_tp_udp_dport_set)
    ...
    if _newclass:
        act_set_tp_udp_sport = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_tp_udp_sport_get, _mul_nbapi.c_ofp_ctors_act_set_tp_udp_sport_set)
    ...
    if _newclass:
        act_set_tp_tcp_dport = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_tp_tcp_dport_get, _mul_nbapi.c_ofp_ctors_act_set_tp_tcp_dport_set)
    ...
    if _newclass:
        act_set_tp_tcp_sport = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_tp_tcp_sport_get, _mul_nbapi.c_ofp_ctors_act_set_tp_tcp_sport_set)
    ...
    if _newclass:
        act_set_group = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_group_get, _mul_nbapi.c_ofp_ctors_act_set_group_set)
    ...
    if _newclass:
        act_set_queue = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_queue_get, _mul_nbapi.c_ofp_ctors_act_set_queue_set)
    ...
    if _newclass:
        act_set_tunnel = _swig_property(_mul_nbapi.c_ofp_ctors_act_set_tunnel_get, _mul_nbapi.c_ofp_ctors_act_set_tunnel_set)
    ...
    if _newclass:
        meter_drop = _swig_property(_mul_nbapi.c_ofp_ctors_meter_drop_get, _mul_nbapi.c_ofp_ctors_meter_drop_set)
    ...
    if _newclass:
        meter_mark_dscp = _swig_property(_mul_nbapi.c_ofp_ctors_meter_mark_dscp_get, _mul_nbapi.c_ofp_ctors_meter_mark_dscp_set)
    ...
    if _newclass:
        validate_acts = _swig_property(_mul_nbapi.c_ofp_ctors_validate_acts_get, _mul_nbapi.c_ofp_ctors_validate_acts_set)
    ...
    if _newclass:
        normalize_flow = _swig_property(_mul_nbapi.c_ofp_ctors_normalize_flow_get, _mul_nbapi.c_ofp_ctors_normalize_flow_set)
    ...
    if _newclass:
        group_validate_feat = _swig_property(_mul_nbapi.c_ofp_ctors_group_validate_feat_get, _mul_nbapi.c_ofp_ctors_group_validate_feat_set)
    ...
    if _newclass:
        meter_validate_feat = _swig_property(_mul_nbapi.c_ofp_ctors_meter_validate_feat_get, _mul_nbapi.c_ofp_ctors_meter_validate_feat_set)
    ...
    if _newclass:
        dump_flow = _swig_property(_mul_nbapi.c_ofp_ctors_dump_flow_get, _mul_nbapi.c_ofp_ctors_dump_flow_set)
    ...
    if _newclass:
        dump_acts = _swig_property(_mul_nbapi.c_ofp_ctors_dump_acts_get, _mul_nbapi.c_ofp_ctors_dump_acts_set)
    ...
    if _newclass:
        dump_of_msg = _swig_property(_mul_nbapi.c_ofp_ctors_dump_of_msg_get, _mul_nbapi.c_ofp_ctors_dump_of_msg_set)
    ...
    if _newclass:
        multi_table_support = _swig_property(_mul_nbapi.c_ofp_ctors_multi_table_support_get, _mul_nbapi.c_ofp_ctors_multi_table_support_set)
    ...
    if _newclass:
        flow_stats_support = _swig_property(_mul_nbapi.c_ofp_ctors_flow_stats_support_get, _mul_nbapi.c_ofp_ctors_flow_stats_support_set)
    ...
    if _newclass:
        group_stats_support = _swig_property(_mul_nbapi.c_ofp_ctors_group_stats_support_get, _mul_nbapi.c_ofp_ctors_group_stats_support_set)
    ...
    if _newclass:
        table_stats_support = _swig_property(_mul_nbapi.c_ofp_ctors_table_stats_support_get, _mul_nbapi.c_ofp_ctors_table_stats_support_set)
    ...
    if _newclass:
        act_modify_uflow = _swig_property(_mul_nbapi.c_ofp_ctors_act_modify_uflow_get, _mul_nbapi.c_ofp_ctors_act_modify_uflow_set)
...
def of_switch_desc_dump(desc, desc_len):
    return _mul_nbapi.of_switch_desc_dump(desc, desc_len)
of_switch_desc_dump = _mul_nbapi.of_switch_desc_dump

def of_mact_alloc(mdata):
    return _mul_nbapi.of_mact_alloc(mdata)
of_mact_alloc = _mul_nbapi.of_mact_alloc

def of_mact_free(mdata):
    return _mul_nbapi.of_mact_free(mdata)
of_mact_free = _mul_nbapi.of_mact_free

def of_capabilities_tostr(string, capabilities):
    return _mul_nbapi.of_capabilities_tostr(string, capabilities)
of_capabilities_tostr = _mul_nbapi.of_capabilities_tostr

def of_switch_supports_flow_stats(cap):
    return _mul_nbapi.of_switch_supports_flow_stats(cap)
of_switch_supports_flow_stats = _mul_nbapi.of_switch_supports_flow_stats

def __of_match_flows(f1, m1, f2):
    return _mul_nbapi.__of_match_flows(f1, m1, f2)
__of_match_flows = _mul_nbapi.__of_match_flows

def of_match_flows_prio(f1, m1, f2, m2, p1, p2):
    return _mul_nbapi.of_match_flows_prio(f1, m1, f2, m2, p1, p2)
of_match_flows_prio = _mul_nbapi.of_match_flows_prio

def of_check_flow_wildcard_generic(fl, mask):
    return _mul_nbapi.of_check_flow_wildcard_generic(fl, mask)
of_check_flow_wildcard_generic = _mul_nbapi.of_check_flow_wildcard_generic

def of_dump_flow_generic_cmd(fl, mask):
    return _mul_nbapi.of_dump_flow_generic_cmd(fl, mask)
of_dump_flow_generic_cmd = _mul_nbapi.of_dump_flow_generic_cmd

def of_dump_flow_generic(fl, mask):
    return _mul_nbapi.of_dump_flow_generic(fl, mask)
of_dump_flow_generic = _mul_nbapi.of_dump_flow_generic

def of_dump_flow_all(fl):
    return _mul_nbapi.of_dump_flow_all(fl)
of_dump_flow_all = _mul_nbapi.of_dump_flow_all

def of_prep_msg_common(ver, len, type, xid):
    return _mul_nbapi.of_prep_msg_common(ver, len, type, xid)
of_prep_msg_common = _mul_nbapi.of_prep_msg_common

def of_role_to_str(role):
    return _mul_nbapi.of_role_to_str(role)
of_role_to_str = _mul_nbapi.of_role_to_str

def of_make_action_output(mdata, oport):
    return _mul_nbapi.of_make_action_output(mdata, oport)
of_make_action_output = _mul_nbapi.of_make_action_output

def of_make_action_set_vid(mdata, vid):
    return _mul_nbapi.of_make_action_set_vid(mdata, vid)
of_make_action_set_vid = _mul_nbapi.of_make_action_set_vid

def of_make_action_strip_vlan(mdata):
    return _mul_nbapi.of_make_action_strip_vlan(mdata)
of_make_action_strip_vlan = _mul_nbapi.of_make_action_strip_vlan

def of_make_action_set_dmac(mdata, dmac):
    return _mul_nbapi.of_make_action_set_dmac(mdata, dmac)
of_make_action_set_dmac = _mul_nbapi.of_make_action_set_dmac

def of_make_action_set_nw_saddr(mdata, nw_saddr):
    return _mul_nbapi.of_make_action_set_nw_saddr(mdata, nw_saddr)
of_make_action_set_nw_saddr = _mul_nbapi.of_make_action_set_nw_saddr

def of_make_action_set_nw_daddr(mdata, nw_saddr):
    return _mul_nbapi.of_make_action_set_nw_daddr(mdata, nw_saddr)
of_make_action_set_nw_daddr = _mul_nbapi.of_make_action_set_nw_daddr

def of_make_action_set_vlan_pcp(mdata, vlan_pcp):
    return _mul_nbapi.of_make_action_set_vlan_pcp(mdata, vlan_pcp)
of_make_action_set_vlan_pcp = _mul_nbapi.of_make_action_set_vlan_pcp

def of_make_action_set_smac(mdata, smac):
    return _mul_nbapi.of_make_action_set_smac(mdata, smac)
of_make_action_set_smac = _mul_nbapi.of_make_action_set_smac

def of_make_action_set_nw_tos(mdata, tos):
    return _mul_nbapi.of_make_action_set_nw_tos(mdata, tos)
of_make_action_set_nw_tos = _mul_nbapi.of_make_action_set_nw_tos

def of_make_action_set_tp_udp_sport(mdata, port):
    return _mul_nbapi.of_make_action_set_tp_udp_sport(mdata, port)
of_make_action_set_tp_udp_sport = _mul_nbapi.of_make_action_set_tp_udp_sport

def of_make_action_set_tp_udp_dport(mdata, port):
    return _mul_nbapi.of_make_action_set_tp_udp_dport(mdata, port)
of_make_action_set_tp_udp_dport = _mul_nbapi.of_make_action_set_tp_udp_dport

def of_make_action_set_tp_tcp_sport(mdata, port):
    return _mul_nbapi.of_make_action_set_tp_tcp_sport(mdata, port)
of_make_action_set_tp_tcp_sport = _mul_nbapi.of_make_action_set_tp_tcp_sport

def of_make_action_set_tp_tcp_dport(mdata, port):
    return _mul_nbapi.of_make_action_set_tp_tcp_dport(mdata, port)
of_make_action_set_tp_tcp_dport = _mul_nbapi.of_make_action_set_tp_tcp_dport

def of10_parse_actions(fl, mask, actions, action_len, inst_parsers, act_parsers, u_arg):
    return _mul_nbapi.of10_parse_actions(fl, mask, actions, action_len, inst_parsers, act_parsers, u_arg)
of10_parse_actions = _mul_nbapi.of10_parse_actions

def of10_dump_actions(actions, action_len, acts_only):
    return _mul_nbapi.of10_dump_actions(actions, action_len, acts_only)
of10_dump_actions = _mul_nbapi.of10_dump_actions

def of10_dump_actions_cmd(actions, action_len, acts_only):
    return _mul_nbapi.of10_dump_actions_cmd(actions, action_len, acts_only)
of10_dump_actions_cmd = _mul_nbapi.of10_dump_actions_cmd

def of_dump_flow(fl, wildcards):
    return _mul_nbapi.of_dump_flow(fl, wildcards)
of_dump_flow = _mul_nbapi.of_dump_flow

def of10_dump_flow(fl, mask):
    return _mul_nbapi.of10_dump_flow(fl, mask)
of10_dump_flow = _mul_nbapi.of10_dump_flow

def of10_flow_correction(fl, mask):
    return _mul_nbapi.of10_flow_correction(fl, mask)
of10_flow_correction = _mul_nbapi.of10_flow_correction

def of_validate_actions(fl, mask, actions, action_len, acts_only, u_arg):
    return _mul_nbapi.of_validate_actions(fl, mask, actions, action_len, acts_only, u_arg)
of_validate_actions = _mul_nbapi.of_validate_actions

def of_dump_wildcards(wildcards):
    return _mul_nbapi.of_dump_wildcards(wildcards)
of_dump_wildcards = _mul_nbapi.of_dump_wildcards

def of_prep_msg(len, type, xid):
    return _mul_nbapi.of_prep_msg(len, type, xid)
...
def of_prep_echo_reply(xid):
    return _mul_nbapi.of_prep_echo_reply(xid)
...
def of_prep_set_config(flags, miss_len):
    return _mul_nbapi.of_prep_set_config(flags, miss_len)
of_prep_set_config = _mul_nbapi.of_prep_set_config

def of_prep_flow_mod(command, flow, mask, actions_len):
    return _mul_nbapi.of_prep_flow_mod(command, flow, mask, actions_len)
of_prep_flow_mod = _mul_nbapi.of_prep_flow_mod

def of_prep_flow_add_msg(flow, mask, buffer_id, actions, actions_len, i_timeo, h_timeo, prio, cookie, mod):
    return _mul_nbapi.of_prep_flow_add_msg(flow, mask, buffer_id, actions, actions_len, i_timeo, h_timeo, prio, cookie, mod)
of_prep_flow_add_msg = _mul_nbapi.of_prep_flow_add_msg

def of_prep_flow_del_msg(flow, mask, oport, strict, prio, group):
    return _mul_nbapi.of_prep_flow_del_msg(flow, mask, oport, strict, prio, group)
of_prep_flow_del_msg = _mul_nbapi.of_prep_flow_del_msg

def of_prep_pkt_out_msg(parms):
    return _mul_nbapi.of_prep_pkt_out_msg(parms)
of_prep_pkt_out_msg = _mul_nbapi.of_prep_pkt_out_msg

def of_prep_flow_stat_msg(flow, mask, oport, group):
    return _mul_nbapi.of_prep_flow_stat_msg(flow, mask, oport, group)
of_prep_flow_stat_msg = _mul_nbapi.of_prep_flow_stat_msg

def of_prep_port_stat_msg(port_no):
    return _mul_nbapi.of_prep_port_stat_msg(port_no)
of_prep_port_stat_msg = _mul_nbapi.of_prep_port_stat_msg

def of_prep_q_get_config(port_no):
    return _mul_nbapi.of_prep_q_get_config(port_no)
of_prep_q_get_config = _mul_nbapi.of_prep_q_get_config

def of_prep_vendor_msg(vp):
    return _mul_nbapi.of_prep_vendor_msg(vp)
of_prep_vendor_msg = _mul_nbapi.of_prep_vendor_msg

def of10_mask_to_wc(mask):
    return _mul_nbapi.of10_mask_to_wc(mask)
of10_mask_to_wc = _mul_nbapi.of10_mask_to_wc

def of10_wc_to_mask(wildcards, mask):
    return _mul_nbapi.of10_wc_to_mask(wildcards, mask)
of10_wc_to_mask = _mul_nbapi.of10_wc_to_mask

def of131_capabilities_tostr(string, capabilities):
    return _mul_nbapi.of131_capabilities_tostr(string, capabilities)
...
def of131_prep_echo_reply_msg(xid):
    return _mul_nbapi.of131_prep_echo_reply_msg(xid)
...
def of131_prep_pkt_out_msg(parms):
    return _mul_nbapi.of131_prep_pkt_out_msg(parms)
of131_prep_pkt_out_msg = _mul_nbapi.of131_prep_pkt_out_msg

def of131_prep_flow_add_msg(flow, mask, buffer_id, ins_list, ins_len, i_timeo, h_timeo, prio, cookie, mod):
    return _mul_nbapi.of131_prep_flow_add_msg(flow, mask, buffer_id, ins_list, ins_len, i_timeo, h_timeo, prio, cookie, mod)
...
def of131_prep_flow_del_msg(flow, mask, oport, strict, prio, group):
    return _mul_nbapi.of131_prep_flow_del_msg(flow, mask, oport, strict, prio, group)
of131_prep_flow_del_msg = _mul_nbapi.of131_prep_flow_del_msg

def of131_prep_flow_stat_msg(flow, mask, eoport, group):
    return _mul_nbapi.of131_prep_flow_stat_msg(flow, mask, eoport, group)
of131_prep_flow_stat_msg = _mul_nbapi.of131_prep_flow_stat_msg

def of131_prep_queue_stat_msg(port, queue):
    return _mul_nbapi.of131_prep_queue_stat_msg(port, queue)
of131_prep_queue_stat_msg = _mul_nbapi.of131_prep_queue_stat_msg

def of131_prep_group_add_msg(group, type, act_vectors, act_vec_len, modify):
    return _mul_nbapi.of131_prep_group_add_msg(group, type, act_vectors, act_vec_len, modify)
of131_prep_group_add_msg = _mul_nbapi.of131_prep_group_add_msg

def of131_prep_group_del_msg(group):
    return _mul_nbapi.of131_prep_group_del_msg(group)
of131_prep_group_del_msg = _mul_nbapi.of131_prep_group_del_msg

def of131_prep_meter_add_msg(meter, flags, band_vectors, nbands, modify):
    return _mul_nbapi.of131_prep_meter_add_msg(meter, flags, band_vectors, nbands, modify)
of131_prep_meter_add_msg = _mul_nbapi.of131_prep_meter_add_msg

def of131_prep_meter_del_msg(meter):
    return _mul_nbapi.of131_prep_meter_del_msg(meter)
of131_prep_meter_del_msg = _mul_nbapi.of131_prep_meter_del_msg

def of131_prep_port_mod_msg(port_no, pm_params, hw_addr):
    return _mul_nbapi.of131_prep_port_mod_msg(port_no, pm_params, hw_addr)
of131_prep_port_mod_msg = _mul_nbapi.of131_prep_port_mod_msg

def of131_prep_async_config(ac_params):
    return _mul_nbapi.of131_prep_async_config(ac_params)
of131_prep_async_config = _mul_nbapi.of131_prep_async_config

def of131_prep_mpart_msg(type, flags, body_len):
    return _mul_nbapi.of131_prep_mpart_msg(type, flags, body_len)
of131_prep_mpart_msg = _mul_nbapi.of131_prep_mpart_msg

def of131_group_validate_parms(add, group, type, act_vectors, act_vec_len):
    return _mul_nbapi.of131_group_validate_parms(add, group, type, act_vectors, act_vec_len)
of131_group_validate_parms = _mul_nbapi.of131_group_validate_parms

def of131_ofpx_match_to_flow(ofx, flow, mask):
    return _mul_nbapi.of131_ofpx_match_to_flow(ofx, flow, mask)
of131_ofpx_match_to_flow = _mul_nbapi.of131_ofpx_match_to_flow

def of131_prep_set_config_msg(flags, miss_len):
    return _mul_nbapi.of131_prep_set_config_msg(flags, miss_len)
of131_prep_set_config_msg = _mul_nbapi.of131_prep_set_config_msg

def of131_prep_role_request_msg(role, gen_id):
    return _mul_nbapi.of131_prep_role_request_msg(role, gen_id)
of131_prep_role_request_msg = _mul_nbapi.of131_prep_role_request_msg

def of131_set_inst_action_type(mdata, type):
    return _mul_nbapi.of131_set_inst_action_type(mdata, type)
of131_set_inst_action_type = _mul_nbapi.of131_set_inst_action_type

def of131_make_inst_actions(mdata, type):
    return _mul_nbapi.of131_make_inst_actions(mdata, type)
of131_make_inst_actions = _mul_nbapi.of131_make_inst_actions

def of131_fini_inst_actions(mdata):
    return _mul_nbapi.of131_fini_inst_actions(mdata)
of131_fini_inst_actions = _mul_nbapi.of131_fini_inst_actions

def of131_make_inst_goto(mdata, tbl_id):
    return _mul_nbapi.of131_make_inst_goto(mdata, tbl_id)
of131_make_inst_goto = _mul_nbapi.of131_make_inst_goto

def of131_make_inst_meter(mdata, meter):
    return _mul_nbapi.of131_make_inst_meter(mdata, meter)
of131_make_inst_meter = _mul_nbapi.of131_make_inst_meter

def of131_make_inst_wr_meta(mdata, metadata, metadata_mask):
    return _mul_nbapi.of131_make_inst_wr_meta(mdata, metadata, metadata_mask)
of131_make_inst_wr_meta = _mul_nbapi.of131_make_inst_wr_meta

def of131_make_inst_clear_act(mdata):
    return _mul_nbapi.of131_make_inst_clear_act(mdata)
of131_make_inst_clear_act = _mul_nbapi.of131_make_inst_clear_act

def of131_make_action_output(mdata, oport):
    return _mul_nbapi.of131_make_action_output(mdata, oport)
of131_make_action_output = _mul_nbapi.of131_make_action_output

def of131_make_action_push(mdata, eth_type):
    return _mul_nbapi.of131_make_action_push(mdata, eth_type)
of131_make_action_push = _mul_nbapi.of131_make_action_push

def of131_make_action_strip_mpls(mdata, eth_type):
    return _mul_nbapi.of131_make_action_strip_mpls(mdata, eth_type)
of131_make_action_strip_mpls = _mul_nbapi.of131_make_action_strip_mpls

def of131_make_action_set_mpls_ttl(mdata, ttl):
    return _mul_nbapi.of131_make_action_set_mpls_ttl(mdata, ttl)
of131_make_action_set_mpls_ttl = _mul_nbapi.of131_make_action_set_mpls_ttl

def of131_make_action_dec_mpls_ttl(mdata):
    return _mul_nbapi.of131_make_action_dec_mpls_ttl(mdata)
of131_make_action_dec_mpls_ttl = _mul_nbapi.of131_make_action_dec_mpls_ttl

def of131_make_action_set_ip_ttl(mdata, ttl):
    return _mul_nbapi.of131_make_action_set_ip_ttl(mdata, ttl)
of131_make_action_set_ip_ttl = _mul_nbapi.of131_make_action_set_ip_ttl

def of131_make_action_dec_ip_ttl(mdata):
    return _mul_nbapi.of131_make_action_dec_ip_ttl(mdata)
of131_make_action_dec_ip_ttl = _mul_nbapi.of131_make_action_dec_ip_ttl

def of131_make_action_cp_ttl(mdata, arg2):
    return _mul_nbapi.of131_make_action_cp_ttl(mdata, arg2)
of131_make_action_cp_ttl = _mul_nbapi.of131_make_action_cp_ttl

def of131_make_action_strip_pbb(mdata):
    return _mul_nbapi.of131_make_action_strip_pbb(mdata)
of131_make_action_strip_pbb = _mul_nbapi.of131_make_action_strip_pbb

def of131_make_action_set_vid(mdata, vid):
    return _mul_nbapi.of131_make_action_set_vid(mdata, vid)
of131_make_action_set_vid = _mul_nbapi.of131_make_action_set_vid

def of131_make_action_strip_vlan(mdata):
    return _mul_nbapi.of131_make_action_strip_vlan(mdata)
of131_make_action_strip_vlan = _mul_nbapi.of131_make_action_strip_vlan

def of131_make_action_set_vlan_pcp(mdata, vlan_pcp):
    return _mul_nbapi.of131_make_action_set_vlan_pcp(mdata, vlan_pcp)
of131_make_action_set_vlan_pcp = _mul_nbapi.of131_make_action_set_vlan_pcp

def of131_make_action_set_mpls_label(mdata, label):
    return _mul_nbapi.of131_make_action_set_mpls_label(mdata, label)
of131_make_action_set_mpls_label = _mul_nbapi.of131_make_action_set_mpls_label

def of131_make_action_set_mpls_tc(mdata, tc):
    return _mul_nbapi.of131_make_action_set_mpls_tc(mdata, tc)
of131_make_action_set_mpls_tc = _mul_nbapi.of131_make_action_set_mpls_tc

def of131_make_action_set_mpls_bos(mdata, bos):
    return _mul_nbapi.of131_make_action_set_mpls_bos(mdata, bos)
of131_make_action_set_mpls_bos = _mul_nbapi.of131_make_action_set_mpls_bos

def of131_make_action_set_dmac(mdata, dmac):
    return _mul_nbapi.of131_make_action_set_dmac(mdata, dmac)
of131_make_action_set_dmac = _mul_nbapi.of131_make_action_set_dmac

def of131_make_action_set_smac(mdata, smac):
    return _mul_nbapi.of131_make_action_set_smac(mdata, smac)
of131_make_action_set_smac = _mul_nbapi.of131_make_action_set_smac

def of131_make_action_set_eth_type(mdata, eth_type):
    return _mul_nbapi.of131_make_action_set_eth_type(mdata, eth_type)
of131_make_action_set_eth_type = _mul_nbapi.of131_make_action_set_eth_type

def of131_make_action_set_ipv4_src(mdata, nw_saddr):
    return _mul_nbapi.of131_make_action_set_ipv4_src(mdata, nw_saddr)
of131_make_action_set_ipv4_src = _mul_nbapi.of131_make_action_set_ipv4_src

def of131_make_action_set_ipv4_dst(mdata, nw_daddr):
    return _mul_nbapi.of131_make_action_set_ipv4_dst(mdata, nw_daddr)
of131_make_action_set_ipv4_dst = _mul_nbapi.of131_make_action_set_ipv4_dst

def of131_make_action_set_ipv6_src(mdata, nw_saddr):
    return _mul_nbapi.of131_make_action_set_ipv6_src(mdata, nw_saddr)
of131_make_action_set_ipv6_src = _mul_nbapi.of131_make_action_set_ipv6_src

def of131_make_action_set_ipv6_dst(mdata, nw_daddr):
    return _mul_nbapi.of131_make_action_set_ipv6_dst(mdata, nw_daddr)
of131_make_action_set_ipv6_dst = _mul_nbapi.of131_make_action_set_ipv6_dst

def of131_make_action_set_nw_tos(mdata, tos):
    return _mul_nbapi.of131_make_action_set_nw_tos(mdata, tos)
of131_make_action_set_nw_tos = _mul_nbapi.of131_make_action_set_nw_tos

def of131_make_action_set_tp_udp_sport(mdata, port):
    return _mul_nbapi.of131_make_action_set_tp_udp_sport(mdata, port)
of131_make_action_set_tp_udp_sport = _mul_nbapi.of131_make_action_set_tp_udp_sport

def of131_make_action_set_tp_udp_dport(mdata, port):
    return _mul_nbapi.of131_make_action_set_tp_udp_dport(mdata, port)
of131_make_action_set_tp_udp_dport = _mul_nbapi.of131_make_action_set_tp_udp_dport

def of131_make_action_set_tp_tcp_sport(mdata, port):
    return _mul_nbapi.of131_make_action_set_tp_tcp_sport(mdata, port)
of131_make_action_set_tp_tcp_sport = _mul_nbapi.of131_make_action_set_tp_tcp_sport

def of131_make_action_set_tp_tcp_dport(mdata, port):
    return _mul_nbapi.of131_make_action_set_tp_tcp_dport(mdata, port)
of131_make_action_set_tp_tcp_dport = _mul_nbapi.of131_make_action_set_tp_tcp_dport

def of131_make_action_group(mdata, group):
    return _mul_nbapi.of131_make_action_group(mdata, group)
of131_make_action_group = _mul_nbapi.of131_make_action_group

def of131_make_action_set_queue(mdata, queue):
    return _mul_nbapi.of131_make_action_set_queue(mdata, queue)
of131_make_action_set_queue = _mul_nbapi.of131_make_action_set_queue

def of131_make_action_set_tunnel_id(mdata, tunnel_id):
    return _mul_nbapi.of131_make_action_set_tunnel_id(mdata, tunnel_id)
of131_make_action_set_tunnel_id = _mul_nbapi.of131_make_action_set_tunnel_id

def of131_make_meter_band_drop(mdata, bparms):
    return _mul_nbapi.of131_make_meter_band_drop(mdata, bparms)
of131_make_meter_band_drop = _mul_nbapi.of131_make_meter_band_drop

def of131_make_meter_band_mark_dscp(mdata, bparms):
    return _mul_nbapi.of131_make_meter_band_mark_dscp(mdata, bparms)
of131_make_meter_band_mark_dscp = _mul_nbapi.of131_make_meter_band_mark_dscp

def of131_parse_actions(actions, act_len, parse_ctx):
    return _mul_nbapi.of131_parse_actions(actions, act_len, parse_ctx)
of131_parse_actions = _mul_nbapi.of131_parse_actions

def of131_parse_act_set_field_tlv(ofp_sf, act_parsers, parse_ctx):
    return _mul_nbapi.of131_parse_act_set_field_tlv(ofp_sf, act_parsers, parse_ctx)
of131_parse_act_set_field_tlv = _mul_nbapi.of131_parse_act_set_field_tlv

def of131_parse_instructions(fl, mask, inst_list, inst_len, inst_handlers, act_handlers, u_arg, acts_only):
    return _mul_nbapi.of131_parse_instructions(fl, mask, inst_list, inst_len, inst_handlers, act_handlers, u_arg, acts_only)
of131_parse_instructions = _mul_nbapi.of131_parse_instructions

def of131_validate_actions(fl, mask, inst_list, inst_len, acts_only, arg):
    return _mul_nbapi.of131_validate_actions(fl, mask, inst_list, inst_len, acts_only, arg)
of131_validate_actions = _mul_nbapi.of131_validate_actions

def of131_dump_actions(inst_list, inst_len, acts_only):
    return _mul_nbapi.of131_dump_actions(inst_list, inst_len, acts_only)
of131_dump_actions = _mul_nbapi.of131_dump_actions

def of131_dump_actions_cmd(inst_list, inst_len, acts_only):
    return _mul_nbapi.of131_dump_actions_cmd(inst_list, inst_len, acts_only)
of131_dump_actions_cmd = _mul_nbapi.of131_dump_actions_cmd

def of131_dump_queue_stats(q_stats, stat_len):
    return _mul_nbapi.of131_dump_queue_stats(q_stats, stat_len)
of131_dump_queue_stats = _mul_nbapi.of131_dump_queue_stats

def of131_supports_multi_tables(n_tables, table_id):
    return _mul_nbapi.of131_supports_multi_tables(n_tables, table_id)
of131_supports_multi_tables = _mul_nbapi.of131_supports_multi_tables

def of131_flow_normalize(fl, mask):
    return _mul_nbapi.of131_flow_normalize(fl, mask)
of131_flow_normalize = _mul_nbapi.of131_flow_normalize

def of131_group_features_dump(feat, feat_len):
    return _mul_nbapi.of131_group_features_dump(feat, feat_len)
of131_group_features_dump = _mul_nbapi.of131_group_features_dump

def of131_meter_features_dump(feat, feat_len):
    return _mul_nbapi.of131_meter_features_dump(feat, feat_len)
of131_meter_features_dump = _mul_nbapi.of131_meter_features_dump

def of131_group_validate_feat(g_parms, gp_feat):
    return _mul_nbapi.of131_group_validate_feat(g_parms, gp_feat)
of131_group_validate_feat = _mul_nbapi.of131_group_validate_feat

def of131_meter_validate_feat(m_parms, m_feat):
    return _mul_nbapi.of131_meter_validate_feat(m_parms, m_feat)
of131_meter_validate_feat = _mul_nbapi.of131_meter_validate_feat

def of131_table_features_dump(prop):
    return _mul_nbapi.of131_table_features_dump(prop)
of131_table_features_dump = _mul_nbapi.of131_table_features_dump

def of131_switch_supports_group_stats(cap):
    return _mul_nbapi.of131_switch_supports_group_stats(cap)
of131_switch_supports_group_stats = _mul_nbapi.of131_switch_supports_group_stats

def of131_switch_supports_flow_stats(cap):
    return _mul_nbapi.of131_switch_supports_flow_stats(cap)
of131_switch_supports_flow_stats = _mul_nbapi.of131_switch_supports_flow_stats

def of131_switch_supports_table_stats(cap):
    return _mul_nbapi.of131_switch_supports_table_stats(cap)
of131_switch_supports_table_stats = _mul_nbapi.of131_switch_supports_table_stats

def of131_prep_group_stat_req(group_id):
    return _mul_nbapi.of131_prep_group_stat_req(group_id)
of131_prep_group_stat_req = _mul_nbapi.of131_prep_group_stat_req

def of131_prep_meter_stat_req(meter_id):
    return _mul_nbapi.of131_prep_meter_stat_req(meter_id)
of131_prep_meter_stat_req = _mul_nbapi.of131_prep_meter_stat_req

def of131_prep_meter_config_req(meter_id):
    return _mul_nbapi.of131_prep_meter_config_req(meter_id)
of131_prep_meter_config_req = _mul_nbapi.of131_prep_meter_config_req

def of131_prep_port_stat_req(port):
    return _mul_nbapi.of131_prep_port_stat_req(port)
of131_prep_port_stat_req = _mul_nbapi.of131_prep_port_stat_req

def of131_prep_q_get_config(port_no):
    return _mul_nbapi.of131_prep_q_get_config(port_no)
of131_prep_q_get_config = _mul_nbapi.of131_prep_q_get_config

def of131_dump_msg(b, tx, mask, dpid):
    return _mul_nbapi.of131_dump_msg(b, tx, mask, dpid)
of131_dump_msg = _mul_nbapi.of131_dump_msg

def of131_port_stats_dump(feat, feat_len):
    return _mul_nbapi.of131_port_stats_dump(feat, feat_len)
of131_port_stats_dump = _mul_nbapi.of131_port_stats_dump

def of_port_stats_dump(feat, feat_len):
    return _mul_nbapi.of_port_stats_dump(feat, feat_len)
of_port_stats_dump = _mul_nbapi.of_port_stats_dump

def ofp131_dump_port_details(string, config, state):
    return _mul_nbapi.ofp131_dump_port_details(string, config, state)
ofp131_dump_port_details = _mul_nbapi.ofp131_dump_port_details

def of131_modify_uflow(fl, mask, inst_list, inst_len, acts_only, arg):
    return _mul_nbapi.of131_modify_uflow(fl, mask, inst_list, inst_len, acts_only, arg)
of131_modify_uflow = _mul_nbapi.of131_modify_uflow

def ofp_dump_port_details(string, config, state):
    return _mul_nbapi.ofp_dump_port_details(string, config, state)
ofp_dump_port_details = _mul_nbapi.ofp_dump_port_details

def ofp_convert_flow_endian_hton(fl):
    return _mul_nbapi.ofp_convert_flow_endian_hton(fl)
ofp_convert_flow_endian_hton = _mul_nbapi.ofp_convert_flow_endian_hton

def of_prep_port_mod_msg(port_no, pm_params, hw_addr):
    return _mul_nbapi.of_prep_port_mod_msg(port_no, pm_params, hw_addr)
...
def of140_prep_echo_reply_msg(xid):
    return _mul_nbapi.of140_prep_echo_reply_msg(xid)
...
def of140_prep_mpart_msg(type, flags, body_len):
    return _mul_nbapi.of140_prep_mpart_msg(type, flags, body_len)
of140_prep_mpart_msg = _mul_nbapi.of140_prep_mpart_msg

def of140_prep_role_request_msg(role, gen_id):
    return _mul_nbapi.of140_prep_role_request_msg(role, gen_id)
of140_prep_role_request_msg = _mul_nbapi.of140_prep_role_request_msg

def ofp_dump_port_type(string, type):
    return _mul_nbapi.ofp_dump_port_type(string, type)
ofp_dump_port_type = _mul_nbapi.ofp_dump_port_type

def ofp_dump_port_speed(string, curr_speed, max_speed):
    return _mul_nbapi.ofp_dump_port_speed(string, curr_speed, max_speed)
ofp_dump_port_speed = _mul_nbapi.ofp_dump_port_speed

def of140_prep_flow_add_msg(flow, mask, buffer_id, ins_list, ins_len, i_timeo, h_timeo, prio, cookie, mod):
    return _mul_nbapi.of140_prep_flow_add_msg(flow, mask, buffer_id, ins_list, ins_len, i_timeo, h_timeo, prio, cookie, mod)
of140_prep_flow_add_msg = _mul_nbapi.of140_prep_flow_add_msg

def of140_prep_flow_del_msg(flow, mask, oport, strict, prio, group):
    return _mul_nbapi.of140_prep_flow_del_msg(flow, mask, oport, strict, prio, group)
of140_prep_flow_del_msg = _mul_nbapi.of140_prep_flow_del_msg

def of140_prep_flow_stat_msg(flow, mask, eoport, group):
    return _mul_nbapi.of140_prep_flow_stat_msg(flow, mask, eoport, group)
of140_prep_flow_stat_msg = _mul_nbapi.of140_prep_flow_stat_msg

def of140_prep_queue_stat_msg(port, queue):
    return _mul_nbapi.of140_prep_queue_stat_msg(port, queue)
of140_prep_queue_stat_msg = _mul_nbapi.of140_prep_queue_stat_msg

def of140_prep_group_stat_req(group_id):
    return _mul_nbapi.of140_prep_group_stat_req(group_id)
of140_prep_group_stat_req = _mul_nbapi.of140_prep_group_stat_req

def of140_prep_meter_stat_req(meter_id):
    return _mul_nbapi.of140_prep_meter_stat_req(meter_id)
of140_prep_meter_stat_req = _mul_nbapi.of140_prep_meter_stat_req

def of140_prep_meter_config_req(meter_id):
    return _mul_nbapi.of140_prep_meter_config_req(meter_id)
of140_prep_meter_config_req = _mul_nbapi.of140_prep_meter_config_req

def of140_prep_port_stat_req(port):
    return _mul_nbapi.of140_prep_port_stat_req(port)
of140_prep_port_stat_req = _mul_nbapi.of140_prep_port_stat_req

def of140_prep_group_add_msg(group, type, act_vectors, act_vec_len, modify):
    return _mul_nbapi.of140_prep_group_add_msg(group, type, act_vectors, act_vec_len, modify)
of140_prep_group_add_msg = _mul_nbapi.of140_prep_group_add_msg

def of140_prep_group_del_msg(group):
    return _mul_nbapi.of140_prep_group_del_msg(group)
of140_prep_group_del_msg = _mul_nbapi.of140_prep_group_del_msg

def of140_prep_meter_add_msg(meter, flags, band_vectors, nbands, modify):
    return _mul_nbapi.of140_prep_meter_add_msg(meter, flags, band_vectors, nbands, modify)
of140_prep_meter_add_msg = _mul_nbapi.of140_prep_meter_add_msg

def of140_prep_meter_del_msg(meter):
    return _mul_nbapi.of140_prep_meter_del_msg(meter)
of140_prep_meter_del_msg = _mul_nbapi.of140_prep_meter_del_msg

def of140_prep_port_mod_msg(port_no, pm_params, hw_addr):
    return _mul_nbapi.of140_prep_port_mod_msg(port_no, pm_params, hw_addr)
of140_prep_port_mod_msg = _mul_nbapi.of140_prep_port_mod_msg

def of140_port_stats_dump(feat, feat_len):
    return _mul_nbapi.of140_port_stats_dump(feat, feat_len)
of140_port_stats_dump = _mul_nbapi.of140_port_stats_dump

def of140_prep_pkt_out_msg(parms):
    return _mul_nbapi.of140_prep_pkt_out_msg(parms)
...
def of140_prep_q_get_config(port_no):
    return _mul_nbapi.of140_prep_q_get_config(port_no)
of140_prep_q_get_config = _mul_nbapi.of140_prep_q_get_config

def of140_prep_set_config_msg(flags, miss_len):
    return _mul_nbapi.of140_prep_set_config_msg(flags, miss_len)
of140_prep_set_config_msg = _mul_nbapi.of140_prep_set_config_msg
class mul_getopt_helper_info(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, mul_getopt_helper_info, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, mul_getopt_helper_info, name)
    __repr__ = _swig_repr
    __swig_setmethods__["module_init_fn"] = _mul_nbapi.mul_getopt_helper_info_module_init_fn_set
    __swig_getmethods__["module_init_fn"] = _mul_nbapi.mul_getopt_helper_info_module_init_fn_get
    if _newclass:
        module_init_fn = _swig_property(_mul_nbapi.mul_getopt_helper_info_module_init_fn_get, _mul_nbapi.mul_getopt_helper_info_module_init_fn_set)
    __swig_setmethods__["module_getopt_helper_fn"] = _mul_nbapi.mul_getopt_helper_info_module_getopt_helper_fn_set
    __swig_getmethods__["module_getopt_helper_fn"] = _mul_nbapi.mul_getopt_helper_info_module_getopt_helper_fn_get
    if _newclass:
        module_getopt_helper_fn = _swig_property(_mul_nbapi.mul_getopt_helper_info_module_getopt_helper_fn_get, _mul_nbapi.mul_getopt_helper_info_module_getopt_helper_fn_set)
    __swig_setmethods__["priv"] = _mul_nbapi.mul_getopt_helper_info_priv_set
    __swig_getmethods__["priv"] = _mul_nbapi.mul_getopt_helper_info_priv_get
    if _newclass:
        priv = _swig_property(_mul_nbapi.mul_getopt_helper_info_priv_get, _mul_nbapi.mul_getopt_helper_info_priv_set)
    __swig_setmethods__["opts"] = _mul_nbapi.mul_getopt_helper_info_opts_set
    __swig_getmethods__["opts"] = _mul_nbapi.mul_getopt_helper_info_opts_get
    if _newclass:
        opts = _swig_property(_mul_nbapi.mul_getopt_helper_info_opts_get, _mul_nbapi.mul_getopt_helper_info_opts_set)
    __swig_setmethods__["longopts"] = _mul_nbapi.mul_getopt_helper_info_longopts_set
    __swig_getmethods__["longopts"] = _mul_nbapi.mul_getopt_helper_info_longopts_get
    if _newclass:
        longopts = _swig_property(_mul_nbapi.mul_getopt_helper_info_longopts_get, _mul_nbapi.mul_getopt_helper_info_longopts_set)
    __swig_setmethods__["longopts_len"] = _mul_nbapi.mul_getopt_helper_info_longopts_len_set
    __swig_getmethods__["longopts_len"] = _mul_nbapi.mul_getopt_helper_info_longopts_len_get
    if _newclass:
        longopts_len = _swig_property(_mul_nbapi.mul_getopt_helper_info_longopts_len_get, _mul_nbapi.mul_getopt_helper_info_longopts_len_set)
    __swig_setmethods__["usage"] = _mul_nbapi.mul_getopt_helper_info_usage_set
    __swig_getmethods__["usage"] = _mul_nbapi.mul_getopt_helper_info_usage_get
    if _newclass:
        usage = _swig_property(_mul_nbapi.mul_getopt_helper_info_usage_get, _mul_nbapi.mul_getopt_helper_info_usage_set)

    def __init__(self):
        this = _mul_nbapi.new_mul_getopt_helper_info()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _mul_nbapi.delete_mul_getopt_helper_info
    __del__ = lambda self: None
mul_getopt_helper_info_swigregister = _mul_nbapi.mul_getopt_helper_info_swigregister
mul_getopt_helper_info_swigregister(mul_getopt_helper_info)
...
class c_ofp_switch_delete(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_switch_delete_header_get, _mul_nbapi.c_ofp_switch_delete_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_delete_datapath_id_get, _mul_nbapi.c_ofp_switch_delete_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_switch_delete_sw_alias_get, _mul_nbapi.c_ofp_switch_delete_sw_alias_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_switch_delete_pad_get, _mul_nbapi.c_ofp_switch_delete_pad_set)
...
class c_ofp_vendor_message(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_vendor_message_header_get, _mul_nbapi.c_ofp_vendor_message_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_vendor_message_datapath_id_get, _mul_nbapi.c_ofp_vendor_message_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_vendor_message_sw_alias_get, _mul_nbapi.c_ofp_vendor_message_sw_alias_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_vendor_message_pad_get, _mul_nbapi.c_ofp_vendor_message_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_vendor_message_data_get, _mul_nbapi.c_ofp_vendor_message_data_set)
...
class c_ofp_send_vendor_message(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_send_vendor_message_header_get, _mul_nbapi.c_ofp_send_vendor_message_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_send_vendor_message_datapath_id_get, _mul_nbapi.c_ofp_send_vendor_message_datapath_id_set)
    ...
    if _newclass:
        vendor_id = _swig_property(_mul_nbapi.c_ofp_send_vendor_message_vendor_id_get, _mul_nbapi.c_ofp_send_vendor_message_vendor_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_send_vendor_message_pad_get, _mul_nbapi.c_ofp_send_vendor_message_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_send_vendor_message_data_get, _mul_nbapi.c_ofp_send_vendor_message_data_set)
...
class c_sw_port(_object):
    ...
    if _newclass:
        of_config = _swig_property(_mul_nbapi.c_sw_port_of_config_get, _mul_nbapi.c_sw_port_of_config_set)
    ...
    if _newclass:
        of_state = _swig_property(_mul_nbapi.c_sw_port_of_state_get, _mul_nbapi.c_sw_port_of_state_set)
    __swig_setmethods__["curr"] = _mul_nbapi.c_sw_port_curr_set
    __swig_getmethods__["curr"] = _mul_nbapi.c_sw_port_curr_get
    if _newclass:
        curr = _swig_property(_mul_nbapi.c_sw_port_curr_get, _mul_nbapi.c_sw_port_curr_set)
    ...
    if _newclass:
        advertised = _swig_property(_mul_nbapi.c_sw_port_advertised_get, _mul_nbapi.c_sw_port_advertised_set)
    ...
    if _newclass:
        supported = _swig_property(_mul_nbapi.c_sw_port_supported_get, _mul_nbapi.c_sw_port_supported_set)
    __swig_setmethods__["peer"] = _mul_nbapi.c_sw_port_peer_set
    __swig_getmethods__["peer"] = _mul_nbapi.c_sw_port_peer_get
    if _newclass:
        peer = _swig_property(_mul_nbapi.c_sw_port_peer_get, _mul_nbapi.c_sw_port_peer_set)
    ...
    if _newclass:
        curr_speed = _swig_property(_mul_nbapi.c_sw_port_curr_speed_get, _mul_nbapi.c_sw_port_curr_speed_set)
    ...
    if _newclass:
        max_speed = _swig_property(_mul_nbapi.c_sw_port_max_speed_get, _mul_nbapi.c_sw_port_max_speed_set)
...
class c_ofp_switch_add(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_switch_add_header_get, _mul_nbapi.c_ofp_switch_add_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_add_datapath_id_get, _mul_nbapi.c_ofp_switch_add_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_switch_add_sw_alias_get, _mul_nbapi.c_ofp_switch_add_sw_alias_set)
    ...
    if _newclass:
        n_buffers = _swig_property(_mul_nbapi.c_ofp_switch_add_n_buffers_get, _mul_nbapi.c_ofp_switch_add_n_buffers_set)
    ...
    if _newclass:
        state = _swig_property(_mul_nbapi.c_ofp_switch_add_state_get, _mul_nbapi.c_ofp_switch_add_state_set)
    ...
    if _newclass:
        rx_rlim_pps = _swig_property(_mul_nbapi.c_ofp_switch_add_rx_rlim_pps_get, _mul_nbapi.c_ofp_switch_add_rx_rlim_pps_set)
    ...
    if _newclass:
        tx_rlim_pps = _swig_property(_mul_nbapi.c_ofp_switch_add_tx_rlim_pps_get, _mul_nbapi.c_ofp_switch_add_tx_rlim_pps_set)
    ...
    if _newclass:
        n_tables = _swig_property(_mul_nbapi.c_ofp_switch_add_n_tables_get, _mul_nbapi.c_ofp_switch_add_n_tables_set)
    __swig_setmethods__["ver"] = _mul_nbapi.c_ofp_switch_add_ver_set
    __swig_getmethods__["ver"] = _mul_nbapi.c_ofp_switch_add_ver_get
    if _newclass:
        ver = _swig_property(_mul_nbapi.c_ofp_switch_add_ver_get, _mul_nbapi.c_ofp_switch_add_ver_set)
    ...
    if _newclass:
        rx_dump_en = _swig_property(_mul_nbapi.c_ofp_switch_add_rx_dump_en_get, _mul_nbapi.c_ofp_switch_add_rx_dump_en_set)
    ...
    if _newclass:
        tx_dump_en = _swig_property(_mul_nbapi.c_ofp_switch_add_tx_dump_en_get, _mul_nbapi.c_ofp_switch_add_tx_dump_en_set)
    ...
    if _newclass:
        pad1 = _swig_property(_mul_nbapi.c_ofp_switch_add_pad1_get, _mul_nbapi.c_ofp_switch_add_pad1_set)
    ...
    if _newclass:
        capabilities = _swig_property(_mul_nbapi.c_ofp_switch_add_capabilities_get, _mul_nbapi.c_ofp_switch_add_capabilities_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.c_ofp_switch_add_actions_get, _mul_nbapi.c_ofp_switch_add_actions_set)
    ...
    if _newclass:
        ports = _swig_property(_mul_nbapi.c_ofp_switch_add_ports_get, _mul_nbapi.c_ofp_switch_add_ports_set)
...
class c_ofp_port_status(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_port_status_header_get, _mul_nbapi.c_ofp_port_status_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_port_status_datapath_id_get, _mul_nbapi.c_ofp_port_status_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_port_status_sw_alias_get, _mul_nbapi.c_ofp_port_status_sw_alias_set)
    ...
    if _newclass:
        config_mask = _swig_property(_mul_nbapi.c_ofp_port_status_config_mask_get, _mul_nbapi.c_ofp_port_status_config_mask_set)
    ...
    if _newclass:
        state_mask = _swig_property(_mul_nbapi.c_ofp_port_status_state_mask_get, _mul_nbapi.c_ofp_port_status_state_mask_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.c_ofp_port_status_reason_get, _mul_nbapi.c_ofp_port_status_reason_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_port_status_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_port_status_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_port_status_pad_get, _mul_nbapi.c_ofp_port_status_pad_set)
    ...
    if _newclass:
        desc = _swig_property(_mul_nbapi.c_ofp_port_status_desc_get, _mul_nbapi.c_ofp_port_status_desc_set)
...
class ip_flow(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ip_flow, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ip_flow, name)
    __repr__ = _swig_repr
    __swig_setmethods__["nw_src"] = _mul_nbapi.ip_flow_nw_src_set
    __swig_getmethods__["nw_src"] = _mul_nbapi.ip_flow_nw_src_get
    if _newclass:
        nw_src = _swig_property(_mul_nbapi.ip_flow_nw_src_get, _mul_nbapi.ip_flow_nw_src_set)
    __swig_setmethods__["nw_dst"] = _mul_nbapi.ip_flow_nw_dst_set
    __swig_getmethods__["nw_dst"] = _mul_nbapi.ip_flow_nw_dst_get
    if _newclass:
        nw_dst = _swig_property(_mul_nbapi.ip_flow_nw_dst_get, _mul_nbapi.ip_flow_nw_dst_set)

    def __init__(self):
        this = _mul_nbapi.new_ip_flow()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _mul_nbapi.delete_ip_flow
    __del__ = lambda self: None
ip_flow_swigregister = _mul_nbapi.ip_flow_swigregister
ip_flow_swigregister(ip_flow)

class ipv6_flow(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ipv6_flow, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ipv6_flow, name)
    __repr__ = _swig_repr
    __swig_setmethods__["nw_src"] = _mul_nbapi.ipv6_flow_nw_src_set
    __swig_getmethods__["nw_src"] = _mul_nbapi.ipv6_flow_nw_src_get
    if _newclass:
        nw_src = _swig_property(_mul_nbapi.ipv6_flow_nw_src_get, _mul_nbapi.ipv6_flow_nw_src_set)
    __swig_setmethods__["nw_dst"] = _mul_nbapi.ipv6_flow_nw_dst_set
    __swig_getmethods__["nw_dst"] = _mul_nbapi.ipv6_flow_nw_dst_get
    if _newclass:
        nw_dst = _swig_property(_mul_nbapi.ipv6_flow_nw_dst_get, _mul_nbapi.ipv6_flow_nw_dst_set)

    def __init__(self):
        this = _mul_nbapi.new_ipv6_flow()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _mul_nbapi.delete_ipv6_flow
    __del__ = lambda self: None
ipv6_flow_swigregister = _mul_nbapi.ipv6_flow_swigregister
ipv6_flow_swigregister(ipv6_flow)
...
class c_ofp_packet_in(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_packet_in_header_get, _mul_nbapi.c_ofp_packet_in_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_packet_in_datapath_id_get, _mul_nbapi.c_ofp_packet_in_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_packet_in_sw_alias_get, _mul_nbapi.c_ofp_packet_in_sw_alias_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.c_ofp_packet_in_buffer_id_get, _mul_nbapi.c_ofp_packet_in_buffer_id_set)
    __swig_setmethods__["fl"] = _mul_nbapi.c_ofp_packet_in_fl_set
    __swig_getmethods__["fl"] = _mul_nbapi.c_ofp_packet_in_fl_get
    if _newclass:
        fl = _swig_property(_mul_nbapi.c_ofp_packet_in_fl_get, _mul_nbapi.c_ofp_packet_in_fl_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.c_ofp_packet_in_in_port_get, _mul_nbapi.c_ofp_packet_in_in_port_set)
    ...
    if _newclass:
        total_len = _swig_property(_mul_nbapi.c_ofp_packet_in_total_len_get, _mul_nbapi.c_ofp_packet_in_total_len_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.c_ofp_packet_in_reason_get, _mul_nbapi.c_ofp_packet_in_reason_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_packet_in_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_packet_in_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_packet_in_pad_get, _mul_nbapi.c_ofp_packet_in_pad_set)
    __swig_setmethods__["data"] = _mul_nbapi.c_ofp_packet_in_data_set
    __swig_getmethods__["data"] = _mul_nbapi.c_ofp_packet_in_data_get
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_packet_in_data_get, _mul_nbapi.c_ofp_packet_in_data_set)
...
class c_ofp_flow_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_flow_mod_header_get, _mul_nbapi.c_ofp_flow_mod_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_flow_mod_datapath_id_get, _mul_nbapi.c_ofp_flow_mod_datapath_id_set)
    __swig_setmethods__["flow"] = _mul_nbapi.c_ofp_flow_mod_flow_set
    __swig_getmethods__["flow"] = _mul_nbapi.c_ofp_flow_mod_flow_get
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_ofp_flow_mod_flow_get, _mul_nbapi.c_ofp_flow_mod_flow_set)
    __swig_setmethods__["mask"] = _mul_nbapi.c_ofp_flow_mod_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.c_ofp_flow_mod_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.c_ofp_flow_mod_mask_get, _mul_nbapi.c_ofp_flow_mod_mask_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.c_ofp_flow_mod_flags_get, _mul_nbapi.c_ofp_flow_mod_flags_set)
    __swig_setmethods__["pad0"] = _mul_nbapi.c_ofp_flow_mod_pad0_set
    __swig_getmethods__["pad0"] = _mul_nbapi.c_ofp_flow_mod_pad0_get
    if _newclass:
        pad0 = _swig_property(_mul_nbapi.c_ofp_flow_mod_pad0_get, _mul_nbapi.c_ofp_flow_mod_pad0_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.c_ofp_flow_mod_command_get, _mul_nbapi.c_ofp_flow_mod_command_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.c_ofp_flow_mod_priority_get, _mul_nbapi.c_ofp_flow_mod_priority_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_flow_mod_sw_alias_get, _mul_nbapi.c_ofp_flow_mod_sw_alias_set)
    ...
    if _newclass:
        wildcards = _swig_property(_mul_nbapi.c_ofp_flow_mod_wildcards_get, _mul_nbapi.c_ofp_flow_mod_wildcards_set)
    ...
    if _newclass:
        itimeo = _swig_property(_mul_nbapi.c_ofp_flow_mod_itimeo_get, _mul_nbapi.c_ofp_flow_mod_itimeo_set)
    ...
    if _newclass:
        htimeo = _swig_property(_mul_nbapi.c_ofp_flow_mod_htimeo_get, _mul_nbapi.c_ofp_flow_mod_htimeo_set)
    ...
    if _newclass:
        oport = _swig_property(_mul_nbapi.c_ofp_flow_mod_oport_get, _mul_nbapi.c_ofp_flow_mod_oport_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.c_ofp_flow_mod_buffer_id_get, _mul_nbapi.c_ofp_flow_mod_buffer_id_set)
    ...
    if _newclass:
        ogroup = _swig_property(_mul_nbapi.c_ofp_flow_mod_ogroup_get, _mul_nbapi.c_ofp_flow_mod_ogroup_set)
    ...
    if _newclass:
        mod_flags = _swig_property(_mul_nbapi.c_ofp_flow_mod_mod_flags_get, _mul_nbapi.c_ofp_flow_mod_mod_flags_set)
    __swig_setmethods__["pad1"] = _mul_nbapi.c_ofp_flow_mod_pad1_set
    __swig_getmethods__["pad1"] = _mul_nbapi.c_ofp_flow_mod_pad1_get
    if _newclass:
        pad1 = _swig_property(_mul_nbapi.c_ofp_flow_mod_pad1_get, _mul_nbapi.c_ofp_flow_mod_pad1_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.c_ofp_flow_mod_cookie_get, _mul_nbapi.c_ofp_flow_mod_cookie_set)
    ...
    if _newclass:
        seq_cookie = _swig_property(_mul_nbapi.c_ofp_flow_mod_seq_cookie_get, _mul_nbapi.c_ofp_flow_mod_seq_cookie_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.c_ofp_flow_mod_actions_get, _mul_nbapi.c_ofp_flow_mod_actions_set)
...
class c_ofp_flow_info(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_flow_info_header_get, _mul_nbapi.c_ofp_flow_info_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_flow_info_datapath_id_get, _mul_nbapi.c_ofp_flow_info_datapath_id_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.c_ofp_flow_info_sw_alias_get, _mul_nbapi.c_ofp_flow_info_sw_alias_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_flow_info_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_flow_info_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_flow_info_pad_get, _mul_nbapi.c_ofp_flow_info_pad_set)
    __swig_setmethods__["flow"] = _mul_nbapi.c_ofp_flow_info_flow_set
    __swig_getmethods__["flow"] = _mul_nbapi.c_ofp_flow_info_flow_get
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_ofp_flow_info_flow_get, _mul_nbapi.c_ofp_flow_info_flow_set)
    __swig_setmethods__["mask"] = _mul_nbapi.c_ofp_flow_info_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.c_ofp_flow_info_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.c_ofp_flow_info_mask_get, _mul_nbapi.c_ofp_flow_info_mask_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.c_ofp_flow_info_flags_get, _mul_nbapi.c_ofp_flow_info_flags_set)
    __swig_setmethods__["pad0"] = _mul_nbapi.c_ofp_flow_info_pad0_set
    __swig_getmethods__["pad0"] = _mul_nbapi.c_ofp_flow_info_pad0_get
    if _newclass:
        pad0 = _swig_property(_mul_nbapi.c_ofp_flow_info_pad0_get, _mul_nbapi.c_ofp_flow_info_pad0_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.c_ofp_flow_info_command_get, _mul_nbapi.c_ofp_flow_info_command_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.c_ofp_flow_info_priority_get, _mul_nbapi.c_ofp_flow_info_priority_set)
    ...
    if _newclass:
        wildcards = _swig_property(_mul_nbapi.c_ofp_flow_info_wildcards_get, _mul_nbapi.c_ofp_flow_info_wildcards_set)
    ...
    if _newclass:
        itimeo = _swig_property(_mul_nbapi.c_ofp_flow_info_itimeo_get, _mul_nbapi.c_ofp_flow_info_itimeo_set)
    ...
    if _newclass:
        htimeo = _swig_property(_mul_nbapi.c_ofp_flow_info_htimeo_get, _mul_nbapi.c_ofp_flow_info_htimeo_set)
    ...
    if _newclass:
        mod_flags = _swig_property(_mul_nbapi.c_ofp_flow_info_mod_flags_get, _mul_nbapi.c_ofp_flow_info_mod_flags_set)
    ...
    if _newclass:
        oport = _swig_property(_mul_nbapi.c_ofp_flow_info_oport_get, _mul_nbapi.c_ofp_flow_info_oport_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.c_ofp_flow_info_buffer_id_get, _mul_nbapi.c_ofp_flow_info_buffer_id_set)
    __swig_setmethods__["pad1"] = _mul_nbapi.c_ofp_flow_info_pad1_set
    __swig_getmethods__["pad1"] = _mul_nbapi.c_ofp_flow_info_pad1_get
    if _newclass:
        pad1 = _swig_property(_mul_nbapi.c_ofp_flow_info_pad1_get, _mul_nbapi.c_ofp_flow_info_pad1_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.c_ofp_flow_info_byte_count_get, _mul_nbapi.c_ofp_flow_info_byte_count_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.c_ofp_flow_info_packet_count_get, _mul_nbapi.c_ofp_flow_info_packet_count_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.c_ofp_flow_info_duration_sec_get, _mul_nbapi.c_ofp_flow_info_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.c_ofp_flow_info_duration_nsec_get, _mul_nbapi.c_ofp_flow_info_duration_nsec_set)
    __swig_setmethods__["bps"] = _mul_nbapi.c_ofp_flow_info_bps_set
    __swig_getmethods__["bps"] = _mul_nbapi.c_ofp_flow_info_bps_get
    if _newclass:
        bps = _swig_property(_mul_nbapi.c_ofp_flow_info_bps_get, _mul_nbapi.c_ofp_flow_info_bps_set)
    __swig_setmethods__["pps"] = _mul_nbapi.c_ofp_flow_info_pps_set
    __swig_getmethods__["pps"] = _mul_nbapi.c_ofp_flow_info_pps_get
    if _newclass:
        pps = _swig_property(_mul_nbapi.c_ofp_flow_info_pps_get, _mul_nbapi.c_ofp_flow_info_pps_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.c_ofp_flow_info_actions_get, _mul_nbapi.c_ofp_flow_info_actions_set)
...
class c_ofp_flow_removed(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_flow_removed_header_get, _mul_nbapi.c_ofp_flow_removed_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_flow_removed_datapath_id_get, _mul_nbapi.c_ofp_flow_removed_datapath_id_set)
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_ofp_flow_removed_flow_get, _mul_nbapi.c_ofp_flow_removed_flow_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.c_ofp_flow_removed_mask_get, _mul_nbapi.c_ofp_flow_removed_mask_set)
    ...
    if _newclass:
        cookie = _swig_property(_mul_nbapi.c_ofp_flow_removed_cookie_get, _mul_nbapi.c_ofp_flow_removed_cookie_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.c_ofp_flow_removed_duration_sec_get, _mul_nbapi.c_ofp_flow_removed_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.c_ofp_flow_removed_duration_nsec_get, _mul_nbapi.c_ofp_flow_removed_duration_nsec_set)
    ...
    if _newclass:
        idle_timeout = _swig_property(_mul_nbapi.c_ofp_flow_removed_idle_timeout_get, _mul_nbapi.c_ofp_flow_removed_idle_timeout_set)
    ...
    if _newclass:
        priority = _swig_property(_mul_nbapi.c_ofp_flow_removed_priority_get, _mul_nbapi.c_ofp_flow_removed_priority_set)
    ...
    if _newclass:
        reason = _swig_property(_mul_nbapi.c_ofp_flow_removed_reason_get, _mul_nbapi.c_ofp_flow_removed_reason_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_flow_removed_pad_get, _mul_nbapi.c_ofp_flow_removed_pad_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.c_ofp_flow_removed_packet_count_get, _mul_nbapi.c_ofp_flow_removed_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.c_ofp_flow_removed_byte_count_get, _mul_nbapi.c_ofp_flow_removed_byte_count_set)
...
class c_ofp_bkt(_object):
    ...
    if _newclass:
        weight = _swig_property(_mul_nbapi.c_ofp_bkt_weight_get, _mul_nbapi.c_ofp_bkt_weight_set)
    __swig_setmethods__["act_len"] = _mul_nbapi.c_ofp_bkt_act_len_set
    __swig_getmethods__["act_len"] = _mul_nbapi.c_ofp_bkt_act_len_get
    if _newclass:
        act_len = _swig_property(_mul_nbapi.c_ofp_bkt_act_len_get, _mul_nbapi.c_ofp_bkt_act_len_set)
    __swig_setmethods__["ff_port"] = _mul_nbapi.c_ofp_bkt_ff_port_set
    __swig_getmethods__["ff_port"] = _mul_nbapi.c_ofp_bkt_ff_port_get
    if _newclass:
        ff_port = _swig_property(_mul_nbapi.c_ofp_bkt_ff_port_get, _mul_nbapi.c_ofp_bkt_ff_port_set)
    ...
    if _newclass:
        ff_group = _swig_property(_mul_nbapi.c_ofp_bkt_ff_group_get, _mul_nbapi.c_ofp_bkt_ff_group_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_bkt_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_bkt_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_bkt_pad_get, _mul_nbapi.c_ofp_bkt_pad_set)
    __swig_setmethods__["actions"] = _mul_nbapi.c_ofp_bkt_actions_set
    __swig_getmethods__["actions"] = _mul_nbapi.c_ofp_bkt_actions_get
    if _newclass:
        actions = _swig_property(_mul_nbapi.c_ofp_bkt_actions_get, _mul_nbapi.c_ofp_bkt_actions_set)
...
class c_ofp_group_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_group_mod_header_get, _mul_nbapi.c_ofp_group_mod_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_group_mod_datapath_id_get, _mul_nbapi.c_ofp_group_mod_datapath_id_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.c_ofp_group_mod_command_get, _mul_nbapi.c_ofp_group_mod_command_set)
    __swig_setmethods__["type"] = _mul_nbapi.c_ofp_group_mod_type_set
    __swig_getmethods__["type"] = _mul_nbapi.c_ofp_group_mod_type_get
    if _newclass:
        type = _swig_property(_mul_nbapi.c_ofp_group_mod_type_get, _mul_nbapi.c_ofp_group_mod_type_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.c_ofp_group_mod_flags_get, _mul_nbapi.c_ofp_group_mod_flags_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_group_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_group_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_group_mod_pad_get, _mul_nbapi.c_ofp_group_mod_pad_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.c_ofp_group_mod_group_id_get, _mul_nbapi.c_ofp_group_mod_group_id_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.c_ofp_group_mod_packet_count_get, _mul_nbapi.c_ofp_group_mod_packet_count_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.c_ofp_group_mod_byte_count_get, _mul_nbapi.c_ofp_group_mod_byte_count_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.c_ofp_group_mod_duration_sec_get, _mul_nbapi.c_ofp_group_mod_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.c_ofp_group_mod_duration_nsec_get, _mul_nbapi.c_ofp_group_mod_duration_nsec_set)
    ...
    if _newclass:
        buckets = _swig_property(_mul_nbapi.c_ofp_group_mod_buckets_get, _mul_nbapi.c_ofp_group_mod_buckets_set)
...
class c_ofp_meter_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_meter_mod_header_get, _mul_nbapi.c_ofp_meter_mod_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_meter_mod_datapath_id_get, _mul_nbapi.c_ofp_meter_mod_datapath_id_set)
    ...
    if _newclass:
        command = _swig_property(_mul_nbapi.c_ofp_meter_mod_command_get, _mul_nbapi.c_ofp_meter_mod_command_set)
    ...
    if _newclass:
        c_flags = _swig_property(_mul_nbapi.c_ofp_meter_mod_c_flags_get, _mul_nbapi.c_ofp_meter_mod_c_flags_set)
    ...
    if _newclass:
        flags = _swig_property(_mul_nbapi.c_ofp_meter_mod_flags_get, _mul_nbapi.c_ofp_meter_mod_flags_set)
    ...
    if _newclass:
        meter_id = _swig_property(_mul_nbapi.c_ofp_meter_mod_meter_id_get, _mul_nbapi.c_ofp_meter_mod_meter_id_set)
    ...
    if _newclass:
        byte_count = _swig_property(_mul_nbapi.c_ofp_meter_mod_byte_count_get, _mul_nbapi.c_ofp_meter_mod_byte_count_set)
    ...
    if _newclass:
        packet_count = _swig_property(_mul_nbapi.c_ofp_meter_mod_packet_count_get, _mul_nbapi.c_ofp_meter_mod_packet_count_set)
    ...
    if _newclass:
        flow_count = _swig_property(_mul_nbapi.c_ofp_meter_mod_flow_count_get, _mul_nbapi.c_ofp_meter_mod_flow_count_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_meter_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_meter_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_meter_mod_pad_get, _mul_nbapi.c_ofp_meter_mod_pad_set)
    ...
    if _newclass:
        duration_sec = _swig_property(_mul_nbapi.c_ofp_meter_mod_duration_sec_get, _mul_nbapi.c_ofp_meter_mod_duration_sec_set)
    ...
    if _newclass:
        duration_nsec = _swig_property(_mul_nbapi.c_ofp_meter_mod_duration_nsec_get, _mul_nbapi.c_ofp_meter_mod_duration_nsec_set)
    ...
    if _newclass:
        bands = _swig_property(_mul_nbapi.c_ofp_meter_mod_bands_get, _mul_nbapi.c_ofp_meter_mod_bands_set)
...
class c_ofp_port_mod(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_port_mod_header_get, _mul_nbapi.c_ofp_port_mod_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_port_mod_datapath_id_get, _mul_nbapi.c_ofp_port_mod_datapath_id_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.c_ofp_port_mod_port_no_get, _mul_nbapi.c_ofp_port_mod_port_no_set)
    ...
    if _newclass:
        config = _swig_property(_mul_nbapi.c_ofp_port_mod_config_get, _mul_nbapi.c_ofp_port_mod_config_set)
    __swig_setmethods__["mask"] = _mul_nbapi.c_ofp_port_mod_mask_set
    __swig_getmethods__["mask"] = _mul_nbapi.c_ofp_port_mod_mask_get
    if _newclass:
        mask = _swig_property(_mul_nbapi.c_ofp_port_mod_mask_get, _mul_nbapi.c_ofp_port_mod_mask_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_port_mod_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_port_mod_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_port_mod_pad_get, _mul_nbapi.c_ofp_port_mod_pad_set)
...
class c_ofp_packet_out(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_packet_out_header_get, _mul_nbapi.c_ofp_packet_out_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_packet_out_datapath_id_get, _mul_nbapi.c_ofp_packet_out_datapath_id_set)
    ...
    if _newclass:
        buffer_id = _swig_property(_mul_nbapi.c_ofp_packet_out_buffer_id_get, _mul_nbapi.c_ofp_packet_out_buffer_id_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.c_ofp_packet_out_in_port_get, _mul_nbapi.c_ofp_packet_out_in_port_set)
    ...
    if _newclass:
        actions_len = _swig_property(_mul_nbapi.c_ofp_packet_out_actions_len_get, _mul_nbapi.c_ofp_packet_out_actions_len_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_packet_out_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_packet_out_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_packet_out_pad_get, _mul_nbapi.c_ofp_packet_out_pad_set)
    ...
    if _newclass:
        actions = _swig_property(_mul_nbapi.c_ofp_packet_out_actions_get, _mul_nbapi.c_ofp_packet_out_actions_set)
...
class c_ofp_register_app(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_register_app_header_get, _mul_nbapi.c_ofp_register_app_header_set)
    ...
    if _newclass:
        app_name = _swig_property(_mul_nbapi.c_ofp_register_app_app_name_get, _mul_nbapi.c_ofp_register_app_app_name_set)
    ...
    if _newclass:
        app_flags = _swig_property(_mul_nbapi.c_ofp_register_app_app_flags_get, _mul_nbapi.c_ofp_register_app_app_flags_set)
    ...
    if _newclass:
        ev_mask = _swig_property(_mul_nbapi.c_ofp_register_app_ev_mask_get, _mul_nbapi.c_ofp_register_app_ev_mask_set)
    ...
    if _newclass:
        dpid = _swig_property(_mul_nbapi.c_ofp_register_app_dpid_get, _mul_nbapi.c_ofp_register_app_dpid_set)
    ...
    if _newclass:
        app_cookie = _swig_property(_mul_nbapi.c_ofp_register_app_app_cookie_get, _mul_nbapi.c_ofp_register_app_app_cookie_set)
    ...
    if _newclass:
        dpid_list = _swig_property(_mul_nbapi.c_ofp_register_app_dpid_list_get, _mul_nbapi.c_ofp_register_app_dpid_list_set)
...
class c_ofp_unregister_app(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_unregister_app_header_get, _mul_nbapi.c_ofp_unregister_app_header_set)
    ...
    if _newclass:
        app_name = _swig_property(_mul_nbapi.c_ofp_unregister_app_app_name_get, _mul_nbapi.c_ofp_unregister_app_app_name_set)
...
class c_ofp_set_fp_ops(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_set_fp_ops_header_get, _mul_nbapi.c_ofp_set_fp_ops_header_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_set_fp_ops_datapath_id_get, _mul_nbapi.c_ofp_set_fp_ops_datapath_id_set)
    ...
    if _newclass:
        fp_type = _swig_property(_mul_nbapi.c_ofp_set_fp_ops_fp_type_get, _mul_nbapi.c_ofp_set_fp_ops_fp_type_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_set_fp_ops_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_set_fp_ops_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_set_fp_ops_pad_get, _mul_nbapi.c_ofp_set_fp_ops_pad_set)
...
class c_ofp_async_config(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_async_config_datapath_id_get, _mul_nbapi.c_ofp_async_config_datapath_id_set)
    ...
    if _newclass:
        packet_in_mask = _swig_property(_mul_nbapi.c_ofp_async_config_packet_in_mask_get, _mul_nbapi.c_ofp_async_config_packet_in_mask_set)
    ...
    if _newclass:
        port_status_mask = _swig_property(_mul_nbapi.c_ofp_async_config_port_status_mask_get, _mul_nbapi.c_ofp_async_config_port_status_mask_set)
    ...
    if _newclass:
        flow_removed_mask = _swig_property(_mul_nbapi.c_ofp_async_config_flow_removed_mask_get, _mul_nbapi.c_ofp_async_config_flow_removed_mask_set)
...
class c_ofp_auxapp_cmd(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_auxapp_cmd_header_get, _mul_nbapi.c_ofp_auxapp_cmd_header_set)
    ...
    if _newclass:
        cmd_code = _swig_property(_mul_nbapi.c_ofp_auxapp_cmd_cmd_code_get, _mul_nbapi.c_ofp_auxapp_cmd_cmd_code_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_auxapp_cmd_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_auxapp_cmd_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_auxapp_cmd_pad_get, _mul_nbapi.c_ofp_auxapp_cmd_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_auxapp_cmd_data_get, _mul_nbapi.c_ofp_auxapp_cmd_data_set)
...
class c_ofp_req_dpid_attr(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_req_dpid_attr_datapath_id_get, _mul_nbapi.c_ofp_req_dpid_attr_datapath_id_set)
...
class c_ofp_group_info(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_group_info_datapath_id_get, _mul_nbapi.c_ofp_group_info_datapath_id_set)
    ...
    if _newclass:
        group_id = _swig_property(_mul_nbapi.c_ofp_group_info_group_id_get, _mul_nbapi.c_ofp_group_info_group_id_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_group_info_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_group_info_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_group_info_pad_get, _mul_nbapi.c_ofp_group_info_pad_set)
...
class c_ofp_port_neigh(_object):
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.c_ofp_port_neigh_port_no_get, _mul_nbapi.c_ofp_port_neigh_port_no_set)
    ...
    if _newclass:
        neigh_present = _swig_property(_mul_nbapi.c_ofp_port_neigh_neigh_present_get, _mul_nbapi.c_ofp_port_neigh_neigh_present_set)
    ...
    if _newclass:
        neigh_port = _swig_property(_mul_nbapi.c_ofp_port_neigh_neigh_port_get, _mul_nbapi.c_ofp_port_neigh_neigh_port_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_port_neigh_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_port_neigh_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_port_neigh_pad_get, _mul_nbapi.c_ofp_port_neigh_pad_set)
    ...
    if _newclass:
        neigh_dpid = _swig_property(_mul_nbapi.c_ofp_port_neigh_neigh_dpid_get, _mul_nbapi.c_ofp_port_neigh_neigh_dpid_set)
...
class c_ofp_switch_neigh(_object):
    ...
    if _newclass:
        switch_id = _swig_property(_mul_nbapi.c_ofp_switch_neigh_switch_id_get, _mul_nbapi.c_ofp_switch_neigh_switch_id_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_switch_neigh_data_get, _mul_nbapi.c_ofp_switch_neigh_data_set)
...
class c_ofp_switch_brief(_object):
    ...
    if _newclass:
        switch_id = _swig_property(_mul_nbapi.c_ofp_switch_brief_switch_id_get, _mul_nbapi.c_ofp_switch_brief_switch_id_set)
    ...
    if _newclass:
        n_ports = _swig_property(_mul_nbapi.c_ofp_switch_brief_n_ports_get, _mul_nbapi.c_ofp_switch_brief_n_ports_set)
    ...
    if _newclass:
        res = _swig_property(_mul_nbapi.c_ofp_switch_brief_res_get, _mul_nbapi.c_ofp_switch_brief_res_set)
    ...
    if _newclass:
        state = _swig_property(_mul_nbapi.c_ofp_switch_brief_state_get, _mul_nbapi.c_ofp_switch_brief_state_set)
    ...
    if _newclass:
        conn_str = _swig_property(_mul_nbapi.c_ofp_switch_brief_conn_str_get, _mul_nbapi.c_ofp_switch_brief_conn_str_set)
...
class c_ofp_switch_feature_common(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_feature_common_datapath_id_get, _mul_nbapi.c_ofp_switch_feature_common_datapath_id_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.c_ofp_switch_feature_common_table_id_get, _mul_nbapi.c_ofp_switch_feature_common_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_switch_feature_common_pad_get, _mul_nbapi.c_ofp_switch_feature_common_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_switch_feature_common_data_get, _mul_nbapi.c_ofp_switch_feature_common_data_set)
...
class c_ofp_switch_rlim(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_rlim_datapath_id_get, _mul_nbapi.c_ofp_switch_rlim_datapath_id_set)
    ...
    if _newclass:
        is_rx = _swig_property(_mul_nbapi.c_ofp_switch_rlim_is_rx_get, _mul_nbapi.c_ofp_switch_rlim_is_rx_set)
    __swig_setmethods__["pps"] = _mul_nbapi.c_ofp_switch_rlim_pps_set
    __swig_getmethods__["pps"] = _mul_nbapi.c_ofp_switch_rlim_pps_get
    if _newclass:
        pps = _swig_property(_mul_nbapi.c_ofp_switch_rlim_pps_get, _mul_nbapi.c_ofp_switch_rlim_pps_set)
...
class c_ofp_switch_of_dump(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_of_dump_datapath_id_get, _mul_nbapi.c_ofp_switch_of_dump_datapath_id_set)
    ...
    if _newclass:
        rx_enable = _swig_property(_mul_nbapi.c_ofp_switch_of_dump_rx_enable_get, _mul_nbapi.c_ofp_switch_of_dump_rx_enable_set)
    ...
    if _newclass:
        tx_enable = _swig_property(_mul_nbapi.c_ofp_switch_of_dump_tx_enable_get, _mul_nbapi.c_ofp_switch_of_dump_tx_enable_set)
    ...
    if _newclass:
        dump_mask = _swig_property(_mul_nbapi.c_ofp_switch_of_dump_dump_mask_get, _mul_nbapi.c_ofp_switch_of_dump_dump_mask_set)
...
class c_ofp_switch_stats_strategy(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_stats_strategy_datapath_id_get, _mul_nbapi.c_ofp_switch_stats_strategy_datapath_id_set)
    ...
    if _newclass:
        fl_bulk_enable = _swig_property(_mul_nbapi.c_ofp_switch_stats_strategy_fl_bulk_enable_get, _mul_nbapi.c_ofp_switch_stats_strategy_fl_bulk_enable_set)
    ...
    if _newclass:
        grp_bulk_enable = _swig_property(_mul_nbapi.c_ofp_switch_stats_strategy_grp_bulk_enable_get, _mul_nbapi.c_ofp_switch_stats_strategy_grp_bulk_enable_set)
    ...
    if _newclass:
        meter_bulk_config_enable = _swig_property(_mul_nbapi.c_ofp_switch_stats_strategy_meter_bulk_config_enable_get, _mul_nbapi.c_ofp_switch_stats_strategy_meter_bulk_config_enable_set)
    ...
    if _newclass:
        meter_bulk_enable = _swig_property(_mul_nbapi.c_ofp_switch_stats_strategy_meter_bulk_enable_get, _mul_nbapi.c_ofp_switch_stats_strategy_meter_bulk_enable_set)
...
class c_ofp_switch_stats_mode_config(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_stats_mode_config_datapath_id_get, _mul_nbapi.c_ofp_switch_stats_mode_config_datapath_id_set)
    ...
    if _newclass:
        stats_mode = _swig_property(_mul_nbapi.c_ofp_switch_stats_mode_config_stats_mode_get, _mul_nbapi.c_ofp_switch_stats_mode_config_stats_mode_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_switch_stats_mode_config_pad_get, _mul_nbapi.c_ofp_switch_stats_mode_config_pad_set)
...
class c_ofp_switch_table_stats(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_datapath_id_get, _mul_nbapi.c_ofp_switch_table_stats_datapath_id_set)
    ...
    if _newclass:
        table_id = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_table_id_get, _mul_nbapi.c_ofp_switch_table_stats_table_id_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_pad_get, _mul_nbapi.c_ofp_switch_table_stats_pad_set)
    ...
    if _newclass:
        active_count = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_active_count_get, _mul_nbapi.c_ofp_switch_table_stats_active_count_set)
    ...
    if _newclass:
        lookup_count = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_lookup_count_get, _mul_nbapi.c_ofp_switch_table_stats_lookup_count_set)
    ...
    if _newclass:
        matched_count = _swig_property(_mul_nbapi.c_ofp_switch_table_stats_matched_count_get, _mul_nbapi.c_ofp_switch_table_stats_matched_count_set)
...
class c_ofp_switch_port_query(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_switch_port_query_datapath_id_get, _mul_nbapi.c_ofp_switch_port_query_datapath_id_set)
    ...
    if _newclass:
        port_no = _swig_property(_mul_nbapi.c_ofp_switch_port_query_port_no_get, _mul_nbapi.c_ofp_switch_port_query_port_no_set)
    ...
    if _newclass:
        qid = _swig_property(_mul_nbapi.c_ofp_switch_port_query_qid_get, _mul_nbapi.c_ofp_switch_port_query_qid_set)
    ...
    if _newclass:
        stats_len = _swig_property(_mul_nbapi.c_ofp_switch_port_query_stats_len_get, _mul_nbapi.c_ofp_switch_port_query_stats_len_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_switch_port_query_pad_get, _mul_nbapi.c_ofp_switch_port_query_pad_set)
    ...
    if _newclass:
        data = _swig_property(_mul_nbapi.c_ofp_switch_port_query_data_get, _mul_nbapi.c_ofp_switch_port_query_data_set)
...
class c_ofp_host_mod(_object):
    ...
    if _newclass:
        switch_id = _swig_property(_mul_nbapi.c_ofp_host_mod_switch_id_get, _mul_nbapi.c_ofp_host_mod_switch_id_set)
    ...
    if _newclass:
        tenant_id = _swig_property(_mul_nbapi.c_ofp_host_mod_tenant_id_get, _mul_nbapi.c_ofp_host_mod_tenant_id_set)
    ...
    if _newclass:
        network_id = _swig_property(_mul_nbapi.c_ofp_host_mod_network_id_get, _mul_nbapi.c_ofp_host_mod_network_id_set)
    ...
    if _newclass:
        host_flow = _swig_property(_mul_nbapi.c_ofp_host_mod_host_flow_get, _mul_nbapi.c_ofp_host_mod_host_flow_set)
...
class c_ofp_port_tnid_mod(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_port_tnid_mod_datapath_id_get, _mul_nbapi.c_ofp_port_tnid_mod_datapath_id_set)
    ...
    if _newclass:
        port = _swig_property(_mul_nbapi.c_ofp_port_tnid_mod_port_get, _mul_nbapi.c_ofp_port_tnid_mod_port_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_port_tnid_mod_pad_get, _mul_nbapi.c_ofp_port_tnid_mod_pad_set)
    ...
    if _newclass:
        tenant_id = _swig_property(_mul_nbapi.c_ofp_port_tnid_mod_tenant_id_get, _mul_nbapi.c_ofp_port_tnid_mod_tenant_id_set)
    ...
    if _newclass:
        network_id = _swig_property(_mul_nbapi.c_ofp_port_tnid_mod_network_id_get, _mul_nbapi.c_ofp_port_tnid_mod_network_id_set)
...
class c_ofp_tenant_nw_mod(_object):
    ...
    if _newclass:
        tenant_id = _swig_property(_mul_nbapi.c_ofp_tenant_nw_mod_tenant_id_get, _mul_nbapi.c_ofp_tenant_nw_mod_tenant_id_set)
    ...
    if _newclass:
        network_id = _swig_property(_mul_nbapi.c_ofp_tenant_nw_mod_network_id_get, _mul_nbapi.c_ofp_tenant_nw_mod_network_id_set)
...
class c_ofp_route(_object):
    ...
    if _newclass:
        src_host = _swig_property(_mul_nbapi.c_ofp_route_src_host_get, _mul_nbapi.c_ofp_route_src_host_set)
    ...
    if _newclass:
        dst_host = _swig_property(_mul_nbapi.c_ofp_route_dst_host_get, _mul_nbapi.c_ofp_route_dst_host_set)
    ...
    if _newclass:
        route_links = _swig_property(_mul_nbapi.c_ofp_route_route_links_get, _mul_nbapi.c_ofp_route_route_links_set)
...
class c_ofp_route_link(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_route_link_datapath_id_get, _mul_nbapi.c_ofp_route_link_datapath_id_set)
    ...
    if _newclass:
        src_link = _swig_property(_mul_nbapi.c_ofp_route_link_src_link_get, _mul_nbapi.c_ofp_route_link_src_link_set)
    ...
    if _newclass:
        dst_link = _swig_property(_mul_nbapi.c_ofp_route_link_dst_link_get, _mul_nbapi.c_ofp_route_link_dst_link_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_route_link_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_route_link_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_route_link_pad_get, _mul_nbapi.c_ofp_route_link_pad_set)
...
class c_ofp_ha_state(_object):
    ...
    if _newclass:
        ha_sysid = _swig_property(_mul_nbapi.c_ofp_ha_state_ha_sysid_get, _mul_nbapi.c_ofp_ha_state_ha_sysid_set)
    ...
    if _newclass:
        ha_state = _swig_property(_mul_nbapi.c_ofp_ha_state_ha_state_get, _mul_nbapi.c_ofp_ha_state_ha_state_set)
    ...
    if _newclass:
        gen_id = _swig_property(_mul_nbapi.c_ofp_ha_state_gen_id_get, _mul_nbapi.c_ofp_ha_state_gen_id_set)
...
class c_ofp_loop_status_mod(_object):
    ...
    if _newclass:
        loop_status = _swig_property(_mul_nbapi.c_ofp_loop_status_mod_loop_status_get, _mul_nbapi.c_ofp_loop_status_mod_loop_status_set)
...
class c_ofp_tr_status_mod(_object):
    ...
    if _newclass:
        tr_status = _swig_property(_mul_nbapi.c_ofp_tr_status_mod_tr_status_get, _mul_nbapi.c_ofp_tr_status_mod_tr_status_set)
...
class c_ofp_fl_mod_info(_object):
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_ofp_fl_mod_info_flow_get, _mul_nbapi.c_ofp_fl_mod_info_flow_set)
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_fl_mod_info_datapath_id_get, _mul_nbapi.c_ofp_fl_mod_info_datapath_id_set)
    ...
    if _newclass:
        out_port = _swig_property(_mul_nbapi.c_ofp_fl_mod_info_out_port_get, _mul_nbapi.c_ofp_fl_mod_info_out_port_set)
    __swig_setmethods__["pad"] = _mul_nbapi.c_ofp_fl_mod_info_pad_set
    __swig_getmethods__["pad"] = _mul_nbapi.c_ofp_fl_mod_info_pad_get
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_fl_mod_info_pad_get, _mul_nbapi.c_ofp_fl_mod_info_pad_set)
...
class c_ofp_s_chain_mod(_object):
    ...
    if _newclass:
        user_info = _swig_property(_mul_nbapi.c_ofp_s_chain_mod_user_info_get, _mul_nbapi.c_ofp_s_chain_mod_user_info_set)
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_s_chain_mod_num_nfvs_get, _mul_nbapi.c_ofp_s_chain_mod_num_nfvs_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_s_chain_mod_nfv_list_get, _mul_nbapi.c_ofp_s_chain_mod_nfv_list_set)
    ...
    if _newclass:
        service = _swig_property(_mul_nbapi.c_ofp_s_chain_mod_service_get, _mul_nbapi.c_ofp_s_chain_mod_service_set)
...
class c_ofp_default_s_chain_mod(_object):
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_default_s_chain_mod_num_nfvs_get, _mul_nbapi.c_ofp_default_s_chain_mod_num_nfvs_set)
    ...
    if _newclass:
        level = _swig_property(_mul_nbapi.c_ofp_default_s_chain_mod_level_get, _mul_nbapi.c_ofp_default_s_chain_mod_level_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_default_s_chain_mod_nfv_list_get, _mul_nbapi.c_ofp_default_s_chain_mod_nfv_list_set)
    ...
    if _newclass:
        service = _swig_property(_mul_nbapi.c_ofp_default_s_chain_mod_service_get, _mul_nbapi.c_ofp_default_s_chain_mod_service_set)
...
class c_ofp_s_chain_nfv_info(_object):
    ...
    if _newclass:
        dpid = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_dpid_get, _mul_nbapi.c_ofp_s_chain_nfv_info_dpid_set)
    ...
    if _newclass:
        nfv = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_nfv_get, _mul_nbapi.c_ofp_s_chain_nfv_info_nfv_set)
    ...
    if _newclass:
        nfv_group = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_nfv_group_get, _mul_nbapi.c_ofp_s_chain_nfv_info_nfv_group_set)
    ...
    if _newclass:
        oif = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_oif_get, _mul_nbapi.c_ofp_s_chain_nfv_info_oif_set)
    ...
    if _newclass:
        iif = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_iif_get, _mul_nbapi.c_ofp_s_chain_nfv_info_iif_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_info_pad_get, _mul_nbapi.c_ofp_s_chain_nfv_info_pad_set)
...
class c_ofp_s_chain_nfv_list(_object):
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_list_num_nfvs_get, _mul_nbapi.c_ofp_s_chain_nfv_list_num_nfvs_set)
    ...
    if _newclass:
        nfv_info = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_list_nfv_info_get, _mul_nbapi.c_ofp_s_chain_nfv_list_nfv_info_set)
...
class c_ofp_s_chain_info(_object):
    ...
    if _newclass:
        user_info = _swig_property(_mul_nbapi.c_ofp_s_chain_info_user_info_get, _mul_nbapi.c_ofp_s_chain_info_user_info_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_s_chain_info_nfv_list_get, _mul_nbapi.c_ofp_s_chain_info_nfv_list_set)
...
class c_ofp_service_info(_object):
    ...
    if _newclass:
        vlan = _swig_property(_mul_nbapi.c_ofp_service_info_vlan_get, _mul_nbapi.c_ofp_service_info_vlan_set)
    ...
    if _newclass:
        service = _swig_property(_mul_nbapi.c_ofp_service_info_service_get, _mul_nbapi.c_ofp_service_info_service_set)
...
class c_ofp_s_chain_show(_object):
    ...
    if _newclass:
        dpid = _swig_property(_mul_nbapi.c_ofp_s_chain_show_dpid_get, _mul_nbapi.c_ofp_s_chain_show_dpid_set)
    ...
    if _newclass:
        nw_src = _swig_property(_mul_nbapi.c_ofp_s_chain_show_nw_src_get, _mul_nbapi.c_ofp_s_chain_show_nw_src_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_s_chain_show_pad_get, _mul_nbapi.c_ofp_s_chain_show_pad_set)
    ...
    if _newclass:
        service = _swig_property(_mul_nbapi.c_ofp_s_chain_show_service_get, _mul_nbapi.c_ofp_s_chain_show_service_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_s_chain_show_nfv_list_get, _mul_nbapi.c_ofp_s_chain_show_nfv_list_set)
...
class c_ofp_service_show(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_ofp_service_show_header_get, _mul_nbapi.c_ofp_service_show_header_set)
    ...
    if _newclass:
        service_list = _swig_property(_mul_nbapi.c_ofp_service_show_service_list_get, _mul_nbapi.c_ofp_service_show_service_list_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_service_show_pad_get, _mul_nbapi.c_ofp_service_show_pad_set)
...
class c_ofp_s_chain_nfv_group_info(_object):
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_group_info_num_nfvs_get, _mul_nbapi.c_ofp_s_chain_nfv_group_info_num_nfvs_set)
    ...
    if _newclass:
        nfv_group = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_group_info_nfv_group_get, _mul_nbapi.c_ofp_s_chain_nfv_group_info_nfv_group_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_s_chain_nfv_group_info_nfv_list_get, _mul_nbapi.c_ofp_s_chain_nfv_group_info_nfv_list_set)
...
class c_ofp_group_show(_object):
    ...
    if _newclass:
        num_groups = _swig_property(_mul_nbapi.c_ofp_group_show_num_groups_get, _mul_nbapi.c_ofp_group_show_num_groups_set)
    ...
    if _newclass:
        group_list = _swig_property(_mul_nbapi.c_ofp_group_show_group_list_get, _mul_nbapi.c_ofp_group_show_group_list_set)
...
class c_ofp_nfv_show(_object):
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_nfv_show_num_nfvs_get, _mul_nbapi.c_ofp_nfv_show_num_nfvs_set)
    ...
    if _newclass:
        nfv_list = _swig_property(_mul_nbapi.c_ofp_nfv_show_nfv_list_get, _mul_nbapi.c_ofp_nfv_show_nfv_list_set)
...
class c_ofp_default_rule(_object):
    ...
    if _newclass:
        nfv_group = _swig_property(_mul_nbapi.c_ofp_default_rule_nfv_group_get, _mul_nbapi.c_ofp_default_rule_nfv_group_set)
...
class c_ofp_default_rule_info(_object):
    ...
    if _newclass:
        num_nfvs = _swig_property(_mul_nbapi.c_ofp_default_rule_info_num_nfvs_get, _mul_nbapi.c_ofp_default_rule_info_num_nfvs_set)
    ...
    if _newclass:
        level = _swig_property(_mul_nbapi.c_ofp_default_rule_info_level_get, _mul_nbapi.c_ofp_default_rule_info_level_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_default_rule_info_pad_get, _mul_nbapi.c_ofp_default_rule_info_pad_set)
    ...
    if _newclass:
        service = _swig_property(_mul_nbapi.c_ofp_default_rule_info_service_get, _mul_nbapi.c_ofp_default_rule_info_service_set)
    ...
    if _newclass:
        group_list = _swig_property(_mul_nbapi.c_ofp_default_rule_info_group_list_get, _mul_nbapi.c_ofp_default_rule_info_group_list_set)
...
class c_ofp_user_flow_info(_object):
    ...
    if _newclass:
        datapath_id = _swig_property(_mul_nbapi.c_ofp_user_flow_info_datapath_id_get, _mul_nbapi.c_ofp_user_flow_info_datapath_id_set)
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_ofp_user_flow_info_flow_get, _mul_nbapi.c_ofp_user_flow_info_flow_set)
...
class c_ofp_default_rule_show(_object):
    ...
    if _newclass:
        num_services = _swig_property(_mul_nbapi.c_ofp_default_rule_show_num_services_get, _mul_nbapi.c_ofp_default_rule_show_num_services_set)
    ...
    if _newclass:
        pad = _swig_property(_mul_nbapi.c_ofp_default_rule_show_pad_get, _mul_nbapi.c_ofp_default_rule_show_pad_set)
    ...
    if _newclass:
        service_list = _swig_property(_mul_nbapi.c_ofp_default_rule_show_service_list_get, _mul_nbapi.c_ofp_default_rule_show_service_list_set)
...
class c_ofp_nfv_stats_show(_object):
    ...
    if _newclass:
        group_name = _swig_property(_mul_nbapi.c_ofp_nfv_stats_show_group_name_get, _mul_nbapi.c_ofp_nfv_stats_show_group_name_set)
    ...
    if _newclass:
        name = _swig_property(_mul_nbapi.c_ofp_nfv_stats_show_name_get, _mul_nbapi.c_ofp_nfv_stats_show_name_set)
...
class c_ofp_service_stats_show(_object):
    ...
    if _newclass:
        service_name = _swig_property(_mul_nbapi.c_ofp_service_stats_show_service_name_get, _mul_nbapi.c_ofp_service_stats_show_service_name_set)
    ...
    if _newclass:
        stats = _swig_property(_mul_nbapi.c_ofp_service_stats_show_stats_get, _mul_nbapi.c_ofp_service_stats_show_stats_set)
...
class c_ofp_user_stats_show(_object):
    ...
    if _newclass:
        stats = _swig_property(_mul_nbapi.c_ofp_user_stats_show_stats_get, _mul_nbapi.c_ofp_user_stats_show_stats_set)
...
class c_conx_user_flow(_object):
    ...
    if _newclass:
        header = _swig_property(_mul_nbapi.c_conx_user_flow_header_get, _mul_nbapi.c_conx_user_flow_header_set)
    ...
    if _newclass:
        dst_dpid = _swig_property(_mul_nbapi.c_conx_user_flow_dst_dpid_get, _mul_nbapi.c_conx_user_flow_dst_dpid_set)
    ...
    if _newclass:
        n_src = _swig_property(_mul_nbapi.c_conx_user_flow_n_src_get, _mul_nbapi.c_conx_user_flow_n_src_set)
    ...
    if _newclass:
        fl_flags = _swig_property(_mul_nbapi.c_conx_user_flow_fl_flags_get, _mul_nbapi.c_conx_user_flow_fl_flags_set)
    ...
    if _newclass:
        flow = _swig_property(_mul_nbapi.c_conx_user_flow_flow_get, _mul_nbapi.c_conx_user_flow_flow_set)
    ...
    if _newclass:
        mask = _swig_property(_mul_nbapi.c_conx_user_flow_mask_get, _mul_nbapi.c_conx_user_flow_mask_set)
    ...
    if _newclass:
        tunnel_key = _swig_property(_mul_nbapi.c_conx_user_flow_tunnel_key_get, _mul_nbapi.c_conx_user_flow_tunnel_key_set)
    ...
    if _newclass:
        tunnel_type = _swig_property(_mul_nbapi.c_conx_user_flow_tunnel_type_get, _mul_nbapi.c_conx_user_flow_tunnel_type_set)
    ...
    if _newclass:
        app_cookie = _swig_property(_mul_nbapi.c_conx_user_flow_app_cookie_get, _mul_nbapi.c_conx_user_flow_app_cookie_set)
    ...
    if _newclass:
        conx_flags = _swig_property(_mul_nbapi.c_conx_user_flow_conx_flags_get, _mul_nbapi.c_conx_user_flow_conx_flags_set)
    ...
    if _newclass:
        src_dpid_list = _swig_property(_mul_nbapi.c_conx_user_flow_src_dpid_list_get, _mul_nbapi.c_conx_user_flow_src_dpid_list_set)
...
class mul_switch(_object):
    ...
    if _newclass:
        alias_id = _swig_property(_mul_nbapi.mul_switch_alias_id_get, _mul_nbapi.mul_switch_alias_id_set)
    ...
    if _newclass:
        port_list = _swig_property(_mul_nbapi.mul_switch_port_list_get, _mul_nbapi.mul_switch_port_list_set)
    ...
    if _newclass:
        n_stale = _swig_property(_mul_nbapi.mul_switch_n_stale_get, _mul_nbapi.mul_switch_n_stale_set)
    __swig_setmethods__["priv"] = _mul_nbapi.mul_switch_priv_set
    __swig_getmethods__["priv"] = _mul_nbapi.mul_switch_priv_get
    if _newclass:
        priv = _swig_property(_mul_nbapi.mul_switch_priv_get, _mul_nbapi.mul_switch_priv_set)
    ...
    if _newclass:
        n_buffers = _swig_property(_mul_nbapi.mul_switch_n_buffers_get, _mul_nbapi.mul_switch_n_buffers_set)
    ...
    if _newclass:
        n_tables = _swig_property(_mul_nbapi.mul_switch_n_tables_get, _mul_nbapi.mul_switch_n_tables_set)
    ...
    if _newclass:
        ofp_ver = _swig_property(_mul_nbapi.mul_switch_ofp_ver_get, _mul_nbapi.mul_switch_ofp_ver_set)
...
class mul_app_client_cb(_object):
    ...
    if _newclass:
        switch_priv_alloc = _swig_property(_mul_nbapi.mul_app_client_cb_switch_priv_alloc_get, _mul_nbapi.mul_app_client_cb_switch_priv_alloc_set)
    ...
    if _newclass:
        switch_priv_free = _swig_property(_mul_nbapi.mul_app_client_cb_switch_priv_free_get, _mul_nbapi.mul_app_client_cb_switch_priv_free_set)
    ...
    if _newclass:
        switch_add_cb = _swig_property(_mul_nbapi.mul_app_client_cb_switch_add_cb_get, _mul_nbapi.mul_app_client_cb_switch_add_cb_set)
    ...
    if _newclass:
        switch_del_cb = _swig_property(_mul_nbapi.mul_app_client_cb_switch_del_cb_get, _mul_nbapi.mul_app_client_cb_switch_del_cb_set)
    ...
    if _newclass:
        switch_priv_port_alloc = _swig_property(_mul_nbapi.mul_app_client_cb_switch_priv_port_alloc_get, _mul_nbapi.mul_app_client_cb_switch_priv_port_alloc_set)
    ...
    if _newclass:
        switch_priv_port_free = _swig_property(_mul_nbapi.mul_app_client_cb_switch_priv_port_free_get, _mul_nbapi.mul_app_client_cb_switch_priv_port_free_set)
    ...
    if _newclass:
        switch_port_add_cb = _swig_property(_mul_nbapi.mul_app_client_cb_switch_port_add_cb_get, _mul_nbapi.mul_app_client_cb_switch_port_add_cb_set)
    ...
    if _newclass:
        switch_port_del_cb = _swig_property(_mul_nbapi.mul_app_client_cb_switch_port_del_cb_get, _mul_nbapi.mul_app_client_cb_switch_port_del_cb_set)
    ...
    if _newclass:
        switch_port_chg = _swig_property(_mul_nbapi.mul_app_client_cb_switch_port_chg_get, _mul_nbapi.mul_app_client_cb_switch_port_chg_set)
    ...
    if _newclass:
        switch_port_link_chg = _swig_property(_mul_nbapi.mul_app_client_cb_switch_port_link_chg_get, _mul_nbapi.mul_app_client_cb_switch_port_link_chg_set)
    ...
    if _newclass:
        switch_port_adm_chg = _swig_property(_mul_nbapi.mul_app_client_cb_switch_port_adm_chg_get, _mul_nbapi.mul_app_client_cb_switch_port_adm_chg_set)
    ...
    if _newclass:
        switch_packet_in = _swig_property(_mul_nbapi.mul_app_client_cb_switch_packet_in_get, _mul_nbapi.mul_app_client_cb_switch_packet_in_set)
    ...
    if _newclass:
        switch_error = _swig_property(_mul_nbapi.mul_app_client_cb_switch_error_get, _mul_nbapi.mul_app_client_cb_switch_error_set)
    ...
    if _newclass:
        switch_fl_mod_err = _swig_property(_mul_nbapi.mul_app_client_cb_switch_fl_mod_err_get, _mul_nbapi.mul_app_client_cb_switch_fl_mod_err_set)
    ...
    if _newclass:
        switch_group_mod_err = _swig_property(_mul_nbapi.mul_app_client_cb_switch_group_mod_err_get, _mul_nbapi.mul_app_client_cb_switch_group_mod_err_set)
    ...
    if _newclass:
        switch_meter_mod_err = _swig_property(_mul_nbapi.mul_app_client_cb_switch_meter_mod_err_get, _mul_nbapi.mul_app_client_cb_switch_meter_mod_err_set)
    ...
    if _newclass:
        core_conn_closed = _swig_property(_mul_nbapi.mul_app_client_cb_core_conn_closed_get, _mul_nbapi.mul_app_client_cb_core_conn_closed_set)
    ...
    if _newclass:
        core_conn_reconn = _swig_property(_mul_nbapi.mul_app_client_cb_core_conn_reconn_get, _mul_nbapi.mul_app_client_cb_core_conn_reconn_set)
    ...
    if _newclass:
        app_ha_state = _swig_property(_mul_nbapi.mul_app_client_cb_app_ha_state_get, _mul_nbapi.mul_app_client_cb_app_ha_state_set)
    ...
    if _newclass:
        process_vendor_msg_cb = _swig_property(_mul_nbapi.mul_app_client_cb_process_vendor_msg_cb_get, _mul_nbapi.mul_app_client_cb_process_vendor_msg_cb_set)
    ...
    if _newclass:
        topo_route_status_cb = _swig_property(_mul_nbapi.mul_app_client_cb_topo_route_status_cb_get, _mul_nbapi.mul_app_client_cb_topo_route_status_cb_set)
...
def mul_app_free_buf(b):
    return _mul_nbapi.mul_app_free_buf(b)
mul_app_free_buf = _mul_nbapi.mul_app_free_buf

def mul_register_app(app, app_name, app_flags, ev_mask, n_dpid, dpid_list, ev_cb):
    return _mul_nbapi.mul_register_app(app, app_name, app_flags, ev_mask, n_dpid, dpid_list, ev_cb)
mul_register_app = _mul_nbapi.mul_register_app

def mul_register_app_cb(app_arg, app_name, app_flags, ev_mask, n_dpid, dpid_list, app_cbs):
    return _mul_nbapi.mul_register_app_cb(app_arg, app_name, app_flags, ev_mask, n_dpid, dpid_list, app_cbs)
mul_register_app_cb = _mul_nbapi.mul_register_app_cb

def mul_unregister_app(app_name):
    return _mul_nbapi.mul_unregister_app(app_name)
mul_unregister_app = _mul_nbapi.mul_unregister_app

def mul_app_command_handler(app_name, b):
    return _mul_nbapi.mul_app_command_handler(app_name, b)
mul_app_command_handler = _mul_nbapi.mul_app_command_handler

def mul_app_send_flow_add(app_name, sw_arg, dpid, fl, mask, buffer_id, actions, action_len, itimeo, htimeo, prio, flags):
    return _mul_nbapi.mul_app_send_flow_add(app_name, sw_arg, dpid, fl, mask, buffer_id, actions, action_len, itimeo, htimeo, prio, flags)
mul_app_send_flow_add = _mul_nbapi.mul_app_send_flow_add

def mul_service_send_flow_add(service, dpid, fl, mask, buffer_id, actions, action_len, itimeo, htimeo, prio, flags):
    return _mul_nbapi.mul_service_send_flow_add(service, dpid, fl, mask, buffer_id, actions, action_len, itimeo, htimeo, prio, flags)
mul_service_send_flow_add = _mul_nbapi.mul_service_send_flow_add

def mul_app_send_flow_del(app_name, sw_arg, dpid, fl, mask, port, prio, flag, group):
    return _mul_nbapi.mul_app_send_flow_del(app_name, sw_arg, dpid, fl, mask, port, prio, flag, group)
mul_app_send_flow_del = _mul_nbapi.mul_app_send_flow_del

def mul_service_send_flow_del(service, dpid, fl, mask, oport, prio, flags, group):
    return _mul_nbapi.mul_service_send_flow_del(service, dpid, fl, mask, oport, prio, flags, group)
mul_service_send_flow_del = _mul_nbapi.mul_service_send_flow_del

def mul_app_group_id_alloc(id):
    return _mul_nbapi.mul_app_group_id_alloc(id)
mul_app_group_id_alloc = _mul_nbapi.mul_app_group_id_alloc

def mul_app_group_id_dealloc(id):
    return _mul_nbapi.mul_app_group_id_dealloc(id)
mul_app_group_id_dealloc = _mul_nbapi.mul_app_group_id_dealloc

def mul_service_send_group_add(service, dpid, g_parms):
    return _mul_nbapi.mul_service_send_group_add(service, dpid, g_parms)
mul_service_send_group_add = _mul_nbapi.mul_service_send_group_add

def mul_service_send_group_del(service, dpid, g_parms):
    return _mul_nbapi.mul_service_send_group_del(service, dpid, g_parms)
mul_service_send_group_del = _mul_nbapi.mul_service_send_group_del

def mul_app_send_pkt_out(sw_arg, dpid, parms):
    return _mul_nbapi.mul_app_send_pkt_out(sw_arg, dpid, parms)
mul_app_send_pkt_out = _mul_nbapi.mul_app_send_pkt_out

def mul_app_create_service(name, service_handler):
    return _mul_nbapi.mul_app_create_service(name, service_handler)
mul_app_create_service = _mul_nbapi.mul_app_create_service

def mul_app_get_service(name, server):
    return _mul_nbapi.mul_app_get_service(name, server)
mul_app_get_service = _mul_nbapi.mul_app_get_service

def mul_app_get_service_notify(name, conn_update, retry_conn, server):
    return _mul_nbapi.mul_app_get_service_notify(name, conn_update, retry_conn, server)
mul_app_get_service_notify = _mul_nbapi.mul_app_get_service_notify

def mul_app_get_service_notify_ka(name, conn_update, keepalive, retry_conn, server):
    return _mul_nbapi.mul_app_get_service_notify_ka(name, conn_update, keepalive, retry_conn, server)
mul_app_get_service_notify_ka = _mul_nbapi.mul_app_get_service_notify_ka

def mul_app_destroy_service(service):
    return _mul_nbapi.mul_app_destroy_service(service)
...
def c_app_switch_get_with_id(dpid):
    return _mul_nbapi.c_app_switch_get_with_id(dpid)
c_app_switch_get_with_id = _mul_nbapi.c_app_switch_get_with_id

def c_app_traverse_all_switches(iter_fn, arg):
    return _mul_nbapi.c_app_traverse_all_switches(iter_fn, arg)
c_app_traverse_all_switches = _mul_nbapi.c_app_traverse_all_switches

def __c_app_traverse_all_switches(iter_fn, arg):
    return _mul_nbapi.__c_app_traverse_all_switches(iter_fn, arg)
__c_app_traverse_all_switches = _mul_nbapi.__c_app_traverse_all_switches

def c_app_switch_get_version_with_id(dpid):
    return _mul_nbapi.c_app_switch_get_version_with_id(dpid)
c_app_switch_get_version_with_id = _mul_nbapi.c_app_switch_get_version_with_id

def c_app_switch_get_dpid_with_alias(alias):
    return _mul_nbapi.c_app_switch_get_dpid_with_alias(alias)
c_app_switch_get_dpid_with_alias = _mul_nbapi.c_app_switch_get_dpid_with_alias

def c_app_switch_put(sw):
    return _mul_nbapi.c_app_switch_put(sw)
c_app_switch_put = _mul_nbapi.c_app_switch_put

def mul_app_act_alloc(mdata):
    return _mul_nbapi.mul_app_act_alloc(mdata)
mul_app_act_alloc = _mul_nbapi.mul_app_act_alloc

def mul_app_act_free(mdata):
    return _mul_nbapi.mul_app_act_free(mdata)
mul_app_act_free = _mul_nbapi.mul_app_act_free

def mul_app_act_len(mdata):
    return _mul_nbapi.mul_app_act_len(mdata)
mul_app_act_len = _mul_nbapi.mul_app_act_len

def mul_app_act_buf_room(mdata):
    return _mul_nbapi.mul_app_act_buf_room(mdata)
mul_app_act_buf_room = _mul_nbapi.mul_app_act_buf_room

def mul_app_act_set_ctors(mdata, dpid):
    return _mul_nbapi.mul_app_act_set_ctors(mdata, dpid)
mul_app_act_set_ctors = _mul_nbapi.mul_app_act_set_ctors

def mul_app_inst_goto(mdata, table):
    return _mul_nbapi.mul_app_inst_goto(mdata, table)
mul_app_inst_goto = _mul_nbapi.mul_app_inst_goto

def mul_app_inst_meter(mdata, meter):
    return _mul_nbapi.mul_app_inst_meter(mdata, meter)
mul_app_inst_meter = _mul_nbapi.mul_app_inst_meter

def mul_app_inst_wr_meta(mdata, metadata, metadata_mask):
    return _mul_nbapi.mul_app_inst_wr_meta(mdata, metadata, metadata_mask)
mul_app_inst_wr_meta = _mul_nbapi.mul_app_inst_wr_meta

def mul_app_set_inst_write(mdata):
    return _mul_nbapi.mul_app_set_inst_write(mdata)
mul_app_set_inst_write = _mul_nbapi.mul_app_set_inst_write

def mul_app_set_inst_apply(mdata):
    return _mul_nbapi.mul_app_set_inst_apply(mdata)
mul_app_set_inst_apply = _mul_nbapi.mul_app_set_inst_apply

def mul_app_action_output(mdata, oport):
    return _mul_nbapi.mul_app_action_output(mdata, oport)
mul_app_action_output = _mul_nbapi.mul_app_action_output

def mul_app_action_set_queue(mdata, queue):
    return _mul_nbapi.mul_app_action_set_queue(mdata, queue)
mul_app_action_set_queue = _mul_nbapi.mul_app_action_set_queue

def mul_app_action_set_vid(mdata, vid):
    return _mul_nbapi.mul_app_action_set_vid(mdata, vid)
mul_app_action_set_vid = _mul_nbapi.mul_app_action_set_vid

def mul_app_action_strip_vlan(mdata):
    return _mul_nbapi.mul_app_action_strip_vlan(mdata)
mul_app_action_strip_vlan = _mul_nbapi.mul_app_action_strip_vlan

def mul_app_action_set_dmac(mdata, dmac):
    return _mul_nbapi.mul_app_action_set_dmac(mdata, dmac)
mul_app_action_set_dmac = _mul_nbapi.mul_app_action_set_dmac

def mul_app_action_set_smac(mdata, smac):
    return _mul_nbapi.mul_app_action_set_smac(mdata, smac)
mul_app_action_set_smac = _mul_nbapi.mul_app_action_set_smac

def mul_app_action_set_eth_type(mdata, eth_type):
    return _mul_nbapi.mul_app_action_set_eth_type(mdata, eth_type)
mul_app_action_set_eth_type = _mul_nbapi.mul_app_action_set_eth_type

def mul_app_action_push_hdr(mdata, eth_type):
    return _mul_nbapi.mul_app_action_push_hdr(mdata, eth_type)
mul_app_action_push_hdr = _mul_nbapi.mul_app_action_push_hdr

def mul_app_action_strip_mpls(mdata, eth_type):
    return _mul_nbapi.mul_app_action_strip_mpls(mdata, eth_type)
mul_app_action_strip_mpls = _mul_nbapi.mul_app_action_strip_mpls

def mul_app_action_set_mpls_ttl(mdata, ttl):
    return _mul_nbapi.mul_app_action_set_mpls_ttl(mdata, ttl)
mul_app_action_set_mpls_ttl = _mul_nbapi.mul_app_action_set_mpls_ttl

def mul_app_action_set_mpls_label(mdata, label):
    return _mul_nbapi.mul_app_action_set_mpls_label(mdata, label)
mul_app_action_set_mpls_label = _mul_nbapi.mul_app_action_set_mpls_label

def mul_app_action_set_mpls_tc(mdata, tc):
    return _mul_nbapi.mul_app_action_set_mpls_tc(mdata, tc)
mul_app_action_set_mpls_tc = _mul_nbapi.mul_app_action_set_mpls_tc

def mul_app_action_set_mpls_bos(mdata, bos):
    return _mul_nbapi.mul_app_action_set_mpls_bos(mdata, bos)
mul_app_action_set_mpls_bos = _mul_nbapi.mul_app_action_set_mpls_bos

def mul_app_action_dec_mpls_ttl(mdata):
    return _mul_nbapi.mul_app_action_dec_mpls_ttl(mdata)
mul_app_action_dec_mpls_ttl = _mul_nbapi.mul_app_action_dec_mpls_ttl

def mul_app_action_set_nw_ttl(mdata, ttl):
    return _mul_nbapi.mul_app_action_set_nw_ttl(mdata, ttl)
mul_app_action_set_nw_ttl = _mul_nbapi.mul_app_action_set_nw_ttl

def mul_app_action_dec_nw_ttl(mdata):
    return _mul_nbapi.mul_app_action_dec_nw_ttl(mdata)
mul_app_action_dec_nw_ttl = _mul_nbapi.mul_app_action_dec_nw_ttl

def mul_app_action_cp_ttl(mdata, arg2):
    return _mul_nbapi.mul_app_action_cp_ttl(mdata, arg2)
mul_app_action_cp_ttl = _mul_nbapi.mul_app_action_cp_ttl

def mul_app_action_strip_pbb(mdata):
    return _mul_nbapi.mul_app_action_strip_pbb(mdata)
mul_app_action_strip_pbb = _mul_nbapi.mul_app_action_strip_pbb

def mul_app_action_set_vlan_pcp(mdata, vlan_pcp):
    return _mul_nbapi.mul_app_action_set_vlan_pcp(mdata, vlan_pcp)
mul_app_action_set_vlan_pcp = _mul_nbapi.mul_app_action_set_vlan_pcp

def mul_app_action_set_nw_saddr(mdata, nw_saddr):
    return _mul_nbapi.mul_app_action_set_nw_saddr(mdata, nw_saddr)
mul_app_action_set_nw_saddr = _mul_nbapi.mul_app_action_set_nw_saddr

def mul_app_action_set_nw_daddr(mdata, nw_daddr):
    return _mul_nbapi.mul_app_action_set_nw_daddr(mdata, nw_daddr)
mul_app_action_set_nw_daddr = _mul_nbapi.mul_app_action_set_nw_daddr

def mul_app_action_set_nw_saddr6(mdata, nw_saddr):
    return _mul_nbapi.mul_app_action_set_nw_saddr6(mdata, nw_saddr)
mul_app_action_set_nw_saddr6 = _mul_nbapi.mul_app_action_set_nw_saddr6

def mul_app_action_set_nw_daddr6(mdata, nw_daddr):
    return _mul_nbapi.mul_app_action_set_nw_daddr6(mdata, nw_daddr)
mul_app_action_set_nw_daddr6 = _mul_nbapi.mul_app_action_set_nw_daddr6

def mul_app_action_set_nw_tos(mdata, tos):
    return _mul_nbapi.mul_app_action_set_nw_tos(mdata, tos)
mul_app_action_set_nw_tos = _mul_nbapi.mul_app_action_set_nw_tos

def mul_app_action_set_tp_udp_sport(mdata, port):
    return _mul_nbapi.mul_app_action_set_tp_udp_sport(mdata, port)
mul_app_action_set_tp_udp_sport = _mul_nbapi.mul_app_action_set_tp_udp_sport

def mul_app_action_set_tp_udp_dport(mdata, port):
    return _mul_nbapi.mul_app_action_set_tp_udp_dport(mdata, port)
mul_app_action_set_tp_udp_dport = _mul_nbapi.mul_app_action_set_tp_udp_dport

def mul_app_action_set_tp_tcp_sport(mdata, port):
    return _mul_nbapi.mul_app_action_set_tp_tcp_sport(mdata, port)
mul_app_action_set_tp_tcp_sport = _mul_nbapi.mul_app_action_set_tp_tcp_sport

def mul_app_action_set_tp_tcp_dport(mdata, port):
    return _mul_nbapi.mul_app_action_set_tp_tcp_dport(mdata, port)
mul_app_action_set_tp_tcp_dport = _mul_nbapi.mul_app_action_set_tp_tcp_dport

def mul_app_action_set_group(mdata, group):
    return _mul_nbapi.mul_app_action_set_group(mdata, group)
mul_app_action_set_group = _mul_nbapi.mul_app_action_set_group

def mul_app_action_set_tunnel_id(mdata, tunnel):
    return _mul_nbapi.mul_app_action_set_tunnel_id(mdata, tunnel)
mul_app_action_set_tunnel_id = _mul_nbapi.mul_app_action_set_tunnel_id

def mul_app_set_band_drop(mdata, parms):
    return _mul_nbapi.mul_app_set_band_drop(mdata, parms)
mul_app_set_band_drop = _mul_nbapi.mul_app_set_band_drop

def mul_app_set_band_dscp(mdata, parms):
    return _mul_nbapi.mul_app_set_band_dscp(mdata, parms)
mul_app_set_band_dscp = _mul_nbapi.mul_app_set_band_dscp

def mul_service_send_meter_add(service, dpid, m_parms):
    return _mul_nbapi.mul_service_send_meter_add(service, dpid, m_parms)
mul_service_send_meter_add = _mul_nbapi.mul_service_send_meter_add

def mul_service_send_meter_del(service, dpid, m_parms):
    return _mul_nbapi.mul_service_send_meter_del(service, dpid, m_parms)
mul_service_send_meter_del = _mul_nbapi.mul_service_send_meter_del

def mul_service_send_port_mod(service, dpid, pm_parms):
    return _mul_nbapi.mul_service_send_port_mod(service, dpid, pm_parms)
mul_service_send_port_mod = _mul_nbapi.mul_service_send_port_mod

def mul_app_send_port_mod(dpid, pm_parms):
    return _mul_nbapi.mul_app_send_port_mod(dpid, pm_parms)
mul_app_send_port_mod = _mul_nbapi.mul_app_send_port_mod

def mul_service_send_async_config(service, dpid, ac_parms):
    return _mul_nbapi.mul_service_send_async_config(service, dpid, ac_parms)
mul_service_send_async_config = _mul_nbapi.mul_service_send_async_config

def mul_app_send_loop_status(status):
    return _mul_nbapi.mul_app_send_loop_status(status)
mul_app_send_loop_status = _mul_nbapi.mul_app_send_loop_status

def mul_send_vendor_msg(dpid, vendor_id, arg, arg_len):
    return _mul_nbapi.mul_send_vendor_msg(dpid, vendor_id, arg, arg_len)
...
def mul_app_send_tr_status(status):
    return _mul_nbapi.mul_app_send_tr_status(status)
...
class lweight_pair_(_object):
    ...
    if _newclass:
        la = _swig_property(_mul_nbapi.lweight_pair__la_get, _mul_nbapi.lweight_pair__la_set)
    __swig_setmethods__["lb"] = _mul_nbapi.lweight_pair__lb_set
    __swig_getmethods__["lb"] = _mul_nbapi.lweight_pair__lb_get
    if _newclass:
        lb = _swig_property(_mul_nbapi.lweight_pair__lb_get, _mul_nbapi.lweight_pair__lb_set)
    ...
    if _newclass:
        weight = _swig_property(_mul_nbapi.lweight_pair__weight_get, _mul_nbapi.lweight_pair__weight_set)
    __swig_setmethods__["flags"] = _mul_nbapi.lweight_pair__flags_set
    __swig_getmethods__["flags"] = _mul_nbapi.lweight_pair__flags_get
    if _newclass:
        flags = _swig_property(_mul_nbapi.lweight_pair__flags_get, _mul_nbapi.lweight_pair__flags_set)
...
class rt_adj_elem_(_object):
    ...
    if _newclass:
        dpid_a = _swig_property(_mul_nbapi.rt_adj_elem__dpid_a_get, _mul_nbapi.rt_adj_elem__dpid_a_set)
    ...
    if _newclass:
        dpid_b = _swig_property(_mul_nbapi.rt_adj_elem__dpid_b_get, _mul_nbapi.rt_adj_elem__dpid_b_set)
    __swig_setmethods__["pairs"] = _mul_nbapi.rt_adj_elem__pairs_set
    __swig_getmethods__["pairs"] = _mul_nbapi.rt_adj_elem__pairs_get
    if _newclass:
        pairs = _swig_property(_mul_nbapi.rt_adj_elem__pairs_get, _mul_nbapi.rt_adj_elem__pairs_set)
    ...
    if _newclass:
        adj_pairs = _swig_property(_mul_nbapi.rt_adj_elem__adj_pairs_get, _mul_nbapi.rt_adj_elem__adj_pairs_set)
...
class rt_path_elem_(_object):
    ...
    if _newclass:
        sw_dpid = _swig_property(_mul_nbapi.rt_path_elem__sw_dpid_get, _mul_nbapi.rt_path_elem__sw_dpid_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.rt_path_elem__sw_alias_get, _mul_nbapi.rt_path_elem__sw_alias_set)
    __swig_setmethods__["flags"] = _mul_nbapi.rt_path_elem__flags_set
    __swig_getmethods__["flags"] = _mul_nbapi.rt_path_elem__flags_get
    if _newclass:
        flags = _swig_property(_mul_nbapi.rt_path_elem__flags_get, _mul_nbapi.rt_path_elem__flags_set)
    ...
    if _newclass:
        in_port = _swig_property(_mul_nbapi.rt_path_elem__in_port_get, _mul_nbapi.rt_path_elem__in_port_set)
    __swig_setmethods__["link"] = _mul_nbapi.rt_path_elem__link_set
    __swig_getmethods__["link"] = _mul_nbapi.rt_path_elem__link_get
    if _newclass:
        link = _swig_property(_mul_nbapi.rt_path_elem__link_get, _mul_nbapi.rt_path_elem__link_set)
...
class rt_transit_elem_(_object):
    ...
    if _newclass:
        n_paths = _swig_property(_mul_nbapi.rt_transit_elem__n_paths_get, _mul_nbapi.rt_transit_elem__n_paths_set)
    ...
    if _newclass:
        sw_alias = _swig_property(_mul_nbapi.rt_transit_elem__sw_alias_get, _mul_nbapi.rt_transit_elem__sw_alias_set)
...
class rt_list(_object):
    ...
    if _newclass:
        skip = _swig_property(_mul_nbapi.rt_list_skip_get, _mul_nbapi.rt_list_skip_set)
    __swig_setmethods__["route"] = _mul_nbapi.rt_list_route_set
    __swig_getmethods__["route"] = _mul_nbapi.rt_list_route_get
    if _newclass:
        route = _swig_property(_mul_nbapi.rt_list_route_get, _mul_nbapi.rt_list_route_set)
    __swig_setmethods__["next"] = _mul_nbapi.rt_list_next_set
    __swig_getmethods__["next"] = _mul_nbapi.rt_list_next_get
    if _newclass:
        next = _swig_property(_mul_nbapi.rt_list_next_get, _mul_nbapi.rt_list_next_set)
...
def mul_route_path_traverse(iroute, iter_fn, arg):
    return _mul_nbapi.mul_route_path_traverse(iroute, iter_fn, arg)
mul_route_path_traverse = _mul_nbapi.mul_route_path_traverse

def mul_destroy_route(route):
    return _mul_nbapi.mul_destroy_route(route)
mul_destroy_route = _mul_nbapi.mul_destroy_route

def mul_route_list_free(path_head, free_route):
    return _mul_nbapi.mul_route_list_free(path_head, free_route)
mul_route_list_free = _mul_nbapi.mul_route_list_free

def mul_route_get_nodes(rt_service):
    return _mul_nbapi.mul_route_get_nodes(rt_service)
mul_route_get_nodes = _mul_nbapi.mul_route_get_nodes

def mul_route_get(rt_service, src_sw, dest_sw):
    return _mul_nbapi.mul_route_get(rt_service, src_sw, dest_sw)
mul_route_get = _mul_nbapi.mul_route_get

def mul_route_get_mp(rt_service, src_sw, dest_sw, u_arg, mp_select):
    return _mul_nbapi.mul_route_get_mp(rt_service, src_sw, dest_sw, u_arg, mp_select)
mul_route_get_mp = _mul_nbapi.mul_route_get_mp

def mul_route_get_all(rt_service, src_sw, dest_sw):
    return _mul_nbapi.mul_route_get_all(rt_service, src_sw, dest_sw)
mul_route_get_all = _mul_nbapi.mul_route_get_all

def mul_route_init_block_meta(rt_info, blk):
    return _mul_nbapi.mul_route_init_block_meta(rt_info, blk)
...
def mul_route_service_destroy(rt_service):
    return _mul_nbapi.mul_route_service_destroy(rt_service)
...
class nbapi_switch_brief_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_switch_brief_list_t_array_get, _mul_nbapi.nbapi_switch_brief_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_switch_brief_list_t_length_get, _mul_nbapi.nbapi_switch_brief_list_t_length_set)
...
class nbapi_port_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_port_list_t_array_get, _mul_nbapi.nbapi_port_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_port_list_t_length_get, _mul_nbapi.nbapi_port_list_t_length_set)
...
class nbapi_swport_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_swport_list_t_array_get, _mul_nbapi.nbapi_swport_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_swport_list_t_length_get, _mul_nbapi.nbapi_swport_list_t_length_set)
...
class nbapi_bucket_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_bucket_list_t_array_get, _mul_nbapi.nbapi_bucket_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_bucket_list_t_length_get, _mul_nbapi.nbapi_bucket_list_t_length_set)
...
class nbapi_action_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_action_list_t_array_get, _mul_nbapi.nbapi_action_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_action_list_t_length_get, _mul_nbapi.nbapi_action_list_t_length_set)
...
class ofp_phy_port_array(_object):
    ...
    def __init__(self, nelements):
        this = _mul_nbapi.new_ofp_phy_port_array(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _mul_nbapi.ofp_phy_port_array___getitem__(self, index)

    def __setitem__(self, index, value):
        return _mul_nbapi.ofp_phy_port_array___setitem__(self, index, value)

    def cast(self):
        return _mul_nbapi.ofp_phy_port_array_cast(self)
    if _newclass:
        frompointer = staticmethod(_mul_nbapi.ofp_phy_port_array_frompointer)
    else:
        frompointer = _mul_nbapi.ofp_phy_port_array_frompointer
...
def ofp_phy_port_array_frompointer(t):
    return _mul_nbapi.ofp_phy_port_array_frompointer(t)
...
class c_sw_port_array(_object):
    ...
    def __init__(self, nelements):
        this = _mul_nbapi.new_c_sw_port_array(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _mul_nbapi.c_sw_port_array___getitem__(self, index)

    def __setitem__(self, index, value):
        return _mul_nbapi.c_sw_port_array___setitem__(self, index, value)

    def cast(self):
        return _mul_nbapi.c_sw_port_array_cast(self)
    if _newclass:
        frompointer = staticmethod(_mul_nbapi.c_sw_port_array_frompointer)
    else:
        frompointer = _mul_nbapi.c_sw_port_array_frompointer
c_sw_port_array_swigregister = _mul_nbapi.c_sw_port_array_swigregister
c_sw_port_array_swigregister(c_sw_port_array)

def c_sw_port_array_frompointer(t):
    return _mul_nbapi.c_sw_port_array_frompointer(t)
...
class c_ofp_bkt_array(_object):
    ...
    def __init__(self, nelements):
        this = _mul_nbapi.new_c_ofp_bkt_array(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _mul_nbapi.c_ofp_bkt_array___getitem__(self, index)

    def __setitem__(self, index, value):
        return _mul_nbapi.c_ofp_bkt_array___setitem__(self, index, value)

    def cast(self):
        return _mul_nbapi.c_ofp_bkt_array_cast(self)
    if _newclass:
        frompointer = staticmethod(_mul_nbapi.c_ofp_bkt_array_frompointer)
    else:
        frompointer = _mul_nbapi.c_ofp_bkt_array_frompointer
c_ofp_bkt_array_swigregister = _mul_nbapi.c_ofp_bkt_array_swigregister
c_ofp_bkt_array_swigregister(c_ofp_bkt_array)

def c_ofp_bkt_array_frompointer(t):
    return _mul_nbapi.c_ofp_bkt_array_frompointer(t)
...
class ofp_action_header_array(_object):
    ...
    def __init__(self, nelements):
        this = _mul_nbapi.new_ofp_action_header_array(nelements)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _mul_nbapi.ofp_action_header_array___getitem__(self, index)

    def __setitem__(self, index, value):
        return _mul_nbapi.ofp_action_header_array___setitem__(self, index, value)

    def cast(self):
        return _mul_nbapi.ofp_action_header_array_cast(self)
    if _newclass:
        frompointer = staticmethod(_mul_nbapi.ofp_action_header_array_frompointer)
    else:
        frompointer = _mul_nbapi.ofp_action_header_array_frompointer
...
def ofp_action_header_array_frompointer(t):
    return _mul_nbapi.ofp_action_header_array_frompointer(t)
ofp_action_header_array_frompointer = _mul_nbapi.ofp_action_header_array_frompointer


def get_bit_in_32mask(mask, bit):
    return _mul_nbapi.get_bit_in_32mask(mask, bit)
...
class mband_nbapi_input(_object):
    ...
    if _newclass:
        rate = _swig_property(_mul_nbapi.mband_nbapi_input_rate_get, _mul_nbapi.mband_nbapi_input_rate_set)
    ...
    if _newclass:
        burst_size = _swig_property(_mul_nbapi.mband_nbapi_input_burst_size_get, _mul_nbapi.mband_nbapi_input_burst_size_set)
    ...
    if _newclass:
        prec_level = _swig_property(_mul_nbapi.mband_nbapi_input_prec_level_get, _mul_nbapi.mband_nbapi_input_prec_level_set)
...
def get_switch_general(datapath_id):
    return _mul_nbapi.get_switch_general(datapath_id)
get_switch_general = _mul_nbapi.get_switch_general

def parse_alias_id(alias_id):
    return _mul_nbapi.parse_alias_id(alias_id)
parse_alias_id = _mul_nbapi.parse_alias_id

def get_switch_alias_from_switch_info(switch_info):
    return _mul_nbapi.get_switch_alias_from_switch_info(switch_info)
get_switch_alias_from_switch_info = _mul_nbapi.get_switch_alias_from_switch_info

def get_switch(datapath_id):
    return _mul_nbapi.get_switch(datapath_id)
get_switch = _mul_nbapi.get_switch

def get_switch_meter(dpid):
    return _mul_nbapi.get_switch_meter(dpid)
get_switch_meter = _mul_nbapi.get_switch_meter

def get_switch_table(dpid, table):
    return _mul_nbapi.get_switch_table(dpid, table)
get_switch_table = _mul_nbapi.get_switch_table

def get_switch_group(dpid):
    return _mul_nbapi.get_switch_group(dpid)
get_switch_group = _mul_nbapi.get_switch_group

def get_group_act_type(actions, type):
    return _mul_nbapi.get_group_act_type(actions, type)
get_group_act_type = _mul_nbapi.get_group_act_type

def get_max_group(max_groups, type):
    return _mul_nbapi.get_max_group(max_groups, type)
...
def get_switch_port(datapath_id, port_no):
    return _mul_nbapi.get_switch_port(datapath_id, port_no)
get_switch_port = _mul_nbapi.get_switch_port

def get_switch_port_all(datapath_id):
    return _mul_nbapi.get_switch_port_all(datapath_id)
get_switch_port_all = _mul_nbapi.get_switch_port_all

def nbapi_ntoh_actions(actions, act_len):
    return _mul_nbapi.nbapi_ntoh_actions(actions, act_len)
nbapi_ntoh_actions = _mul_nbapi.nbapi_ntoh_actions

def get_switch_group_table(datapath_id, group_id):
    return _mul_nbapi.get_switch_group_table(datapath_id, group_id)
...
class nbapi_switch_flow_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_switch_flow_list_t_array_get, _mul_nbapi.nbapi_switch_flow_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_switch_flow_list_t_length_get, _mul_nbapi.nbapi_switch_flow_list_t_length_set)
...
class nbapi_switch_group_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_switch_group_list_t_array_get, _mul_nbapi.nbapi_switch_group_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_switch_group_list_t_length_get, _mul_nbapi.nbapi_switch_group_list_t_length_set)
...
def regist_nbapi_cb(port):
    return _mul_nbapi.regist_nbapi_cb(port)
regist_nbapi_cb = _mul_nbapi.regist_nbapi_cb

def add_static_flow(datapath_id, priority, barrier, stat, mdata, drop, dl_src, dl_dst, dl_type, dl_vlan, dl_vlan_pcp, mpls_label, mpls_tc, mpls_bos, nw_src, nw_src6, nw_dst, nw_dst6, nw_proto, nw_tos, tp_dst, tp_src, in_port, table_id):
    return _mul_nbapi.add_static_flow(datapath_id, priority, barrier, stat, mdata, drop, dl_src, dl_dst, dl_type, dl_vlan, dl_vlan_pcp, mpls_label, mpls_tc, mpls_bos, nw_src, nw_src6, nw_dst, nw_dst6, nw_proto, nw_tos, tp_dst, tp_src, in_port, table_id)
add_static_flow = _mul_nbapi.add_static_flow

def prepare_add_group(group, type):
    return _mul_nbapi.prepare_add_group(group, type)
prepare_add_group = _mul_nbapi.prepare_add_group

def nbapi_group_action_add(act_len, g_parms, mdata, weight, ff_port, ff_group):
    return _mul_nbapi.nbapi_group_action_add(act_len, g_parms, mdata, weight, ff_port, ff_group)
nbapi_group_action_add = _mul_nbapi.nbapi_group_action_add

def nbapi_group_add(act_len, datapath_id, g_parms):
    return _mul_nbapi.nbapi_group_add(act_len, datapath_id, g_parms)
nbapi_group_add = _mul_nbapi.nbapi_group_add

def nbapi_group_free(act_len, g_parms):
    return _mul_nbapi.nbapi_group_free(act_len, g_parms)
nbapi_group_free = _mul_nbapi.nbapi_group_free

def compare_flows(fl1, fl2):
    return _mul_nbapi.compare_flows(fl1, fl2)
compare_flows = _mul_nbapi.compare_flows

def nbapi_group_mdata_alloc(dpid):
    return _mul_nbapi.nbapi_group_mdata_alloc(dpid)
nbapi_group_mdata_alloc = _mul_nbapi.nbapi_group_mdata_alloc

def delete_static_flow(datapath_id, fl, mask, priority):
    return _mul_nbapi.delete_static_flow(datapath_id, fl, mask, priority)
delete_static_flow = _mul_nbapi.delete_static_flow

def nbapi_parse_mac_to_str(mac):
    return _mul_nbapi.nbapi_parse_mac_to_str(mac)
nbapi_parse_mac_to_str = _mul_nbapi.nbapi_parse_mac_to_str

def nbapi_fab_parse_nw_addr_to_str(flow):
    return _mul_nbapi.nbapi_fab_parse_nw_addr_to_str(flow)
nbapi_fab_parse_nw_addr_to_str = _mul_nbapi.nbapi_fab_parse_nw_addr_to_str

def nbapi_parse_ipv6_nw_addr_to_str(flow, mask, s):
    return _mul_nbapi.nbapi_parse_ipv6_nw_addr_to_str(flow, mask, s)
nbapi_parse_ipv6_nw_addr_to_str = _mul_nbapi.nbapi_parse_ipv6_nw_addr_to_str

def nbapi_parse_nw_addr_to_str(flow, mask, s):
    return _mul_nbapi.nbapi_parse_nw_addr_to_str(flow, mask, s)
nbapi_parse_nw_addr_to_str = _mul_nbapi.nbapi_parse_nw_addr_to_str

def nbapi_get_switch_version_with_id(dpid):
    return _mul_nbapi.nbapi_get_switch_version_with_id(dpid)
nbapi_get_switch_version_with_id = _mul_nbapi.nbapi_get_switch_version_with_id

def nbapi_make_flow(smac, dmac, eth_type, vid, vlan_pcp, mpls_label, mpls_tc, mpls_bos, dip, sip, proto, tos, dport, sport, inport, table):
    return _mul_nbapi.nbapi_make_flow(smac, dmac, eth_type, vid, vlan_pcp, mpls_label, mpls_tc, mpls_bos, dip, sip, proto, tos, dport, sport, inport, table)
nbapi_make_flow = _mul_nbapi.nbapi_make_flow

def nbapi_make_mask(smac, dmac, eth_type, vid, vlan_pcp, mpls_label, mpls_tc, mpls_bos, dip, sip, proto, tos, dport, sport, inport):
    return _mul_nbapi.nbapi_make_mask(smac, dmac, eth_type, vid, vlan_pcp, mpls_label, mpls_tc, mpls_bos, dip, sip, proto, tos, dport, sport, inport)
nbapi_make_mask = _mul_nbapi.nbapi_make_mask

def nbapi_mdata_alloc(dpid):
    return _mul_nbapi.nbapi_mdata_alloc(dpid)
nbapi_mdata_alloc = _mul_nbapi.nbapi_mdata_alloc

def nbapi_mdata_inst_write(mdata):
    return _mul_nbapi.nbapi_mdata_inst_write(mdata)
nbapi_mdata_inst_write = _mul_nbapi.nbapi_mdata_inst_write

def nbapi_mdata_inst_apply(mdata):
    return _mul_nbapi.nbapi_mdata_inst_apply(mdata)
nbapi_mdata_inst_apply = _mul_nbapi.nbapi_mdata_inst_apply

def nbapi_mdata_inst_meter(mdata, meter):
    return _mul_nbapi.nbapi_mdata_inst_meter(mdata, meter)
nbapi_mdata_inst_meter = _mul_nbapi.nbapi_mdata_inst_meter

def nbapi_mdata_inst_goto(mdata, table):
    return _mul_nbapi.nbapi_mdata_inst_goto(mdata, table)
nbapi_mdata_inst_goto = _mul_nbapi.nbapi_mdata_inst_goto

def nbapi_action_to_mdata(mdata, action_type, action_value):
    return _mul_nbapi.nbapi_action_to_mdata(mdata, action_type, action_value)
nbapi_action_to_mdata = _mul_nbapi.nbapi_action_to_mdata

def nbapi_mdata_free(mdata):
    return _mul_nbapi.nbapi_mdata_free(mdata)
nbapi_mdata_free = _mul_nbapi.nbapi_mdata_free

def nbapi_flow_free(flow):
    return _mul_nbapi.nbapi_flow_free(flow)
nbapi_flow_free = _mul_nbapi.nbapi_flow_free

def nbapi_fabric_make_flow(nw_src, dl_src, in_port):
    return _mul_nbapi.nbapi_fabric_make_flow(nw_src, dl_src, in_port)
nbapi_fabric_make_flow = _mul_nbapi.nbapi_fabric_make_flow

def nbapi_make_action_output(oport):
    return _mul_nbapi.nbapi_make_action_output(oport)
nbapi_make_action_output = _mul_nbapi.nbapi_make_action_output

def nbapi_make_action_set_vid(vid):
    return _mul_nbapi.nbapi_make_action_set_vid(vid)
...
def nbapi_make_action_set_dmac(dmac_str):
    return _mul_nbapi.nbapi_make_action_set_dmac(dmac_str)
nbapi_make_action_set_dmac = _mul_nbapi.nbapi_make_action_set_dmac

def nbapi_make_action_set_smac(smac_str):
    return _mul_nbapi.nbapi_make_action_set_smac(smac_str)
nbapi_make_action_set_smac = _mul_nbapi.nbapi_make_action_set_smac

def nbapi_make_action_set_nw_saddr(nw_saddr_str):
    return _mul_nbapi.nbapi_make_action_set_nw_saddr(nw_saddr_str)
nbapi_make_action_set_nw_saddr = _mul_nbapi.nbapi_make_action_set_nw_saddr

def nbapi_make_action_set_nw_daddr(nw_daddr_str):
    return _mul_nbapi.nbapi_make_action_set_nw_daddr(nw_daddr_str)
nbapi_make_action_set_nw_daddr = _mul_nbapi.nbapi_make_action_set_nw_daddr

def nbapi_make_action_set_vlan_pcp(vlan_pcp):
    return _mul_nbapi.nbapi_make_action_set_vlan_pcp(vlan_pcp)
nbapi_make_action_set_vlan_pcp = _mul_nbapi.nbapi_make_action_set_vlan_pcp

def nbapi_make_action_set_nw_tos(tos):
    return _mul_nbapi.nbapi_make_action_set_nw_tos(tos)
nbapi_make_action_set_nw_tos = _mul_nbapi.nbapi_make_action_set_nw_tos

def nbapi_make_action_set_tp_dport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_dport(port)
nbapi_make_action_set_tp_dport = _mul_nbapi.nbapi_make_action_set_tp_dport

def nbapi_make_action_set_tp_sport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_sport(port)
nbapi_make_action_set_tp_sport = _mul_nbapi.nbapi_make_action_set_tp_sport

def nbapi_make_action_group(gid):
    return _mul_nbapi.nbapi_make_action_group(gid)
nbapi_make_action_group = _mul_nbapi.nbapi_make_action_group

def nbapi_make_action_push(eth_type):
    return _mul_nbapi.nbapi_make_action_push(eth_type)
nbapi_make_action_push = _mul_nbapi.nbapi_make_action_push

def nbapi_make_action_strip_mpls(eth_type):
    return _mul_nbapi.nbapi_make_action_strip_mpls(eth_type)
...
def nbapi_make_action_set_mpls_ttl(ttl):
    return _mul_nbapi.nbapi_make_action_set_mpls_ttl(ttl)
...
def nbapi_make_action_set_ip_ttl(ttl):
    return _mul_nbapi.nbapi_make_action_set_ip_ttl(ttl)
...
def nbapi_make_action_cp_ttl(arg1):
    return _mul_nbapi.nbapi_make_action_cp_ttl(arg1)
nbapi_make_action_cp_ttl = _mul_nbapi.nbapi_make_action_cp_ttl

def nbapi_make_action_set_eth_type(eth_type):
    return _mul_nbapi.nbapi_make_action_set_eth_type(eth_type)
nbapi_make_action_set_eth_type = _mul_nbapi.nbapi_make_action_set_eth_type

def nbapi_make_action_set_mpls_label(label):
    return _mul_nbapi.nbapi_make_action_set_mpls_label(label)
nbapi_make_action_set_mpls_label = _mul_nbapi.nbapi_make_action_set_mpls_label

def nbapi_make_action_set_mpls_tc(tc):
    return _mul_nbapi.nbapi_make_action_set_mpls_tc(tc)
nbapi_make_action_set_mpls_tc = _mul_nbapi.nbapi_make_action_set_mpls_tc

def nbapi_make_action_set_mpls_bos(bos):
    return _mul_nbapi.nbapi_make_action_set_mpls_bos(bos)
nbapi_make_action_set_mpls_bos = _mul_nbapi.nbapi_make_action_set_mpls_bos

def nbapi_make_action_set_tp_port(ip_proto, is_src, port):
    return _mul_nbapi.nbapi_make_action_set_tp_port(ip_proto, is_src, port)
nbapi_make_action_set_tp_port = _mul_nbapi.nbapi_make_action_set_tp_port

def nbapi_make_action_set_tp_udp_sport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_udp_sport(port)
nbapi_make_action_set_tp_udp_sport = _mul_nbapi.nbapi_make_action_set_tp_udp_sport

def nbapi_make_action_set_tp_udp_dport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_udp_dport(port)
nbapi_make_action_set_tp_udp_dport = _mul_nbapi.nbapi_make_action_set_tp_udp_dport

def nbapi_make_action_set_tp_tcp_sport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_tcp_sport(port)
nbapi_make_action_set_tp_tcp_sport = _mul_nbapi.nbapi_make_action_set_tp_tcp_sport

def nbapi_make_action_set_tp_tcp_dport(port):
    return _mul_nbapi.nbapi_make_action_set_tp_tcp_dport(port)
nbapi_make_action_set_tp_tcp_dport = _mul_nbapi.nbapi_make_action_set_tp_tcp_dport

def nbapi_make_action_set_queue(queue):
    return _mul_nbapi.nbapi_make_action_set_queue(queue)
nbapi_make_action_set_queue = _mul_nbapi.nbapi_make_action_set_queue

def get_flow(datapath_id):
    return _mul_nbapi.get_flow(datapath_id)
get_flow = _mul_nbapi.get_flow

def get_single_flow(datapath_id, flow, mask, prio):
    return _mul_nbapi.get_single_flow(datapath_id, flow, mask, prio)
get_single_flow = _mul_nbapi.get_single_flow

def get_flow_number(dpid):
    return _mul_nbapi.get_flow_number(dpid)
get_flow_number = _mul_nbapi.get_flow_number

def get_group(datapath_id):
    return _mul_nbapi.get_group(datapath_id)
get_group = _mul_nbapi.get_group

def get_group_number(dpid):
    return _mul_nbapi.get_group_number(dpid)
get_group_number = _mul_nbapi.get_group_number

def nbapi_dump_single_group_bkt(cofp_gm):
    return _mul_nbapi.nbapi_dump_single_group_bkt(cofp_gm)
nbapi_dump_single_group_bkt = _mul_nbapi.nbapi_dump_single_group_bkt

def nbapi_dump_single_flow_action(cofp_fi):
    return _mul_nbapi.nbapi_dump_single_flow_action(cofp_fi)
nbapi_dump_single_flow_action = _mul_nbapi.nbapi_dump_single_flow_action

def nbapi_of10_dump_actions(actions, actions_len):
    return _mul_nbapi.nbapi_of10_dump_actions(actions, actions_len)
nbapi_of10_dump_actions = _mul_nbapi.nbapi_of10_dump_actions

def nbapi_of131_dump_actions(inst_list, inst_len, acts_only):
    return _mul_nbapi.nbapi_of131_dump_actions(inst_list, inst_len, acts_only)
...
class nbapi_switch_meter_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_switch_meter_list_t_array_get, _mul_nbapi.nbapi_switch_meter_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_switch_meter_list_t_length_get, _mul_nbapi.nbapi_switch_meter_list_t_length_set)
...
def prepare_add_meter(meter_id, type, burst, stat):
    return _mul_nbapi.prepare_add_meter(meter_id, type, burst, stat)
prepare_add_meter = _mul_nbapi.prepare_add_meter

def nbapi_meter_band_add(datapath_id, act_len, m_parms, band_type, rate, burst_size, prec_level):
    return _mul_nbapi.nbapi_meter_band_add(datapath_id, act_len, m_parms, band_type, rate, burst_size, prec_level)
nbapi_meter_band_add = _mul_nbapi.nbapi_meter_band_add

def nbapi_meter_add(act_len, datapath_id, m_parms):
    return _mul_nbapi.nbapi_meter_add(act_len, datapath_id, m_parms)
nbapi_meter_add = _mul_nbapi.nbapi_meter_add

def nbapi_meter_free(act_len, m_parms):
    return _mul_nbapi.nbapi_meter_free(act_len, m_parms)
nbapi_meter_free = _mul_nbapi.nbapi_meter_free

def nbapi_delete_meter(dpid, meter):
    return _mul_nbapi.nbapi_delete_meter(dpid, meter)
nbapi_delete_meter = _mul_nbapi.nbapi_delete_meter

def get_meter(datapath_id):
    return _mul_nbapi.get_meter(datapath_id)
get_meter = _mul_nbapi.get_meter

def get_meter_number(dpid):
    return _mul_nbapi.get_meter_number(dpid)
get_meter_number = _mul_nbapi.get_meter_number

def nbapi_get_band_type(cofp_mm):
    return _mul_nbapi.nbapi_get_band_type(cofp_mm)
nbapi_get_band_type = _mul_nbapi.nbapi_get_band_type

def nbapi_get_band_rate(cofp_mm):
    return _mul_nbapi.nbapi_get_band_rate(cofp_mm)
nbapi_get_band_rate = _mul_nbapi.nbapi_get_band_rate

def nbapi_get_band_burst_size(cofp_mm):
    return _mul_nbapi.nbapi_get_band_burst_size(cofp_mm)
nbapi_get_band_burst_size = _mul_nbapi.nbapi_get_band_burst_size

def nbapi_get_band_prec_level(cofp_mm):
    return _mul_nbapi.nbapi_get_band_prec_level(cofp_mm)
...
class nbapi_fabric_host_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_fabric_host_list_t_array_get, _mul_nbapi.nbapi_fabric_host_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_fabric_host_list_t_length_get, _mul_nbapi.nbapi_fabric_host_list_t_length_set)
...
class nbapi_fabric_port_tnid_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_fabric_port_tnid_list_t_array_get, _mul_nbapi.nbapi_fabric_port_tnid_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_fabric_port_tnid_list_t_length_get, _mul_nbapi.nbapi_fabric_port_tnid_list_t_length_set)
...
class nbapi_fabric_tenant_nw_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_fabric_tenant_nw_list_t_array_get, _mul_nbapi.nbapi_fabric_tenant_nw_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_fabric_tenant_nw_list_t_length_get, _mul_nbapi.nbapi_fabric_tenant_nw_list_t_length_set)
...
class nbapi_fabric_route(_object):
    ...
    if _newclass:
        src_host = _swig_property(_mul_nbapi.nbapi_fabric_route_src_host_get, _mul_nbapi.nbapi_fabric_route_src_host_set)
    ...
    if _newclass:
        dst_host = _swig_property(_mul_nbapi.nbapi_fabric_route_dst_host_get, _mul_nbapi.nbapi_fabric_route_dst_host_set)
    ...
    if _newclass:
        str_route = _swig_property(_mul_nbapi.nbapi_fabric_route_str_route_get, _mul_nbapi.nbapi_fabric_route_str_route_set)
...
class nbapi_fabric_route_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_fabric_route_list_t_array_get, _mul_nbapi.nbapi_fabric_route_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_fabric_route_list_t_length_get, _mul_nbapi.nbapi_fabric_route_list_t_length_set)
...
def add_del_fabric_port_tnid(datapath_id, str_tenant_id, str_network_id, in_port, add):
    return _mul_nbapi.add_del_fabric_port_tnid(datapath_id, str_tenant_id, str_network_id, in_port, add)
...
def get_fabric_host_all(active):
    return _mul_nbapi.get_fabric_host_all(active)
get_fabric_host_all = _mul_nbapi.get_fabric_host_all

def nbapi_uuid_to_str(uuid):
    return _mul_nbapi.nbapi_uuid_to_str(uuid)
nbapi_uuid_to_str = _mul_nbapi.nbapi_uuid_to_str

def add_fabric_host(datapath_id, str_tenant_id, str_network_id, nw_src, dl_src, in_port, is_gw):
    return _mul_nbapi.add_fabric_host(datapath_id, str_tenant_id, str_network_id, nw_src, dl_src, in_port, is_gw)
add_fabric_host = _mul_nbapi.add_fabric_host

def delete_fabric_host(str_tenant_id, str_network_id, str_host_ip, str_host_mac):
    return _mul_nbapi.delete_fabric_host(str_tenant_id, str_network_id, str_host_ip, str_host_mac)
...
def nbapi_get_host_route(str_tenant_id, str_network_id, str_host_ip, str_host_mac):
    return _mul_nbapi.nbapi_get_host_route(str_tenant_id, str_network_id, str_host_ip, str_host_mac)
nbapi_get_host_route = _mul_nbapi.nbapi_get_host_route

def nbapi_compare_src_host(flow, str_host_mac, str_host_ip):
    return _mul_nbapi.nbapi_compare_src_host(flow, str_host_mac, str_host_ip)
...
class nbapi_path_elem_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_path_elem_list_t_array_get, _mul_nbapi.nbapi_path_elem_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_path_elem_list_t_length_get, _mul_nbapi.nbapi_path_elem_list_t_length_set)
...
class nbapi_port_neigh_list_t(_object):
    ...
    if _newclass:
        array = _swig_property(_mul_nbapi.nbapi_port_neigh_list_t_array_get, _mul_nbapi.nbapi_port_neigh_list_t_array_set)
    ...
    if _newclass:
        length = _swig_property(_mul_nbapi.nbapi_port_neigh_list_t_length_get, _mul_nbapi.nbapi_port_neigh_list_t_length_set)
...
def get_simple_path(src_sw_alias, dest_sw_alias):
    return _mul_nbapi.get_simple_path(src_sw_alias, dest_sw_alias)
get_simple_path = _mul_nbapi.get_simple_path

def get_switch_neighbor_all(datapath_id):
    return _mul_nbapi.get_switch_neighbor_all(datapath_id)
...
class Port_Stats_t(_object):
    ...
    if _newclass:
        bps = _swig_property(_mul_nbapi.Port_Stats_t_bps_get, _mul_nbapi.Port_Stats_t_bps_set)
    __swig_setmethods__["pps"] = _mul_nbapi.Port_Stats_t_pps_set
    __swig_getmethods__["pps"] = _mul_nbapi.Port_Stats_t_pps_get
    if _newclass:
        pps = _swig_property(_mul_nbapi.Port_Stats_t_pps_get, _mul_nbapi.Port_Stats_t_pps_set)
...
def get_switch_statistics_all(datapath_id):
    return _mul_nbapi.get_switch_statistics_all(datapath_id)
get_switch_statistics_all = _mul_nbapi.get_switch_statistics_all

def get_switch_statistics_port(datapath_id, port):
    return _mul_nbapi.get_switch_statistics_port(datapath_id, port)
get_switch_statistics_port = _mul_nbapi.get_switch_statistics_port

def nbapi_parse_bps_to_str(bps):
    return _mul_nbapi.nbapi_parse_bps_to_str(bps)
nbapi_parse_bps_to_str = _mul_nbapi.nbapi_parse_bps_to_str

def nbapi_parse_pps_to_str(pps):
    return _mul_nbapi.nbapi_parse_pps_to_str(pps)
nbapi_parse_pps_to_str = _mul_nbapi.nbapi_parse_pps_to_str

def get_table_stats(dp_id, tbl_id):
    return _mul_nbapi.get_table_stats(dp_id, tbl_id)
get_table_stats = _mul_nbapi.get_table_stats

def set_port_stats(dpid, enable):
    return _mul_nbapi.set_port_stats(dpid, enable)
set_port_stats = _mul_nbapi.set_port_stats

def show_port_stats(dpid, port_no):
    return _mul_nbapi.show_port_stats(dpid, port_no)
show_port_stats = _mul_nbapi.show_port_stats

def show_port_stats131(dpid, port_no):
    return _mul_nbapi.show_port_stats131(dpid, port_no)
show_port_stats131 = _mul_nbapi.show_port_stats131

def show_port_stats140(dpid, port_no):
    return _mul_nbapi.show_port_stats140(dpid, port_no)
show_port_stats140 = _mul_nbapi.show_port_stats140

def get_ofp140_port_stats_prop_type(ofp_ps):
    return _mul_nbapi.get_ofp140_port_stats_prop_type(ofp_ps)
get_ofp140_port_stats_prop_type = _mul_nbapi.get_ofp140_port_stats_prop_type

def show_ofp_port_stats_prop_ethernet(ofp_ps):
    return _mul_nbapi.show_ofp_port_stats_prop_ethernet(ofp_ps)
show_ofp_port_stats_prop_ethernet = _mul_nbapi.show_ofp_port_stats_prop_ethernet

def show_ofp_port_stats_prop_optical(ofp_ps):
    return _mul_nbapi.show_ofp_port_stats_prop_optical(ofp_ps)
show_ofp_port_stats_prop_optical = _mul_nbapi.show_ofp_port_stats_prop_optical

def get_switch_pkt_rx_rlim(datapath_id):
    return _mul_nbapi.get_switch_pkt_rx_rlim(datapath_id)
get_switch_pkt_rx_rlim = _mul_nbapi.get_switch_pkt_rx_rlim

def get_switch_pkt_tx_rlim(datapath_id):
    return _mul_nbapi.get_switch_pkt_tx_rlim(datapath_id)
get_switch_pkt_tx_rlim = _mul_nbapi.get_switch_pkt_tx_rlim

def nbapi_set_switch_pkt_rx_rlim(datapath_id, pps):
    return _mul_nbapi.nbapi_set_switch_pkt_rx_rlim(datapath_id, pps)
nbapi_set_switch_pkt_rx_rlim = _mul_nbapi.nbapi_set_switch_pkt_rx_rlim

def nbapi_set_switch_pkt_tx_rlim(datapath_id, pps):
    return _mul_nbapi.nbapi_set_switch_pkt_tx_rlim(datapath_id, pps)
nbapi_set_switch_pkt_tx_rlim = _mul_nbapi.nbapi_set_switch_pkt_tx_rlim

def nbapi_disable_switch_pkt_rx_rlim(datapath_id):
    return _mul_nbapi.nbapi_disable_switch_pkt_rx_rlim(datapath_id)
nbapi_disable_switch_pkt_rx_rlim = _mul_nbapi.nbapi_disable_switch_pkt_rx_rlim

def nbapi_disable_switch_pkt_tx_rlim(datapath_id):
    return _mul_nbapi.nbapi_disable_switch_pkt_tx_rlim(datapath_id)
...
def uuid_clear(uu):
    return _mul_nbapi.uuid_clear(uu)
uuid_clear = _mul_nbapi.uuid_clear

def uuid_compare(uu1, uu2):
    return _mul_nbapi.uuid_compare(uu1, uu2)
uuid_compare = _mul_nbapi.uuid_compare

def uuid_copy(dst, src):
    return _mul_nbapi.uuid_copy(dst, src)
uuid_copy = _mul_nbapi.uuid_copy

def uuid_is_null(uu):
    return _mul_nbapi.uuid_is_null(uu)
uuid_is_null = _mul_nbapi.uuid_is_null

def uuid_parse(arg1, uu):
    return _mul_nbapi.uuid_parse(arg1, uu)
uuid_parse = _mul_nbapi.uuid_parse

def uuid_unparse(uu, out):
    return _mul_nbapi.uuid_unparse(uu, out)
uuid_unparse = _mul_nbapi.uuid_unparse

def uuid_unparse_lower(uu, out):
    return _mul_nbapi.uuid_unparse_lower(uu, out)
uuid_unparse_lower = _mul_nbapi.uuid_unparse_lower

def uuid_unparse_upper(uu, out):
    return _mul_nbapi.uuid_unparse_upper(uu, out)
uuid_unparse_upper = _mul_nbapi.uuid_unparse_upper

def uuid_time(uu, ret_tv):
    return _mul_nbapi.uuid_time(uu, ret_tv)
uuid_time = _mul_nbapi.uuid_time

def uuid_type(uu):
    return _mul_nbapi.uuid_type(uu)
uuid_type = _mul_nbapi.uuid_type

def uuid_variant(uu):
    return _mul_nbapi.uuid_variant(uu)
